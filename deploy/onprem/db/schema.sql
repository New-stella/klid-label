...
\restrict vqCyFTT5tQanubTK11vciE54Woyo3LDStK6cI3BB7dQ3twhl5eCMtgX3lNm5xiP
...
--
-- Name: ls_cm_code; Type: TABLE; Schema: klid_at; Owner: -
--

CREATE TABLE klid_at.ls_cm_code (
...
--
-- Data for Name: ls_cm_code; Type: TABLE DATA; Schema: klid_at; Owner: -
--

COPY klid_at.ls_cm_code (group_code, code, code_nm, code_dc, use_yn, sort_ordr, reg_dt) FROM stdin;
DATA_STTS_CD	PENDING	검수 대기	라벨링 완료 후 검수 대기	Y	10	2026-08-13 05:13:35.511059
DATA_STTS_CD	IN_REVIEW	검수중	REVIEWER가 검수 진행 중	Y	20	2026-08-13 05:13:35.511059
DATA_STTS_CD	APPROVED	검수 승인	REVIEWER 승인 완료	Y	30	2026-08-13 05:13:35.511059
DATA_STTS_CD	REJECTED	검수 반려	REVIEWER 반려	Y	40	2026-08-13 05:13:35.511059
DATA_STTS_CD	BATCH_QUEUED	배치 대기	마킹 완료 후 배치 큐 적재됨	Y	6	2026-08-13 05:13:35.511059
\.
...
BATCH_INTERVAL_SEC	60	NUMBER	배치 트리거 간격 (초, 10~3600)	SYSTEM	2026-08-13 05:13:35.511059
BATCH_CONCURRENCY	1	NUMBER	동시 배치 잡 수 (1=직렬, 1~10)	SYSTEM	2026-08-13 05:13:35.511059
YOLO_IMGSZ	1280	NUMBER	YOLO 추론 입력 해상도 px (320~1920)	SYSTEM	2026-08-13 05:13:35.511059
YOLO_IOU	50	NUMBER	YOLO NMS IoU 임계값 백분율 (30~80, 사용 시 /100)	SYSTEM	2026-08-13 05:13:35.511059
YOLO_CONF_THRESHOLD	25	NUMBER	YOLO 신뢰도 임계값 백분율 (25~80, 사용 시 /100)	SYSTEM	2026-08-13 05:13:35.511059
POLYGON_SIMPLIFY_TOLERANCE	1.0	DECIMAL	폴리곤 경계 단순화 epsilon px (0.0~50.0, Douglas-Peucker)	SYSTEM	2026-08-13 05:13:35.511059
portal.upload.frame-interval-sec	5	NUMBER	포털 업로드 영상 프레임 추출 간격(초, 1~600)	SYSTEM	2026-08-13 05:13:35.511059
autolabel.polygon.max-boxes	20	NUMBER	폴리곤 오토라벨 SAM 분할 박스 상한 (1~100)	SYSTEM	2026-08-13 05:13:35.511059
eventtype.excluded-class-codes	["08"]	JSON	이벤트 필터 옵션에서 제외할 대분류 코드 목록(기본 08=배회)	SYSTEM	2026-08-13 05:13:35.511059
kpst.deid.masking-type	0	NUMBER	비식별 마스킹 방식 (0 색상 / 2 모자이크 / 3 블러)	SYSTEM	2026-08-13 05:13:35.511059
kpst.deid.masking-range	1.0	DECIMAL	비식별 마스킹 영역 배율 (0.5~2.0)	SYSTEM	2026-08-13 05:13:35.511059
kpst.deid.db-save	0	NUMBER	비식별 처리 프레임 저장 여부 (0 저장 안 함 / 1 저장)	SYSTEM	2026-08-13 05:13:35.511059
\.
...
--
-- Name: ls_cm_code ls_cm_code_pkey; Type: CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_cm_code
...
\unrestrict vqCyFTT5tQanubTK11vciE54Woyo3LDStK6cI3BB7dQ3twhl5eCMtgX3lNm5xiP
