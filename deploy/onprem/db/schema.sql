...
\restrict 78Xp2M5scdzQm3fS6xoEhV66nIjn1OspOYSxBDnnaeIZdHi06IA4a0tgMx4JwdG
...
--
-- Name: cm_code; Type: TABLE; Schema: klid_at; Owner: -
--

CREATE TABLE klid_at.cm_code (
...
--
-- Name: ls_data_lbl_ai_info; Type: TABLE; Schema: klid_at; Owner: -
--

CREATE TABLE klid_at.ls_data_lbl_ai_info (
...
--
-- Name: ls_data_lbl_ai_info_data_lbl_ai_info_sn_seq; Type: SEQUENCE; Schema: klid_at; Owner: -
--

ALTER TABLE klid_at.ls_data_lbl_ai_info ALTER COLUMN data_lbl_ai_info_sn ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME klid_at.ls_data_lbl_ai_info_data_lbl_ai_info_sn_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ls_data_meta_hstry; Type: TABLE; Schema: klid_at; Owner: -
--

CREATE TABLE klid_at.ls_data_meta_hstry (
...
--
-- Name: ls_data_meta_hstry_hstry_seq_seq; Type: SEQUENCE; Schema: klid_at; Owner: -
--

ALTER TABLE klid_at.ls_data_meta_hstry ALTER COLUMN hstry_seq ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME klid_at.ls_data_meta_hstry_hstry_seq_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ls_data_raw_hstry; Type: TABLE; Schema: klid_at; Owner: -
--

CREATE TABLE klid_at.ls_data_raw_hstry (
    hstry_seq bigint NOT NULL,
    raw_sn bigint NOT NULL,
...
--
-- Name: ls_data_raw_hstry_hstry_seq_seq; Type: SEQUENCE; Schema: klid_at; Owner: -
--

ALTER TABLE klid_at.ls_data_raw_hstry ALTER COLUMN hstry_seq ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME klid_at.ls_data_raw_hstry_hstry_seq_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ls_deadline; Type: TABLE; Schema: klid_at; Owner: -
--

CREATE TABLE klid_at.ls_deadline (
...
--
-- Name: ls_meta; Type: TABLE; Schema: klid_at; Owner: -
--

CREATE TABLE klid_at.ls_meta (
    meta_key character varying(64) NOT NULL,
    meta_vl character varying(2000)
);
...
--
-- Name: ls_raw_data_enrollment; Type: TABLE; Schema: klid_at; Owner: -
--

CREATE TABLE klid_at.ls_raw_data_enrollment (
...
--
-- Name: ls_task_assign_history; Type: TABLE; Schema: klid_at; Owner: -
--

CREATE TABLE klid_at.ls_task_assign_history (
    hstry_seq bigint NOT NULL,
...
--
-- Name: ls_task_assign_history_hstry_seq_seq; Type: SEQUENCE; Schema: klid_at; Owner: -
--

ALTER TABLE klid_at.ls_task_assign_history ALTER COLUMN hstry_seq ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME klid_at.ls_task_assign_history_hstry_seq_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Data for Name: cm_code; Type: TABLE DATA; Schema: klid_at; Owner: -
--

COPY klid_at.cm_code (group_code, code, code_nm, code_dc, use_yn, sort_ordr, reg_dt) FROM stdin;
DATA_STTS_CD	PENDING	검수 대기	라벨링 완료 후 검수 대기	Y	10	2026-08-13 04:22:14.070182
DATA_STTS_CD	IN_REVIEW	검수중	REVIEWER가 검수 진행 중	Y	20	2026-08-13 04:22:14.070182
DATA_STTS_CD	APPROVED	검수 승인	REVIEWER 승인 완료	Y	30	2026-08-13 04:22:14.070182
DATA_STTS_CD	REJECTED	검수 반려	REVIEWER 반려	Y	40	2026-08-13 04:22:14.070182
DATA_STTS_CD	BATCH_QUEUED	배치 대기	마킹 완료 후 배치 큐 적재됨	Y	6	2026-08-13 04:22:17.154791
\.
...
COPY klid_at.ls_data_lbl (lbl_sn, src_sn, lbl_type_cd, lbl_nm, point_cn, trck_id, reg_user_no, reg_dt, mdfcn_dt, lbl_id) FROM stdin;
\.


--
-- Data for Name: ls_data_lbl_ai_info; Type: TABLE DATA; Schema: klid_at; Owner: -
--

COPY klid_at.ls_data_lbl_ai_info (data_lbl_ai_info_sn, data_lbl_sn, data_raw_sn, data_src_sn, lbl_src_cd, mdl_nm, mdl_ver, conf_score, auto_lbl_yn, reg_id, reg_dt, mdfcn_id, mdfcn_dt) FROM stdin;
\.
...
--
-- Data for Name: ls_data_meta_hstry; Type: TABLE DATA; Schema: klid_at; Owner: -
--

COPY klid_at.ls_data_meta_hstry (hstry_seq, meta_sn, prev_vl, new_vl, chg_user_no, chg_dt) FROM stdin;
\.
...
--
-- Data for Name: ls_data_raw_hstry; Type: TABLE DATA; Schema: klid_at; Owner: -
--

COPY klid_at.ls_data_raw_hstry (hstry_seq, raw_sn, chg_type_cd, prev_stts_cd, new_stts_cd, chg_user_no, chg_dt) FROM stdin;
\.
...
--
-- Data for Name: ls_deadline; Type: TABLE DATA; Schema: klid_at; Owner: -
--

COPY klid_at.ls_deadline (ddln_seq, ddln_dt, anony_incl_yn, psdo_incl_yn, prvc_incl_yn, reg_dt) FROM stdin;
\.
...
--
-- Data for Name: ls_meta; Type: TABLE DATA; Schema: klid_at; Owner: -
--

COPY klid_at.ls_meta (meta_key, meta_vl) FROM stdin;
\.
...
--
-- Data for Name: ls_raw_data_enrollment; Type: TABLE DATA; Schema: klid_at; Owner: -
--

COPY klid_at.ls_raw_data_enrollment (raw_data_id, reg_dt) FROM stdin;
\.
...
BATCH_INTERVAL_SEC	60	NUMBER	배치 트리거 간격 (초, 10~3600)	SYSTEM	2026-08-13 04:22:14.754365
BATCH_CONCURRENCY	1	NUMBER	동시 배치 잡 수 (1=직렬, 1~10)	SYSTEM	2026-08-13 04:22:14.754365
YOLO_IMGSZ	1280	NUMBER	YOLO 추론 입력 해상도 px (320~1920)	SYSTEM	2026-08-13 04:22:15.224398
YOLO_IOU	50	NUMBER	YOLO NMS IoU 임계값 백분율 (30~80, 사용 시 /100)	SYSTEM	2026-08-13 04:22:15.224398
YOLO_CONF_THRESHOLD	25	NUMBER	YOLO 신뢰도 임계값 백분율 (25~80, 사용 시 /100)	SYSTEM	2026-08-13 04:22:15.224398
POLYGON_SIMPLIFY_TOLERANCE	1.0	DECIMAL	폴리곤 경계 단순화 epsilon px (0.0~50.0, Douglas-Peucker)	SYSTEM	2026-08-13 04:22:17.293853
portal.upload.frame-interval-sec	5	NUMBER	포털 업로드 영상 프레임 추출 간격(초, 1~600)	SYSTEM	2026-08-13 04:22:20.072658
autolabel.polygon.max-boxes	20	NUMBER	폴리곤 오토라벨 SAM 분할 박스 상한 (1~100)	SYSTEM	2026-08-13 04:22:20.298675
eventtype.excluded-class-codes	["08"]	JSON	이벤트 필터 옵션에서 제외할 대분류 코드 목록(기본 08=배회)	SYSTEM	2026-08-13 04:22:22.595513
kpst.deid.masking-type	0	NUMBER	비식별 마스킹 방식 (0 색상 / 2 모자이크 / 3 블러)	SYSTEM	2026-08-13 04:22:23.301668
kpst.deid.masking-range	1.0	DECIMAL	비식별 마스킹 영역 배율 (0.5~2.0)	SYSTEM	2026-08-13 04:22:23.301668
kpst.deid.db-save	0	NUMBER	비식별 처리 프레임 저장 여부 (0 저장 안 함 / 1 저장)	SYSTEM	2026-08-13 04:22:23.301668
\.


--
-- Data for Name: ls_task_assign_history; Type: TABLE DATA; Schema: klid_at; Owner: -
--

COPY klid_at.ls_task_assign_history (hstry_seq, authrt_seq, raw_data_id, prev_user_no, new_user_no, task_type_cd, chg_user_no, chg_dt) FROM stdin;
\.
...
--
-- Name: ls_data_lbl_ai_info_data_lbl_ai_info_sn_seq; Type: SEQUENCE SET; Schema: klid_at; Owner: -
--

SELECT pg_catalog.setval('klid_at.ls_data_lbl_ai_info_data_lbl_ai_info_sn_seq', 1, false);
...
--
-- Name: ls_data_meta_hstry_hstry_seq_seq; Type: SEQUENCE SET; Schema: klid_at; Owner: -
--

SELECT pg_catalog.setval('klid_at.ls_data_meta_hstry_hstry_seq_seq', 1, false);
...
--
-- Name: ls_data_raw_hstry_hstry_seq_seq; Type: SEQUENCE SET; Schema: klid_at; Owner: -
--

SELECT pg_catalog.setval('klid_at.ls_data_raw_hstry_hstry_seq_seq', 1, false);
...
--
-- Name: ls_task_assign_history_hstry_seq_seq; Type: SEQUENCE SET; Schema: klid_at; Owner: -
--

SELECT pg_catalog.setval('klid_at.ls_task_assign_history_hstry_seq_seq', 1, false);
...
--
-- Name: cm_code cm_code_pkey; Type: CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.cm_code
...
--
-- Name: ls_data_lbl_ai_info ls_data_lbl_ai_info_pkey; Type: CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_data_lbl_ai_info
...
--
-- Name: ls_data_meta_hstry ls_data_meta_hstry_pkey; Type: CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_data_meta_hstry
...
--
-- Name: ls_data_raw_hstry ls_data_raw_hstry_pkey; Type: CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_data_raw_hstry
...
--
-- Name: ls_deadline ls_deadline_pkey; Type: CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_deadline
...
--
-- Name: ls_meta ls_meta_pkey; Type: CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_meta
...
--
-- Name: ls_raw_data_enrollment ls_raw_data_enrollment_pkey; Type: CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_raw_data_enrollment
...
--
-- Name: ls_task_assign_history ls_task_assign_history_pkey; Type: CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_task_assign_history
...
--
-- Name: idx_ls_data_lbl_ai_info_lbl; Type: INDEX; Schema: klid_at; Owner: -
--

CREATE INDEX idx_ls_data_lbl_ai_info_lbl ON klid_at.ls_data_lbl_ai_info USING btree (data_lbl_sn);


--
-- Name: idx_ls_data_lbl_ai_info_lbl_auto; Type: INDEX; Schema: klid_at; Owner: -
--

CREATE INDEX idx_ls_data_lbl_ai_info_lbl_auto ON klid_at.ls_data_lbl_ai_info USING btree (data_lbl_sn, auto_lbl_yn);


--
-- Name: idx_ls_data_lbl_ai_info_src; Type: INDEX; Schema: klid_at; Owner: -
--

CREATE INDEX idx_ls_data_lbl_ai_info_src ON klid_at.ls_data_lbl_ai_info USING btree (data_raw_sn, data_src_sn);


--
-- Name: idx_ls_data_lbl_ai_info_src_cd; Type: INDEX; Schema: klid_at; Owner: -
--

CREATE INDEX idx_ls_data_lbl_ai_info_src_cd ON klid_at.ls_data_lbl_ai_info USING btree (lbl_src_cd);
...
--
-- Name: ix_ls_data_meta_hstry_meta; Type: INDEX; Schema: klid_at; Owner: -
--

CREATE INDEX ix_ls_data_meta_hstry_meta ON klid_at.ls_data_meta_hstry USING btree (meta_sn);
...
--
-- Name: ix_ls_data_raw_hstry_raw; Type: INDEX; Schema: klid_at; Owner: -
--

CREATE INDEX ix_ls_data_raw_hstry_raw ON klid_at.ls_data_raw_hstry USING btree (raw_sn);
...
--
-- Name: ix_ls_task_assign_history_authrt; Type: INDEX; Schema: klid_at; Owner: -
--

CREATE INDEX ix_ls_task_assign_history_authrt ON klid_at.ls_task_assign_history USING btree (authrt_seq);
...
--
-- Name: ls_data_lbl_ai_info fk_ls_data_lbl_ai_info_raw; Type: FK CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_data_lbl_ai_info
    ADD CONSTRAINT fk_ls_data_lbl_ai_info_raw FOREIGN KEY (data_raw_sn) REFERENCES klid_at.ls_data_raw(raw_sn) ON DELETE CASCADE;
...
--
-- Name: ls_data_raw_hstry fk_ls_data_raw_hstry_raw; Type: FK CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_data_raw_hstry
    ADD CONSTRAINT fk_ls_data_raw_hstry_raw FOREIGN KEY (raw_sn) REFERENCES klid_at.ls_data_raw(raw_sn) ON DELETE CASCADE;
...
--
-- Name: ls_raw_data_enrollment fk_ls_raw_data_enrollment_raw; Type: FK CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_raw_data_enrollment
    ADD CONSTRAINT fk_ls_raw_data_enrollment_raw FOREIGN KEY (raw_data_id) REFERENCES klid_at.ls_data_raw(raw_sn) ON DELETE CASCADE;
...
--
-- Name: ls_task_assign_history fk_ls_task_assign_history_raw; Type: FK CONSTRAINT; Schema: klid_at; Owner: -
--

ALTER TABLE ONLY klid_at.ls_task_assign_history
    ADD CONSTRAINT fk_ls_task_assign_history_raw FOREIGN KEY (raw_data_id) REFERENCES klid_at.ls_data_raw(raw_sn) ON DELETE CASCADE;
...
\unrestrict 78Xp2M5scdzQm3fS6xoEhV66nIjn1OspOYSxBDnnaeIZdHi06IA4a0tgMx4JwdG
