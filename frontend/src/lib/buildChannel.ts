 ...
 *
 * 내부(관제) 채널과 포털 채널은 서로 다른 서버에 배포된다 — 공통 소스는 한 벌로 두고
 ...
 */
export const BUILD_CHANNELS = ['internal', 'portal'] as const;
 ...
 * "자체 셸을 갖는 독립 앱"으로 동작해야 하고 그 기본값이 곧 `internal` 이다.
 */
export const DEFAULT_BUILD_CHANNEL: BuildChannel = 'internal';
