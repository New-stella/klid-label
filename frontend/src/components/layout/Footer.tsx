  ...
  return (
    <footer className="border-t border-gray-200 bg-white px-6 py-4 text-sub text-gray-500">
      <div className="mx-auto flex max-w-6xl flex-col gap-2">
        <dl className="flex flex-col gap-1 sm:flex-row sm:flex-wrap sm:gap-x-6 sm:gap-y-1">
        ...
        <div className="flex flex-col gap-1 text-gray-400 sm:flex-row sm:items-center sm:justify-between">
