...
export const INPUT_CLASS =
  'w-full rounded border border-gray-300 bg-white text-gray-900 text-sm p-1.5 placeholder-gray-400 focus:outline-hidden focus:ring-1 focus:ring-primary-500';
