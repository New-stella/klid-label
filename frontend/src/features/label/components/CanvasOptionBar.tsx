...
//
// 구성(이번 범위): 프레임 이동 컨트롤(UI-052) · 삭제 · 실행취소/다시실행(UI-054) · 저장(UI-053).
...
//
// ⚠ 미구현(이번 범위 밖): 사양 §캔버스 상단 옵션바의 `화면 맞춤`·`확대/축소`·`라벨 표시/숨김`.
//   현재 화면 맞춤은 좌측 도구바(보기 조작)에, 확대/축소·표시숨김은 단축키(+/-/T)에 있다.
