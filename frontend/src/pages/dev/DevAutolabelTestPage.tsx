...
/**
 * [개발/검수 전용] 영상 업로드 화면 (`/dev/upload`). [@design SCREEN-027]
 *
...
export function DevAutolabelTestPage() {
  ...
  return (
    <main className="space-y-6">
      <PageHeader
        title="영상 업로드"
        description="영상 파일과 메타데이터를 한 폼에서 입력해 올립니다. 적재 경로를 파이프라인 즉시 실행과 관제 인입 재현 중에서 고를 수 있으며, 입력 폼은 두 경로가 같습니다. (개발/검수 전용)"
      />
