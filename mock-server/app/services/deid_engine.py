...
#: ⚠ 값을 키우면 <b>차량이 통째로 뭉개져</b> 라벨링 대상으로서 가치를 잃는다. 실제 번호판은
#:   차폭의 25~35% · 차높이의 8~12% 이며, 검출 박스 부정확·차량 각도를 감안한 여유만 더한다.
#:   (구값 0.30/0.60 은 실측상 실제 번호판의 2~4배였다 — 사용자 지적, 2026-09-05)
PLATE_BAND_HEIGHT_RATIO = 0.14
PLATE_BAND_WIDTH_RATIO = 0.38
