...
| [CO-009](CO-009-어노테이션-축-정렬-caption-cot-question.md) | 시계열 위탁 결과를 어노테이션 확정 축에 정렬 + 이벤트별 질문 문구를 저작도구가 관리 (CO-007 축 확정을 재반전 · 이벤트유형 관리 메뉴 미노출 결함 동반) | 공유기반 · DOMAIN-014 · DOMAIN-011 · DOMAIN-010 · DOMAIN-016 · 프론트 · mock-server | 📝 작성 | 🎨 설계 32건 · 💻 구현 완료(표적 회귀) · ⚠ FULL 생략(사용자 승인) | | 2026-08-25 |
