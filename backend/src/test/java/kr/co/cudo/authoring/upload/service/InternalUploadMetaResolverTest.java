 ...
 * 통과하지 못한 값은 <b>그 컬럼만</b> 미채택되어야 한다(전량 폐기 금지). 화소(PXL)·색심도(BIT)는
 * 어떤 입력에도 채워지지 않는다(R3).
 */
class InternalUploadMetaResolverTest {

    /** 정상 측정값 — 1920x1080 h264 29.97fps 10초, nb_frames 300, DAR 16:9. */
    private MediaMeta full() {
        return new MediaMeta(1920, 1080, "h264", 30000.0 / 1001.0, 10_000L, 300L, "16:9");
    }
    ...
    void derivesFrameCountFromDurationAndFps() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 30000.0 / 1001.0, 10_000L, null, "16:9");
    ...
    void fallsBackToDerivationWhenNbFramesNonPositive() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 25.0, 8_000L, 0L, "16:9");
    ...
    void skipsFrameCountWhenNeitherAvailable() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", null, 10_000L, null, "16:9");
    ...
    void derivesAspectRatioByGcd() {
        // given: DAR 미제공
        MediaMeta hd = new MediaMeta(1920, 1080, "h264", 25.0, 1_000L, 25L, null);
        MediaMeta sd = new MediaMeta(640, 480, "h264", 25.0, 1_000L, 25L, null);
    ...
    void fallsBackToGcdWhenAspectRatioIsNotAvailable() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 25.0, 1_000L, 25L, "N/A");
    ...
    void fallsBackToGcdWhenAspectRatioIsZero() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 25.0, 1_000L, 25L, "0:1");
    ...
    void skipsAspectRatioWhenNoSource() {
        ...
        MediaMeta meta = new MediaMeta(0, 0, "h264", 25.0, 1_000L, 25L, null);
    ...
    void formatsIntegerFps() {
        // given: 30/1
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 30.0, 1_000L, 30L, "16:9");
    ...
    void skipsFpsWhenUnknown() {
        // given
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", null, 10_000L, 300L, "16:9");
    ...
    void rejectsOverlongCodecInsteadOfTruncating() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, overlong, 25.0, 1_000L, 25L, "16:9");
    ...
    void rejectsBlankCodec() {
        // given
        MediaMeta meta = new MediaMeta(1920, 1080, "   ", 25.0, 1_000L, 25L, "16:9");
    ...
    void skipsDimensionsWhenNoVideoStream() {
        ...
        MediaMeta meta = new MediaMeta(0, 0, "h264", 25.0, 10_000L, 250L, null);
    ...
    void skipsDimensionsWhenOnlyOneSideKnown() {
        // given
        MediaMeta meta = new MediaMeta(1920, 0, "h264", 25.0, 10_000L, 250L, null);
    ...
    void skipsNonPositiveDuration() {
        // given
        MediaMeta zero = new MediaMeta(1920, 1080, "h264", 25.0, 0L, null, "16:9");
        MediaMeta unknown = new MediaMeta(1920, 1080, "h264", 25.0, null, null, "16:9");
    ...
    void skipsDurationAndFrameCountWhenRoundsToZeroSeconds() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 30.0, 499L, null, "16:9");
    ...
    void rejectsCodecWithDisallowedCharacters() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264/avc", 25.0, 1_000L, 25L, "16:9");
    ...
    void roundsDurationToSeconds() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 25.0, 12_500L, 312L, "16:9");
    ...
    void rejectsNbFramesExceedingNumeric10() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 25.0, 1_000L, Long.MAX_VALUE, null);
    ...
    void rejectsDerivedFrameCountExceedingNumeric10() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 9999.99, 9_999_999_000L, null, "16:9");
    ...
    void rejectsOverlongFpsText() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 1e10, 1_000L, 25L, "16:9");
    ...
    void rejectsDurationExceedingNumeric10() {
        ...
        MediaMeta meta = new MediaMeta(1920, 1080, "h264", 25.0, Long.MAX_VALUE, null, "16:9");
    ...
    @Test
    @DisplayName("화소와_색심도는_어떤_입력에도_채워지지_않는다")
    void neverExposesPixelOrBitDepth() {
        // given / when: ResolvedIngestMeta 는 PXL·BIT 를 담을 필드 자체를 갖지 않는다 (R3)
        ...
        assertThat(names).containsExactlyInAnyOrder(
                "vdoLenSec", "fps", "vdoCdc", "wdth", "vrtc", "resl", "frmeCnt", "asprtRt");
        assertThat(names).doesNotContain("pxl", "bit");
    }
    ...
    void isEmptyWhenNothingAdopted() {
        // given: 전량 미상
        MediaMeta meta = new MediaMeta(0, 0, null, null, null, null, null);
    ...
    void isNotEmptyWhenAnythingAdopted() {
        // given: 코덱만 유효
        MediaMeta meta = new MediaMeta(0, 0, "h264", null, null, null, null);
