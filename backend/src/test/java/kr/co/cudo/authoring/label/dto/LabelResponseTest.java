...
class LabelResponseTest {
    ...
    private LsDataLblAiInfo autoAiInfo(String lblSrcCd) {
        return LsDataLblAiInfo.create(1L, 100L, 1L, lblSrcCd, BigDecimal.valueOf(0.9), "batch");
    }
    ...
    void itemFromMapsTrackId() {
        ...
        LabelResponse.Item item = LabelResponse.Item.from(entity, autoAiInfo(LsDataLblAiInfo.SRC_YOLO), null, objectMapper);
    ...
    void itemFromMapsLblSrcCdInterpolated() {
        ...
        LabelResponse.Item item = LabelResponse.Item.from(entity,
                autoAiInfo(LsDataLblAiInfo.SRC_INTERPOLATE), null, objectMapper);
