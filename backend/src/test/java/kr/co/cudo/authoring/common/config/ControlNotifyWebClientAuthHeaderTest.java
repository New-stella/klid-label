...
class ControlNotifyWebClientAuthHeaderTest {
    ...
    void attachesAccessTokenHeader() throws Exception {
        ...
        WebClient client = config.controlNotifyWebClient(
                server.url("/").toString(), "s3cr3t-control-token", true, null, null);
    ...
    void trimsToken() throws Exception {
        WebClient client = config.controlNotifyWebClient(
                server.url("/").toString(), "  padded-token  ", true, null, null);
    ...
    void omitsHeaderWhenTokenBlank() throws Exception {
        WebClient client = config.controlNotifyWebClient(server.url("/").toString(), "", false, null, null);
    ...
    void omitsHeaderWhenTokenNull() throws Exception {
        WebClient client = config.controlNotifyWebClient(server.url("/").toString(), null, true, null, null);
