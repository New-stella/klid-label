-- =============================================================================
-- V154: LS_DATA_AUG.AUG_PROC_STTS_CD 에 'CANCELED' 코드값 신설을 <문서화>한다.
--
-- 【스키마 변경 없음 — 왜 그런가】
...
--   `AUG_PROC_STTS_CD IN ('PENDING','ACCEPTED')`)은 V153 에서 DROP 됐으므로 새 코드값이 그 술어와
...
COMMENT ON COLUMN LS_DATA_AUG.AUG_PROC_STTS_CD IS
    ...
    'REJECTED(검수 반려 또는 처리 실패 롤업) / CANCELED(사용자 취소 종결, V154 신설). '
