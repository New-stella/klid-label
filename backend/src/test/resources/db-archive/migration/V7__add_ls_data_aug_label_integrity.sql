...
--   - REJECT_RSN : 반려 시 사유 (REJECTED 일 때만 채워짐)
-- ============================================================

CREATE TABLE IF NOT EXISTS LS_DATA_AUG (
    DATA_AUG_SN          BIGINT          NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    ...
    REJECT_RSN           VARCHAR(500),
    DCSN_USER_NO         VARCHAR(50),
    DCSN_DT              TIMESTAMP       NULL,
    REG_DT               TIMESTAMP       NOT NULL DEFAULT CURRENT_TIMESTAMP,
    REG_USER_NO          VARCHAR(50),
...
ALTER TABLE LS_DATA_AUG ADD COLUMN IF NOT EXISTS REJECT_RSN VARCHAR(500);
ALTER TABLE LS_DATA_AUG ADD COLUMN IF NOT EXISTS DCSN_USER_NO VARCHAR(50);
ALTER TABLE LS_DATA_AUG ADD COLUMN IF NOT EXISTS DCSN_DT TIMESTAMP NULL;
ALTER TABLE LS_DATA_AUG ADD COLUMN IF NOT EXISTS REG_USER_NO VARCHAR(50);

CREATE INDEX IF NOT EXISTS IDX_LS_DATA_AUG_SRC      ON LS_DATA_AUG (SRC_SN, AUG_TYPE_CD);
CREATE INDEX IF NOT EXISTS IDX_LS_DATA_AUG_STTS     ON LS_DATA_AUG (AUG_PROC_STTS_CD, REG_DT);
