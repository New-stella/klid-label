...
--   - LS_PJT_DATA_MPNG / LS_PJT_DATA_STTS / LS_PJT_USER_AUTHRT(LABELER·REVIEWER 배정)
...
DELETE FROM LS_PJT_DATA_STTS WHERE RAW_DATA_ID BETWEEN 9001 AND 9999;
DELETE FROM LS_PJT_USER_AUTHRT_HSTRY WHERE RAW_DATA_ID BETWEEN 9001 AND 9999;
DELETE FROM LS_PJT_USER_AUTHRT WHERE RAW_DATA_ID BETWEEN 9001 AND 9999;
DELETE FROM LS_PJT_DATA_MPNG WHERE RAW_DATA_ID BETWEEN 9001 AND 9999;
