-- ============================================================================
-- V19: 라벨 프리셋을 「이벤트 + 라벨」로 단순화한다  @design DOMAIN-010
--
...
BEGIN
    ...
    IF orphan_cnt > 0 THEN
        ...
        RAISE NOTICE 'V19: 이벤트 미연결 프리셋 %건을 삭제했습니다(매칭 대상이 없는 죽은 행).', orphan_cnt;
    ELSE
        RAISE NOTICE 'V19: 이벤트 미연결 프리셋이 없습니다 — 삭제 대상 0건.';
    END IF;
END
$migration$;
