...
ALTER TABLE LS_DATA_LBL_HSTRY ADD COLUMN IF NOT EXISTS LABELS_JSON_SNAPSHOT CLOB;
ALTER TABLE LS_DATA_LBL_HSTRY ADD COLUMN IF NOT EXISTS REGISTERED_USER_NO VARCHAR(50);
ALTER TABLE LS_DATA_LBL_HSTRY ADD COLUMN IF NOT EXISTS SRC_SN BIGINT;
