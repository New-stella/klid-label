...
--     → 본체는 NAS 디렉토리(NAS_FILE_PATH_NM)까지만 생성.
--   - EXPORT_STTS_CD : PENDING / IN_PROGRESS / COMPLETED / FAILED
--   - EXPORT_FMT  : YOLO / COCO
--
...
ALTER TABLE LS_DATA_SET ADD COLUMN IF NOT EXISTS NAS_FILE_PATH_NM VARCHAR(500);
ALTER TABLE LS_DATA_SET ADD COLUMN IF NOT EXISTS ERR_MSG VARCHAR(1000);
ALTER TABLE LS_DATA_SET ADD COLUMN IF NOT EXISTS PRCS_DT TIMESTAMP NULL;
