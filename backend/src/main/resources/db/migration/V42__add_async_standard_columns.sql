...
ALTER TABLE LS_DATA_META ADD COLUMN DEAD_LETTER_AT DATETIME NULL;
...
-- ============================================================
ALTER TABLE LS_DATA_AUG ADD COLUMN IDEMPOTENCY_KEY VARCHAR(64) NULL;
ALTER TABLE LS_DATA_AUG ADD COLUMN EXTERNAL_JOB_ID VARCHAR(128) NULL;
ALTER TABLE LS_DATA_AUG ADD COLUMN RETRY_COUNT INT NOT NULL DEFAULT 0;
ALTER TABLE LS_DATA_AUG ADD COLUMN DEAD_LETTER_AT DATETIME NULL;

ALTER TABLE LS_DATA_AUG ADD CONSTRAINT uk_aug_idempotency_key UNIQUE (IDEMPOTENCY_KEY);
ALTER TABLE LS_DATA_AUG ADD CONSTRAINT uk_aug_external_job_id UNIQUE (EXTERNAL_JOB_ID);
