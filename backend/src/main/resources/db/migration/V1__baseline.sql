...
-- 운영 규칙
-- ============================================================================
--   · 신규 마이그레이션은 <V3 부터> 시작한다. V1(베이스라인)·V2(개명)는 재사용 금지.
...
--
-- Name: ls_data_meta_hstry; Type: TABLE
--

CREATE TABLE ls_data_meta_hstry (
...
--
-- Name: ls_data_meta_hstry_hstry_seq_seq; Type: SEQUENCE
--

ALTER TABLE ls_data_meta_hstry ALTER COLUMN hstry_seq ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME ls_data_meta_hstry_hstry_seq_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ls_data_raw_hstry; Type: TABLE
--

CREATE TABLE ls_data_raw_hstry (
    hstry_seq bigint NOT NULL,
    raw_sn bigint NOT NULL,
...
--
-- Name: ls_data_raw_hstry_hstry_seq_seq; Type: SEQUENCE
--

ALTER TABLE ls_data_raw_hstry ALTER COLUMN hstry_seq ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME ls_data_raw_hstry_hstry_seq_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ls_deadline; Type: TABLE
--

CREATE TABLE ls_deadline (
    ddln_seq bigint NOT NULL,
    ddln_dt timestamp without time zone,
    anony_incl_yn character(1) DEFAULT 'N'::character varying NOT NULL,
    psdo_incl_yn character(1) DEFAULT 'N'::character varying NOT NULL,
    prvc_incl_yn character(1) DEFAULT 'N'::character varying NOT NULL,
    reg_dt timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Name: ls_raw_data_enrollment; Type: TABLE
--

CREATE TABLE ls_raw_data_enrollment (
...
--
-- Name: ls_task_assign_history; Type: TABLE
--

CREATE TABLE ls_task_assign_history (
    hstry_seq bigint NOT NULL,
...
--
-- Name: ls_task_assign_history_hstry_seq_seq; Type: SEQUENCE
--

ALTER TABLE ls_task_assign_history ALTER COLUMN hstry_seq ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME ls_task_assign_history_hstry_seq_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ls_data_meta_hstry ls_data_meta_hstry_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY ls_data_meta_hstry
...
--
-- Name: ls_data_raw_hstry ls_data_raw_hstry_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY ls_data_raw_hstry
...
--
-- Name: ls_deadline ls_deadline_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY ls_deadline
...
--
-- Name: ls_meta ls_meta_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY ls_meta
...
--
-- Name: ls_raw_data_enrollment ls_raw_data_enrollment_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY ls_raw_data_enrollment
...
--
-- Name: ls_task_assign_history ls_task_assign_history_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY ls_task_assign_history
...
--
-- Name: ix_ls_data_meta_hstry_meta; Type: INDEX
--

CREATE INDEX ix_ls_data_meta_hstry_meta ON ls_data_meta_hstry USING btree (meta_sn);
...
--
-- Name: ix_ls_data_raw_hstry_raw; Type: INDEX
--

CREATE INDEX ix_ls_data_raw_hstry_raw ON ls_data_raw_hstry USING btree (raw_sn);
...
--
-- Name: ix_ls_task_assign_history_authrt; Type: INDEX
--

CREATE INDEX ix_ls_task_assign_history_authrt ON ls_task_assign_history USING btree (authrt_seq);
...
--
-- Name: ls_data_raw_hstry fk_ls_data_raw_hstry_raw; Type: FK CONSTRAINT
--

ALTER TABLE ONLY ls_data_raw_hstry
    ADD CONSTRAINT fk_ls_data_raw_hstry_raw FOREIGN KEY (raw_sn) REFERENCES ls_data_raw(raw_sn) ON DELETE CASCADE;
...
--
-- Name: ls_raw_data_enrollment fk_ls_raw_data_enrollment_raw; Type: FK CONSTRAINT
--

ALTER TABLE ONLY ls_raw_data_enrollment
    ADD CONSTRAINT fk_ls_raw_data_enrollment_raw FOREIGN KEY (raw_data_id) REFERENCES ls_data_raw(raw_sn) ON DELETE CASCADE;
...
--
-- Name: ls_task_assign_history fk_ls_task_assign_history_raw; Type: FK CONSTRAINT
--

ALTER TABLE ONLY ls_task_assign_history
    ADD CONSTRAINT fk_ls_task_assign_history_raw FOREIGN KEY (raw_data_id) REFERENCES ls_data_raw(raw_sn) ON DELETE CASCADE;
