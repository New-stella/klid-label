 ...
 * 손댄 라벨이 지워졌다. 단위를 묶음으로 바꾸면 <b>그 선택 자체가 사라진다</b>: 되돌린 묶음의 구성원만
 ...
 * <p>이 변환기는 <b>이미 검증된 대상 묶음</b>만 받는다는 전제 위에 있다. "그 영상에서 실제로 되돌린
...
public class BatchBundleTogglePolicy {
     ...
     *
     * @param bundle 재수행할 작업 묶음(입구에서 이미 "되돌린 묶음"으로 검증된 값)
