 ...
 * <ul>
 *   <li>개행(CR/LF) · 탭 · NULL · 기타 ASCII 제어문자 제거 — 로그 위·변조 차단</li>
 *   <li>최대 길이 상한 — 비정상 입력으로 로그 폭주 차단</li>
 *   <li>한글·UTF-8 BMP 영역은 보존 (가시 문자 0x20 이상은 그대로 유지)</li>
 * </ul>
 *
 * <p>사용 예:
 * <pre>
...
public final class LogSanitizer {
    ...
    public static String sanitize(String input, int maxLength) {
        ...
        for (int i = 0; i < input.length(); i++) {
            ...
            // ASCII 제어문자(0x00~0x1F, 0x7F) 와 개행/탭 계열 일괄 제거.
            // 0x20 이상은 한글 등 가시 문자이므로 보존.
            if (c < 0x20 || c == 0x7F) {
                continue;
            }
            sb.append(c);
