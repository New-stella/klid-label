 ...
 *
 * <p><b>관제 계약(API-251 v17) 9필드 평면 구조</b>(required 8 + optional 1) — 구
 * {@code {eventType, payload:{...}}} 2단 중첩은 폐기했다. 관제는 이 통지로 1차 판단만 하고, 상세는
 * 저작도구 조회 API({@code /v1/tasks/**})·데이터마트 뷰로 가져간다.
