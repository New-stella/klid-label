...
public class AugmentExternalLinkPolicy {
     ...
     *
     * <p>⚠ <b>주소의 「형식·안전성」은 여기서 보지 않는다</b> — 그 판정은 {@code AugmentUrlPolicy} 가
     * 기동 시점에 하되 <b>기동을 막지 않고</b> 결과를 들고 있다가 <b>위탁 시점</b>에 전송을 막는다
     * (2026-09-03 확정). 이 메서드는 "정해졌는가" 만 본다.
     *
     * <p>⚠ <b>구 서술 폐기</b> — <i>"정해졌는데 위험한 주소면 애초에 기동하지 못하므로 여기 도달하지
     * 않는다"</i>. 이제 <b>도달한다</b>: 위험한 주소도 기동하므로 이 판정은 「연동됨」을 돌려주고,
     * 실제 차단은 {@code AugmentTransportGuard} 가 한다. 그래서 <b>요청 접수는 통과하고 위탁이
