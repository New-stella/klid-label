...
| 2026-07-21 | 1.3 | - | - | 데이터라벨이력(LS_DATA_LBL_HSTRY, EN-046) 저장이벤트 재구조화(V114) — '라벨 1건=1행'에서 '저장 이벤트=1행 + diff 페이로드'로 전환. LBL_SN·CHG_KIND_CD 제거, ADD_CNT/MDFCN_CNT/DEL_CNT·CHG_DTL_CN(diff JSON) 추가. ERD-002 속성·관계 반영 |
