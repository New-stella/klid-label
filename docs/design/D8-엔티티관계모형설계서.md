...
> **적용 범위**: PostgreSQL `klid_at` 스키마, 활성 ERD 12건(KLID-AT-ERD-010~021), deprecated 9건 제외.  
...
erDiagram
    ...
    LS_DATA_SET {
        bigint EXPORT_SN PK
        varchar20 EXPORT_FMT
        varchar20 EXPORT_STTS_CD
        varchar500 NAS_FILE_PATH_NM
        varchar1000 ERR_MSG
        timestamp PRCS_DT
        varchar50 REGISTERED_USER_NO
...
> **EN ID 배정**: KLID-AT-EN-001~034 (도메인별 오름차순)
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-030 | 관련 클래스명 | LsDataLbl |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-031 | 관련 클래스명 | LsDataLblAiInfo |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-032 | 관련 클래스명 | LsDataLblAttrVal |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-033 | 관련 클래스명 | LsDataMeta |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-034 | 관련 클래스명 | LsDataMetaHstry |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-035 | 관련 클래스명 | LsDataMetaReview |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-040 | 관련 클래스명 | LsDataAug |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-041 | 관련 클래스명 | LsDataAugRvw |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-042 | 관련 클래스명 | LsDataAugLblMap |
...
### KLID-AT-EN-010 · LS_DATA_SET (학습데이터셋내보내기)

| 엔티티 ID | KLID-AT-EN-010 | 엔티티명 | LS_DATA_SET |
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-043 | 관련 클래스명 | LsDataSet |
| 엔티티 설명 | 학습데이터셋 내보내기(EXPORT) 작업. 저작도구 범위 외(폐기 방향)이나 코드(V8·V34) 잔존 테이블. |

| 속성명 | 동의어 | 타입 | 길이 | NOT NULL (Y/N) | PK (Y/N) | FK (Y/N) | INX (Y/N) | 기본값 | 제약조건 |
|-------|--------|------|------|--------|------|------|------|-------|--------|
| EXPORT_SN | 내보내기일련번호 | BIGINT | — | Y | Y | N | Y | IDENTITY | PK |
| EXPORT_FMT | 내보내기포맷 | VARCHAR | 20 | Y | N | N | N | — | YOLO/COCO |
| EXPORT_STTS_CD | 내보내기상태코드 | VARCHAR | 20 | Y | N | N | Y | PENDING | PENDING/IN_PROGRESS/COMPLETED/FAILED |
| NAS_FILE_PATH_NM | NAS파일경로명 | VARCHAR | 500 | N | N | N | N | — | 산출물 디렉토리 경로 |
| ERR_MSG | 오류메시지 | VARCHAR | 1000 | N | N | N | N | — | FAILED 시 사유 |
| PRCS_DT | 처리일시 | TIMESTAMP | — | N | N | N | N | — | COMPLETED 완료 일시 |
| REGISTERED_USER_NO | 등록사용자번호 | VARCHAR | 50 | N | N | N | N | — | — |
| REGISTERED_AT | 등록일시 | TIMESTAMP | — | Y | N | N | N | CURRENT_TIMESTAMP | — |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-011 | 관련 클래스명 | LsDataSrc |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-012 | 관련 클래스명 | LsDataRawHstry |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-013 | 관련 클래스명 | LsDataSrcHstry |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-050 | 관련 클래스명 | LsMarking |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-060 | 관련 클래스명 | LsTaskAssignment |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-061 | 관련 클래스명 | LsTaskAssignHistory |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-062 | 관련 클래스명 | LsTaskEventLog |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-070 | 관련 클래스명 | LsRawDataEnrollment |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-071 | 관련 클래스명 | LsRawDataStatus |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-072 | 관련 클래스명 | LsDataIssue |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-080 | 관련 클래스명 | LsSystemConfig |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-081 | 관련 클래스명 | LsMeta |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-090 | 관련 클래스명 | LsDeidentProcLog |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-091 | 관련 클래스명 | LsDeidentReport |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-100 | 관련 클래스명 | LsPortalUserLabel |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-110 | 관련 클래스명 | LsLabel |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-111 | 관련 클래스명 | LsLabelAttr |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-112 | 관련 클래스명 | LsLabelPreset |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-113 | 관련 클래스명 | LsLabelPresetCode |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-114 | 관련 클래스명 | LsLabelVersion |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-120 | 관련 클래스명 | LsBatchProcLog |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-121 | 관련 클래스명 | LsAuthWorkLock |
...
> **추가 엔티티(LS_DEADLINE·LS_CONTROL_NOTIFY_FALLBACK·LS_WEBHOOK_IDEMPOTENCY)**는 D9 테이블 명세(KLID-AT-TB-033~035)에 상세 기술하며, 본 엔티티 명세서는 EN-001~034 범위로 작성한다.
...
- 프로젝트 ID: `KLID`
- 서브시스템 ID (저작도구): `AT`
- 산출물 파일명: `KLID_AT_엔티티관계모형설계서_Rev 1.0`
- ERD ID: `KLID-AT-ERD-010~021` (활성 12건)
- 엔티티 ID: `KLID-AT-EN-001~034`
