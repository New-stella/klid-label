...
| 2026-06-05 | 1.4 | **KLID-AT-EN-009·KLID-AT-EN-034 관련 클래스 매핑 연결** — 관련 유스케이스 ID는 있으나 관련 클래스 ID가 `- ※`로 비대칭이던 2건 해소: D1 v1.4에서 LsDataAugLblMap(KLID-AT-DC-048)·LsAuthWorkLock(KLID-AT-DC-049) 정식 등재(EN-009는 UC-002 라벨 복사 매핑 쓰기 경로 코드 구현 동반). 잔여 `- ※`는 전건 관련 클래스 ID·관련 유스케이스 ID 양쪽 `- ※`(R1 기능 요구사항 UC 비사용 도메인)로 표기 불변식 정합 | 박찬기 | - |
| 2026-06-05 | 1.5 | **소유 테이블 전수 매핑 완성** — R2 v1.3 유스케이스 확대(KLID-AT-UC-018~026)·D1 v1.5 클래스 등재(KLID-AT-DC-050~096)에 따라 `- ※` 21건 중 17건 매핑 연결(기존 13 UC 실사용 누락 6건 포함). 잔여 4건(LS_DATA_META_HSTRY·LS_DATA_RAW_HSTRY·LS_RAW_DATA_ENROLLMENT·LS_META)은 코드 호출처 0건 확인 — 예약(미구현) 명시 유지. 표기 불변식: 매핑 30건 양쪽 기재 + 예약 4건 양쪽 `- ※`(사유 명시), 비대칭 0건. ※ 기존 매핑 정정: EN-001(LsDataLbl)에서 UC-005, EN-011(LsDataRaw)에서 UC-001은 D1 v1.5 §1 목록에 해당 DC 미등장으로 제외 | 박찬기 | - |
...
> **관련 클래스 ID 기준**: D1 클래스설계서(v1.5)의 설계 클래스 ID(`KLID-AT-DC-NNN`)와 매핑한다.
> **관련 유스케이스 ID 기준**: R2 유스케이스명세서(v1.3 — KLID-AT-UC-018~026 확대 포함)의 UC ID와 매핑한다(근거: D1 §1 설계 클래스 목록 + R3 추적표). 요구사항(R1 RQ-SFR) 연관은 R2 §3(UC→RQ) 및 R3 가로 추적표를 경유한다. `- ※`는 어떤 유스케이스 실현 코드도 영속 접근하지 않는 **예약(미구현) 엔티티**다(2026-06-05 코드 전수 조사 — LS_DATA_META_HSTRY·LS_DATA_RAW_HSTRY·LS_RAW_DATA_ENROLLMENT·LS_META 4건). 사용 UC·설계 클래스가 부재하므로 관련 클래스 ID·관련 유스케이스 ID 양쪽을 `- ※`로 두고 관련 클래스명(JPA 엔티티 클래스)만 기재한다.
...
| 관련 유스케이스 ID | KLID-AT-UC-004, KLID-AT-UC-021, KLID-AT-UC-024 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-050 | 관련 클래스명 | LsDataLblAttrVal |
| 관련 유스케이스 ID | KLID-AT-UC-016, KLID-AT-UC-021 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-051 | 관련 클래스명 | LsDataMeta |
...
> ※ 예약(미구현) — 설계 의도만 존재하고 코드 호출처 0건(2026-06-05 전수 조사). 사용 UC·설계 클래스 부재로 양쪽 `- ※` 유지. 물리 테이블 존치/제거는 별도 마이그레이션 결정.
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-073 | 관련 클래스명 | LsDataMetaReview |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-048 | 관련 클래스명 | LsDataAugLblMap |
...
| 관련 유스케이스 ID | KLID-AT-UC-002, KLID-AT-UC-003, KLID-AT-UC-011, KLID-AT-UC-016, KLID-AT-UC-018 |
...
| 관련 유스케이스 ID | KLID-AT-UC-004, KLID-AT-UC-016, KLID-AT-UC-026 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-096 | 관련 클래스명 | LsDataSrcHstry |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-060 | 관련 클래스명 | LsMarking |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-052 | 관련 클래스명 | LsTaskAssignment |
| 관련 유스케이스 ID | KLID-AT-UC-004, KLID-AT-UC-005, KLID-AT-UC-007, KLID-AT-UC-008, KLID-AT-UC-016, KLID-AT-UC-020 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-065 | 관련 클래스명 | LsTaskAssignHistory |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-053 | 관련 클래스명 | LsTaskEventLog |
| 관련 유스케이스 ID | KLID-AT-UC-007, KLID-AT-UC-020, KLID-AT-UC-023 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-054 | 관련 클래스명 | LsRawDataStatus |
| 관련 유스케이스 ID | KLID-AT-UC-001, KLID-AT-UC-003, KLID-AT-UC-009, KLID-AT-UC-016, KLID-AT-UC-018, KLID-AT-UC-022, KLID-AT-UC-023, KLID-AT-UC-026 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-077 | 관련 클래스명 | LsDataIssue |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-080 | 관련 클래스명 | LsPortalUserLabel |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-055 | 관련 클래스명 | LsLabel |
| 관련 유스케이스 ID | KLID-AT-UC-009, KLID-AT-UC-021 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-067 | 관련 클래스명 | LsLabelAttr |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-084 | 관련 클래스명 | LsLabelPreset |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-085 | 관련 클래스명 | LsLabelPresetCode |
| 관련 유스케이스 ID | KLID-AT-UC-025 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-095 | 관련 클래스명 | LsBatchProcLog |
| 관련 유스케이스 ID | KLID-AT-UC-026 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-049 | 관련 클래스명 | LsAuthWorkLock |
| 관련 유스케이스 ID | KLID-AT-UC-016 |
...
|---------|---|-------|---|
| 관련 클래스 ID | KLID-AT-DC-068 | 관련 클래스명 | LsDataLblHstry |
| 관련 유스케이스 ID | KLID-AT-UC-016, KLID-AT-UC-021 |
