...
| SRC_BKUP_FILE_PATH_NM | srcBkupFilePathNm | VARCHAR | 1000 | N | N | N | N | | 비식별 프레임 경로 |
...
| ORGN_FILE_PATH_NM | orgnFilePathNm | VARCHAR | 1000 | Y | N | N | N | | 원본 경로 |
...
| ORGN_DATA_LBL_SN | orgnDataLblSn | BIGINT | | N | N | Y | Y | | 원본 라벨 / IDX_..._LBL_MAP_ORGN |
