...
| Domain | DOMAIN-016 |
| Last sync | 2026-08-31T11:12:42.106Z |
| Mode | SYNC — NEW 0 / CHANGED 0 / UNCHANGED 65 |
...
```
  ...
  ℹ️  use_case: 이번 키트 1건 / 스코프 밖 33건 (그중 domain_id 없음 2건)
  ℹ️  domain_event: 이번 키트 5건 / 스코프 밖 7건
  ℹ️  acceptance: 이번 키트 2건 / 스코프 밖 71건
...
|---|---|---|---|
| [[AC-1077]] | acceptance | 5 | UNCHANGED |
| [[AC-1078]] | acceptance | 7 | UNCHANGED |
...
| [[CDIAG-013]] | class_diagram | 8 | UNCHANGED |
