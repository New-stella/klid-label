---
logicraft_item: CDIAG-020
type: class_diagram
version: 1
domain: DOMAIN-006
project_id: 4ece2c3f-8e99-46f5-9580-71108a76e578
synced_at: 2026-09-05T00:45:18.714Z
status: NEW
prev_version: null
content_hash: ea264ba0c1675fc6e392006e2d140ed12347ff2aa2c690f0c94778646435e2e2
stale: false
raw: ./_raw/CDIAG-020.json
links:
  belongs_to_domain: ["[[DOMAIN-006]]"]
---

# 통계·대시보드 표현 계층 — 컨트롤러 오퍼레이션
...
- **is_static**: false
- **visibility**: public
- **description**: 대시보드에 쓰는 요약 지표를 조회한다
- **is_abstract**: false
- **return_type**: 응답 래퍼
...
- **is_static**: false
- **visibility**: public
- **description**: 검수완료 기준 수치와 전체 기준 수치를 함께 조회한다
- **is_abstract**: false
- **return_type**: 응답 래퍼
...
- **is_static**: false
- **visibility**: public
- **description**: 화면이 보여준 다섯 축을 같은 시점 기준으로 묶어 한 파일로 내려보낸다
- **is_abstract**: false
- **return_type**: 파일 응답
