...
| Domain | DOMAIN-004 |
| Last sync | 2026-09-02T10:52:15.846Z |
| Mode | SYNC — NEW 0 / CHANGED 16 / UNCHANGED 103 |
...
```
  ...
  ℹ️  api_endpoint: 이번 키트 27건 / 스코프 밖 193건
  ...
  ℹ️  acceptance: 이번 키트 16건 / 스코프 밖 64건
  ℹ️  constant: 이번 키트 1건 / 스코프 밖 1건 (그중 domain_id 없음 1건)
  ℹ️  adr: 이번 키트 21건 / 스코프 밖 31건 (그중 domain_id 없음 4건)
...
| [[INFRA-001]] | infra_component | 8 | CHANGED |
