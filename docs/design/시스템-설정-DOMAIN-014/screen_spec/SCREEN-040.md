...
synced_at: 2026-08-28T11:38:12.542Z
status: NEW
prev_version: null
...
- **note**: 확인으로 열리는 것은 잠깐 열리는 유효창이며 역할이 바뀌는 것이 아니다. 검수자 권한은 그대로 필요하다.
- **type**: Text
