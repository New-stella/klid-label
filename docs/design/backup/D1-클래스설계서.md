...
|------|------|------------|--------|--------|
| 2026-05-31 | 1.0 | 최초 작성 — R2 유스케이스(KLID-AT-UC-001~015) 매핑 설계 클래스 도출. 실제 코드 기반 시퀀스도 6종·클래스도 5종·클래스 정의 12종 기술 | 박찬기 | 김현욱 |
| 2026-06-02 | 1.1 | RQ-SFR-09-06·09-07(KLID-AT-UC-014/015) 범위 외 삭제 반영 — SFR 18→16개, 대상 UC KLID-AT-UC-001~013. KLID-AT-DC-041(SystemConfigService)·KLID-AT-DC-042(LsSystemConfig)의 KLID-AT-UC-014/015 매핑 제거(KLID-AT-UC-006·KLID-AT-UC-013만 유지), 관련 참고 주석 정리. 두 설정 클래스는 정밀도(KLID-AT-UC-006)·비식별 옵션(KLID-AT-UC-013) 키 관리 용도로 유지 | 박찬기 | 김현욱 |
| 2026-06-02 | 1.2 | **§1 설계 클래스 목록을 CBD 양식대로 유스케이스(UCD)별로 재작성** — 기존 전역 1개 표(KLID-AT-DC-001~042)를 §3 클래스도(KLID-AT-DCD-001~005)와 1:1 대응하는 5개 UCD별 목록(§1.1~§1.5)으로 분할, 공유 클래스는 `(공유)`로 중복 등재. §2 시퀀스도(UC별)·§3 클래스도(UCD별)·§4 클래스 정의(클래스별)는 이미 양식 준수하여 유지 | 박찬기 | 김현욱 |
...
|------------|---------|------|-------------|
| KLID-AT-DC-001 | AugmentController | Controller | KLID-AT-UC-001, KLID-AT-UC-002, KLID-AT-UC-010 |
| KLID-AT-DC-002 | AugmentRequestService | Service | KLID-AT-UC-001 |
| KLID-AT-DC-003 | AugmentReviewService | Service | KLID-AT-UC-002, KLID-AT-UC-010 |
| KLID-AT-DC-004 | LabelIntegrityCalculator | Service(Util) | KLID-AT-UC-002 |
| KLID-AT-DC-005 | ExternalAugmentClient | Client | KLID-AT-UC-001, KLID-AT-UC-002 |
| KLID-AT-DC-006 | LsDataAug | Entity | KLID-AT-UC-002, KLID-AT-UC-010 |
| KLID-AT-DC-007 | LsDataAugRvw | Entity | KLID-AT-UC-010 |
| KLID-AT-DC-008 | LsDataAugLblMap | Entity | KLID-AT-UC-002, KLID-AT-UC-003 |
| KLID-AT-DC-009 | LsDataAugRepository | Repository | KLID-AT-UC-002, KLID-AT-UC-010 |
| KLID-AT-DC-010 | LsDataAugRvwRepository | Repository | KLID-AT-UC-010 |
| KLID-AT-DC-039 | LsDataRaw | Entity | KLID-AT-UC-002, KLID-AT-UC-011 (공유) |

### 1.2 KLID-AT-DCD-002 AI 보조 라벨링 (KLID-AT-UC-004, KLID-AT-UC-005, KLID-AT-UC-006)

| 설계 클래스 ID | 설계 클래스명 | 레이어 | 관련 유스케이스 ID |
|------------|---------|------|-------------|
| KLID-AT-DC-011 | LabelController | Controller | KLID-AT-UC-004, KLID-AT-UC-005, KLID-AT-UC-007 (공유) |
| KLID-AT-DC-012 | Sam2TrackService | Service | KLID-AT-UC-004, KLID-AT-UC-005, KLID-AT-UC-006 |
| KLID-AT-DC-013 | TrackInterpolator | Service(Util) | KLID-AT-UC-004 |
| KLID-AT-DC-014 | AiServerClient | Client | KLID-AT-UC-004, KLID-AT-UC-005 |
| KLID-AT-DC-015 | Sam2TrackRequest | DTO | KLID-AT-UC-004, KLID-AT-UC-005 |
| KLID-AT-DC-016 | Sam2TrackResponseDto | DTO | KLID-AT-UC-004, KLID-AT-UC-005 |
| KLID-AT-DC-018 | LsDataLbl | Entity | KLID-AT-UC-004, KLID-AT-UC-005, KLID-AT-UC-007 (공유) |
| KLID-AT-DC-019 | LsDataLblRepository | Repository | KLID-AT-UC-004, KLID-AT-UC-007 (공유) |
...
> SystemConfig(KLID-AT-DC-040~042)는 라벨링 정밀도(KLID-AT-UC-006)와 비식별 옵션(KLID-AT-UC-013) 설정 키를 함께 관리한다(KLID-AT-UC-013은 KLID-AT-UCD-005 비식별 흐름에서도 참조).
...
| KLID-AT-DC-020 | VersionController | Controller | KLID-AT-UC-007, KLID-AT-UC-008 |
| KLID-AT-DC-021 | VersionService | Service | KLID-AT-UC-007, KLID-AT-UC-008 |
| KLID-AT-DC-022 | LsLabelVersion | Entity | KLID-AT-UC-007, KLID-AT-UC-008 |
| KLID-AT-DC-023 | LsLabelVersionRepository | Repository | KLID-AT-UC-007, KLID-AT-UC-008 |
| KLID-AT-DC-024 | LabelDiffDto | DTO | KLID-AT-UC-008 |
| KLID-AT-DC-025 | VersionItem | DTO | KLID-AT-UC-007, KLID-AT-UC-008 |

### 1.4 KLID-AT-DCD-004 검수 (KLID-AT-UC-010, KLID-AT-UC-012)

| 설계 클래스 ID | 설계 클래스명 | 레이어 | 관련 유스케이스 ID |
|------------|---------|------|-------------|
| KLID-AT-DC-026 | ReviewController | Controller | KLID-AT-UC-010, KLID-AT-UC-012 |
| KLID-AT-DC-027 | ReviewService | Service | KLID-AT-UC-010, KLID-AT-UC-012 |
| KLID-AT-DC-028 | ReviewStateMachine | Service(Domain) | KLID-AT-UC-010 |
| KLID-AT-DC-029 | LsRawDataStatus | Entity | KLID-AT-UC-009, KLID-AT-UC-010 (공유) |
| KLID-AT-DC-030 | LsDataIssue | Entity | KLID-AT-UC-010 |

### 1.5 KLID-AT-DCD-005 비식별 + 데이터마트 통지 (KLID-AT-UC-009, KLID-AT-UC-011, KLID-AT-UC-012)
...
| KLID-AT-DC-035 | DeidentController | Controller | KLID-AT-UC-011, KLID-AT-UC-012 |
| KLID-AT-DC-036 | DeidentifyClient | Client | KLID-AT-UC-011 |
| KLID-AT-DC-037 | DeidentifyResultService | Service | KLID-AT-UC-011, KLID-AT-UC-012 |
...
> 설계 클래스 ID는 전 UCD에 걸쳐 유일하다(KLID-AT-DC-001~042). 동일 클래스가 여러 UCD에 관여하면 각 UCD 목록에 `(공유)` 로 중복 등재한다.

> **참고 (코드 정합)**:
> - **패키지 소속 정정**: `LsDataLbl`(KLID-AT-DC-018, LS_DATA_LBL)·`LsDataLblRepository`(KLID-AT-DC-019)·`LsDataSrcRepository` 는 label 도메인이 아니라 **batch 패키지**에 위치한다(`batch/entity/LsDataLbl.java`, `batch/repository/LsDataLblRepository.java`, `batch/repository/LsDataSrcRepository.java`). label·review·augment 도메인은 batch 산출물(라벨/프레임)을 공유 참조한다. 위 §1 표의 레이어 분류는 클래스 책임 기준이며 물리 패키지가 아니다.
> - SAM2 추적·외곽 밀착(KLID-AT-UC-004/005)은 `LabelController.sam2Track()` → `Sam2TrackService.track()` 로 진입한다(단독 Sam2TrackController 클래스는 없음).
> - KLID-AT-UC-003(해상도 변경)은 증강 결과 라벨 매핑(LsDataAugLblMap, KLID-AT-DC-008)의 `coordRecalcYn/scaleX/scaleY` 와 라벨 복사(`LsDataLbl.copyForNewSrc`)에 흡수된다.
> - KLID-AT-UC-011(비식별)의 실제 처리 흐름은 배치 `DeidentifyStep`(외부 위탁) + webhook `DeidentifyResultService`(결과 인계)이며, `DeidentController` 는 현재 조회 placeholder 단계다.
> - SystemConfig(KLID-AT-DC-040~042)는 라벨링 정밀도(KLID-AT-UC-006)·비식별 옵션(KLID-AT-UC-013) 설정 키 관리 용도다. (구 KLID-AT-UC-014/015 매핑은 RQ-SFR-09-06/07 범위 외 삭제로 제거됨 — 2026-06-02)

---

## 2. 시퀀스도

### 2.1 객체 자동 추적 (KLID-AT-UC-004)
...
### 2.2 객체 외곽 경계 자동 밀착 (KLID-AT-UC-005)
...
### 2.3 증강 결과 수신·등록 (KLID-AT-UC-002)
...
R --> S : LsDataAug
S --> WH : 등록 완료 (이후 KLID-AT-UC-010 검수 대기)
@enduml
```

### 2.4 버전 비교·복구 (KLID-AT-UC-008)
...
### 2.5 데이터마트 수정 통지 (KLID-AT-UC-009)
...
### 2.6 비식별 처리 요청·결과 수신 (KLID-AT-UC-011)
...
|-----------|---|---------|---|
| 관련 유스케이스 ID | KLID-AT-UC-009, KLID-AT-UC-011, KLID-AT-UC-012 |
...
| copyForNewSrc | public(static) | newSrcSn, original | LsDataLbl | 증강 새 영상용 라벨 복사(KLID-AT-UC-002/003) |
...
|-----------|---------|-------------|
| KLID-AT-DCD-001 | 데이터 증강(요청·결과 수신·검수) | KLID-AT-UC-001, KLID-AT-UC-002, KLID-AT-UC-003, KLID-AT-UC-010 |
| KLID-AT-DCD-002 | AI 보조 라벨링(추적·밀착·정밀도) | KLID-AT-UC-004, KLID-AT-UC-005, KLID-AT-UC-006 |
| KLID-AT-DCD-003 | 라벨 저장·버전관리 | KLID-AT-UC-007, KLID-AT-UC-008 |
| KLID-AT-DCD-004 | 검수 워크플로우(승인·반려) | KLID-AT-UC-010, KLID-AT-UC-012 |
| KLID-AT-DCD-005 | 비식별 + 데이터마트 통지 | KLID-AT-UC-009, KLID-AT-UC-011, KLID-AT-UC-012 |
