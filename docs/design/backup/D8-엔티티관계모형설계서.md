...
> **작성 범위 (R1·R2 정합)**: 본 설계서는 R1 요구사항 16개에 매핑된 R2 유스케이스(증강·라벨링·버전관리·검수·비식별·시계열메타)와 직접 관련된 저작도구 전용 `LS_*` 테이블만 대상으로 한다. (구 RQ-SFR-09-06/07은 2026-06-02 범위 외 삭제 — 시스템설정 영역으로 본 설계서 본래 제외 대상, 엔티티 불변) R1/R2 범위 밖 테이블(사용자/권한 `MNG_*`·마킹 `LS_MARKING`·포털 `LS_PORTAL_*`·시스템설정·게시판·배치로그·`QRTZ_*`)은 본 설계서에서 제외한다. 영상/프레임(`LS_DATA_RAW`, `LS_DATA_SRC`)은 증강·라벨·비식별·메타의 기반 엔티티이므로 포함한다.
...
| 2026-06-02 | 1.1 | RQ-SFR-09-06·09-07 범위 외 삭제 반영 — 작성 범위 SFR 18→16개로 갱신. 두 요구사항은 시스템설정 영역으로 본 설계서 본래 제외 대상이라 엔티티·ERD 불변 | 박찬기 | 김현욱 |
| 2026-06-02 | 1.2 | CBD 적합성 — §2 엔티티 명세 KLID-AT-EN-024 배치 순서 정렬(오름차순). LS_DATA_LBL_HSTRY 블록을 KLID-AT-EN-019 뒤에서 KLID-AT-EN-023 뒤(§2 말미)로 이동, 블록 내용 불변 | 박찬기 | 김현욱 |
...
| DATA_RAW_SN | dataRawSn | BIGINT | | Y | N | Y | Y | | IDX_LS_LABEL_VERSION_TARGET(DATA_RAW_SN, DATA_SRC_SN, ACTIVE_YN) 복합 |
...
|-----------|---------|-----------|------------|
| KLID-AT-EN-001 | LS_DATA_RAW | LsDataRaw | 영상(KLID-AT-ERD-001) |
| KLID-AT-EN-002 | LS_DATA_RAW_HSTRY | LsDataRawHstry | 영상(KLID-AT-ERD-001) |
| KLID-AT-EN-003 | LS_DATA_SRC | LsDataSrc | 영상(KLID-AT-ERD-001) |
| KLID-AT-EN-004 | LS_DATA_SRC_HSTRY | LsDataSrcHstry | 영상(KLID-AT-ERD-001) |
| KLID-AT-EN-005 | LS_LABEL | LsLabel | 라벨링(KLID-AT-ERD-002) |
| KLID-AT-EN-006 | LS_DATA_LBL | LsDataLbl | 라벨링(KLID-AT-ERD-002) |
| KLID-AT-EN-007 | LS_LABEL_ATTR | LsLabelAttr | 라벨링(KLID-AT-ERD-002) |
| KLID-AT-EN-008 | LS_DATA_LBL_ATTR_VAL | LsDataLblAttrVal | 라벨링(KLID-AT-ERD-002) |
| KLID-AT-EN-009 | LS_DATA_LBL_AI_INFO | LsDataLblAiInfo | 라벨링(KLID-AT-ERD-002) |
| KLID-AT-EN-010 | LS_LABEL_PRESET | LsLabelPreset | 라벨링(KLID-AT-ERD-002) |
| KLID-AT-EN-011 | LS_LABEL_PRESET_CODE | LsLabelPresetCode | 라벨링(KLID-AT-ERD-002) |
| KLID-AT-EN-012 | LS_DATA_META | LsDataMeta | 시계열메타(KLID-AT-ERD-003) |
| KLID-AT-EN-013 | LS_DATA_META_HSTRY | LsDataMetaHstry | 시계열메타(KLID-AT-ERD-003) |
| KLID-AT-EN-014 | LS_DATA_META_REVIEW | LsDataMetaReview | 시계열메타(KLID-AT-ERD-003) |
| KLID-AT-EN-015 | LS_DEIDENT_PROC_LOG | LsDeidentProcLog | 비식별(KLID-AT-ERD-004) |
| KLID-AT-EN-016 | LS_DEIDENT_REPORT | LsDeidentReport | 비식별(KLID-AT-ERD-004) |
| KLID-AT-EN-017 | LS_DATA_ISSUE | LsDataIssue | 검수(KLID-AT-ERD-005) |
| KLID-AT-EN-018 | LS_RAW_DATA_STATUS | LsRawDataStatus | 검수(KLID-AT-ERD-005) |
| KLID-AT-EN-019 | LS_LABEL_VERSION | LsLabelVersion | 버전관리(KLID-AT-ERD-006) |
| KLID-AT-EN-020 | LS_DATA_AUG | LsDataAug | 증강(KLID-AT-ERD-007) |
| KLID-AT-EN-021 | LS_DATA_AUG_RVW | LsDataAugRvw | 증강(KLID-AT-ERD-007) |
| KLID-AT-EN-022 | LS_DATA_AUG_LBL_MAP | LsDataAugLblMap | 증강(KLID-AT-ERD-007) |
| KLID-AT-EN-023 | LS_DATA_SET | LsDataSet | 증강·내보내기(KLID-AT-ERD-007, 범위 경계) |
| KLID-AT-EN-024 | LS_DATA_LBL_HSTRY | LsDataLblHstry | 버전관리(KLID-AT-ERD-006) |
