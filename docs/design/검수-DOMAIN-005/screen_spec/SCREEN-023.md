...
synced_at: 2026-09-02T10:52:16.813Z
status: CHANGED
prev_version: 41
content_hash: 4d4476512a6ea6d92415fe1208c4a293eaa85587e795779fc4a5af0d82c2db04
stale: false
...
links:
  ...
  implements: ["[[IMPREC-210]]"]
  realizes: ["[[UC-002]]", "[[UC-010]]"]
  references: ["[[API-061]]", "[[API-062]]", "[[API-063]]", "[[API-188]]", "[[API-189]]", "[[API-190]]", "[[FEAT-004]]"]
  requires: ["[[ROLE-001]]"]
  applies_to_backward: ["[[SHELL-001]]"]
  designs_backward: ["[[SD-029]]"]
  granted_on_backward: ["[[ROLE-001]]"]
  navigates_to_backward: ["[[NAV-001]]"]
  realizes_backward: ["[[MOD-013]]"]
  references_backward: ["[[TEST-003]]", "[[UC-002]]", "[[UC-010]]"]
---
