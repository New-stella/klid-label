...
| Domain | DOMAIN-005 |
| Last sync | 2026-09-17T01:15:47.667Z |
...
```
  ...
  ℹ️  api_endpoint: 이번 키트 27건 / 스코프 밖 211건
  ℹ️  erd: 이번 키트 3건 / 스코프 밖 22건
  ℹ️  diagram_sequence: 이번 키트 5건 / 스코프 밖 31건 (그중 domain_id 없음 11건)
  ℹ️  screen_spec: 이번 키트 4건 / 스코프 밖 35건
  ℹ️  use_case: 이번 키트 6건 / 스코프 밖 31건
  ℹ️  domain_event: 이번 키트 5건 / 스코프 밖 7건
  ℹ️  acceptance: 이번 키트 20건 / 스코프 밖 103건 (그중 domain_id 없음 18건)
  🚨 constant: 이번 키트 0건 / 프로젝트 전역 2건 (그중 domain_id 없음 2건) — 전량 누락
  ℹ️  adr: 이번 키트 13건 / 스코프 밖 52건 (그중 domain_id 없음 8건)
