...
| Domain | DOMAIN-005 |
| Last sync | 2026-09-08T00:22:49.394Z |
| Mode | SYNC — NEW 0 / CHANGED 2 / UNCHANGED 136 |
...
```
  ...
  ℹ️  acceptance: 이번 키트 9건 / 스코프 밖 78건 (그중 domain_id 없음 7건)
...
| [[CDIAG-014]] | class_diagram | 17 | CHANGED |
