...
| Domain | DOMAIN-005 |
| Last sync | 2026-09-03T07:39:15.572Z |
| Mode | SYNC — NEW 2 / CHANGED 6 / UNCHANGED 102 |
...
```
  ...
  ℹ️  diagram_sequence: 이번 키트 5건 / 스코프 밖 30건 (그중 domain_id 없음 11건)
  ...
  ℹ️  adr: 이번 키트 10건 / 스코프 밖 45건 (그중 domain_id 없음 8건)
...
- NEW [[AC-1057]]
- NEW [[AC-1058]]
- CHANGED [[CDIAG-006]] (prev v13)
- CHANGED [[CMP-005]] (prev v7)
- CHANGED [[DOMAIN-005]] (prev v15)
- CHANGED [[DFEAT-024]] (prev v12)
...
| [[AC-1057]] | acceptance | 6 | NEW |
| [[AC-1058]] | acceptance | 10 | NEW |
