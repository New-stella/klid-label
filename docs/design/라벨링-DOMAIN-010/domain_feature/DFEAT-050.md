...
synced_at: 2026-08-29T01:27:31.636Z
status: CHANGED
prev_version: 6
content_hash: 0fb9d1e45333cd01e9c0cc528470812825f86d93f60331d6e6fa66410d5ee2c7
stale: false
...
links:
  ...
  realizes_backward: ["[[MOD-047]]"]
---

# 이벤트 어노테이션(VQA/CoT) 검토·수정
...
2026-07-30 독립 DFEAT로 승격 확정(ADR-036) — 원 설계 결정(ADR-020, export event 키)은 decided_by에 유지
...
이벤트 어노테이션(VQA/CoT/caption) 검토·수정 신규 — FEAT-009 롤업, export event 키(ADR-020)
...
VLM 이 생성한 이벤트 어노테이션(VQA/CoT/caption)을 검토·수정하고 caption 을 수동 보정한 뒤 승인·반려하기를 원한다

### so_that

검증된 이벤트 어노테이션만 학습데이터 export(event 키)에 포함된다
