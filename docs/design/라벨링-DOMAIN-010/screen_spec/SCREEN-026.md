...
synced_at: 2026-08-16T14:48:54.441Z
status: NEW
prev_version: null
content_hash: e720d80b3cbe0ac42760000f9d3bd7f6a52ed5597a7da27542798563fc9f9646
stale: true
raw: ./_raw/SCREEN-026.json
links:
  belongs_to_domain: ["[[DOMAIN-010]]"]
  consumes: ["[[API-037]]", "[[API-038]]", "[[API-039]]", "[[API-040]]", "[[API-041]]", "[[API-117]]"]
  migrated_from: ["[[LEGACY-004]]"]
  realizes: ["[[UC-032]]"]
  references: ["[[API-037]]", "[[API-038]]", "[[API-039]]", "[[API-040]]", "[[API-041]]"]
  requires: ["[[ROLE-001]]"]
