...
synced_at: 2026-08-16T14:48:54.385Z
status: NEW
prev_version: null
content_hash: 04e52c137fa9d6316fe83b874394b501acd07ac24c65c1b7cad866567d76105d
stale: true
raw: ./_raw/SCREEN-010.json
links:
  belongs_to_domain: ["[[DOMAIN-010]]"]
  consumes: ["[[API-034]]", "[[API-035]]", "[[API-036]]", "[[API-182]]", "[[API-195]]", "[[API-197]]"]
  migrated_from: ["[[LEGACY-004]]"]
  realizes: ["[[UC-008]]"]
  references: ["[[API-182]]", "[[API-195]]", "[[API-197]]"]
  requires: ["[[ROLE-001]]", "[[ROLE-002]]"]
  designs_backward: ["[[SD-032]]"]
  granted_on_backward: ["[[ROLE-002]]"]
  realizes_backward: ["[[MOD-007]]"]
---
