...
| Domain | DOMAIN-010 |
| Last sync | 2026-09-02T10:52:19.880Z |
| Mode | SYNC — NEW 0 / CHANGED 14 / UNCHANGED 156 |
...
```
  ...
  ℹ️  acceptance: 이번 키트 11건 / 스코프 밖 69건 (그중 domain_id 없음 2건)
  ℹ️  adr: 이번 키트 19건 / 스코프 밖 33건 (그중 domain_id 없음 4건)
