...
## 작성 목적
> 소프트웨어 관점이나 설계 관점에서의 클래스 모형을 작성한다. 본 산출물은 R1 사용자 요구사항(SFR-06~09, 18개)에 매핑된 R2 유스케이스(KLID-AT-UC-001~015)와 직접 관련된 설계 클래스만을 대상으로 한다. R1/R2 범위 밖 도메인(사용자/권한, 마킹, 배치 트리거, 포털, 게시판, 통계)은 제외한다.
...
> R2 유스케이스 단위로 도출한다. 레이어는 Controller / Service / Repository / Entity / Client(외부 연동) / Listener / DTO·Util 로 구분한다.
...
| KLID-AT-DC-011 | LabelController | Controller | KLID-AT-UC-004, UC-005, UC-007 |
...
| KLID-AT-DC-018 | LsDataLbl | Entity | KLID-AT-UC-004, UC-005, UC-007 |
| KLID-AT-DC-019 | LsDataLblRepository | Repository | KLID-AT-UC-004, UC-007 |
...
| KLID-AT-DC-029 | LsRawDataStatus | Entity | KLID-AT-UC-009, UC-010 |
...
| KLID-AT-DC-039 | LsDataRaw | Entity | KLID-AT-UC-011, UC-002 |
| KLID-AT-DC-040 | SystemConfigController | Controller | KLID-AT-UC-006, UC-013 |
| KLID-AT-DC-041 | SystemConfigService | Service | KLID-AT-UC-006, UC-013, UC-014, UC-015 |
| KLID-AT-DC-042 | LsSystemConfig | Entity | KLID-AT-UC-006, UC-013, UC-014, UC-015 |
...
> - UC-014(개인정보 보호대책)·UC-015(개인정보 유형 분류체계)는 독립 도메인 클래스가 아직 없고 SystemConfig(DC-040~042) 설정 키 기반으로 관리되므로 해당 클래스에 매핑한다.
