...
| 2026-07-20 | 1.1 | - | - | R1~R12 반영 — Sam2TrackService DB 미저장 전환(DCD-004·DC-075, labelRepository 의존 제거), LabelController/LabelService에 라벨 변경 이력 조회(getLabelHistory/getHistory) 추가, LsDataLblHstry(DC-093)에 recordChange·chgKindCd·regId 추가(V112) |
