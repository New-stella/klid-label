...
synced_at: 2026-09-07T13:23:46.560Z
status: CHANGED
prev_version: 43
content_hash: 086e260225ae60615deb5ddce13324bc568dbac4741d5175ab6363cbb4e32c7c
stale: true
raw: ./_raw/SCREEN-039.json
links:
  based_on: ["[[ADR-065]]"]
  belongs_to_domain: ["[[DOMAIN-017]]"]
  consumes: ["[[API-205]]", "[[API-206]]", "[[API-207]]", "[[API-208]]", "[[API-209]]", "[[API-210]]", "[[API-211]]", "[[API-215]]", "[[API-216]]", "[[API-217]]", "[[API-218]]", "[[API-221]]", "[[API-222]]"]
  covered_by: ["[[AC-1032]]", "[[AC-1033]]"]
  implements: ["[[IMPREC-111]]"]
  realizes: ["[[UC-035]]", "[[UC-036]]", "[[UC-037]]"]
