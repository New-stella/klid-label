...
|---|---|---|---|
| KLID-AT-CO-001 | BatchOrchestration | Quartz 트리거 → VLM→비식별→프레임→YOLO→SAM2→보간 6단계 자동 파이프라인 오케스트레이션 | UC-001, UC-002, UC-004 |
...
| KLID-AT-CO-006 | Augment | 외부 생성형 AI 비동기 요청·검토(수락/거절) | UC-011 |
| KLID-AT-CO-007 | PortalChannel | TUS 업로드, 본인 데이터 한정 오토라벨링·라벨 수락 | UC-012 |
