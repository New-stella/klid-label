...
@startsalt
{
  ...
  --
  {
    ...
    |
    {
      <b>VLM 시계열 메타
      ---
      외부 VLM 이 자동 생성한 시계열 정보입니다.
      검토 후 수정할 수 있습니다.
      ---
      "00:05 ~ 00:18 사이 보행자가 갑자기 쓰러짐. .
       날씨는 맑음이고 낮 시간대로 조도는 양호함. ..
       주변 차량 통행은 적음.                        ..
       (자유 텍스트 입력 — 최대 5000자)              ."
      ---
      [ 1234 / 5000 ]
...
@startsalt
{
  ...
  ==
  {#
    [ ] | 영상명     | 이벤트   | 프레임 수 | 촬영일시   | 액션
    [X] | cctv-001   | 쓰러짐   | 120       | 2026-05-26 | [배정]
    [X] | cctv-002   | 폭력     | 90        | 2026-05-26 | [배정]
    [ ] | cctv-003   | -        | 60        | 2026-05-25 | [배정]
  }
  ==
  { . | [< 이전]  1 / 5  [다음 >] | . }
}
...
@startsalt
{
  ...
  {SI
    [         영상 플레이어 (VideoPlayer)         ]
    [ [재생] [일시정지]  배속:[0.25x][0.5x][1x][1.5x][2x][4x] ]
    [ |-----O-----------|  00:12 / 02:30                      ]
  }
  ==
  { [마킹 타임라인: |--*----*--*-----------|  ] }
