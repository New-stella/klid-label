...
| KLID-AT-II-003 | 1 | KLID-AT (BatchOrchestrator) | VlmClient | Online(Async) | HTTPS REST | 1 / 영상당 | VLM서비스 운영팀 | VlmService.submitTimeseries | VLM서비스 | 1 | RQ-SFR-03-02 | feature flag |
...
| sampleIntervalSec | int | 4 | → | sampleIntervalSec | int | 4 |
