...
| **주요 액터** | KLID-AT-AC-004 (배치시스템) | **주요 클래스** | BatchOrchestrator, VlmTimeseriesStep, DeidentifyStep, FfmpegFrameExtractor, YoloAutolabelStep, Sam2SegmentStep, TrackInterpolationStep, BatchStatusService, LabelingBatchQueueService |
