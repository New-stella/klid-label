...
synced_at: 2026-08-16T14:48:55.855Z
status: NEW
prev_version: null
content_hash: 022b974dbb9d576507aafdd576ba0a10f182098e48f4d2574bb1e0d5f915fe2c
stale: true
raw: ./_raw/SCREEN-032.json
links:
  belongs_to_domain: ["[[DOMAIN-012]]"]
  consumes: ["[[API-094]]", "[[API-109]]", "[[API-202]]"]
  realizes: ["[[UC-016]]"]
  references: ["[[API-094]]", "[[API-109]]"]
  requires: ["[[ROLE-001]]"]
