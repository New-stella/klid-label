...
synced_at: 2026-08-16T14:48:55.795Z
status: NEW
prev_version: null
content_hash: 473a5f39cfa1b7866f56b21f38b58a647debbbbafbfba56fc0eaa5f030524548
stale: true
raw: ./_raw/SCREEN-008.json
links:
  belongs_to_domain: ["[[DOMAIN-003]]"]
  consumes: ["[[API-042]]", "[[API-047]]", "[[API-070]]", "[[API-071]]", "[[API-181]]"]
  realizes: ["[[UC-018]]"]
  references: ["[[API-042]]", "[[API-047]]", "[[API-070]]", "[[API-071]]", "[[API-181]]", "[[API-199]]"]
