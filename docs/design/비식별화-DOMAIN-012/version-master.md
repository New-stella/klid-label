...
| Domain | DOMAIN-012 |
| Last sync | 2026-09-03T07:39:21.624Z |
| Mode | SYNC — NEW 3 / CHANGED 11 / UNCHANGED 72 |
...
```
  ...
  ℹ️  api_endpoint: 이번 키트 11건 / 스코프 밖 209건
  ℹ️  erd: 이번 키트 1건 / 스코프 밖 22건
  ℹ️  diagram_sequence: 이번 키트 5건 / 스코프 밖 30건 (그중 domain_id 없음 10건)
  ℹ️  screen_spec: 이번 키트 6건 / 스코프 밖 32건
  ℹ️  use_case: 이번 키트 5건 / 스코프 밖 30건
  ℹ️  domain_event: 이번 키트 2건 / 스코프 밖 10건
  ℹ️  acceptance: 이번 키트 5건 / 스코프 밖 77건 (그중 domain_id 없음 2건)
  🚨 constant: 이번 키트 0건 / 프로젝트 전역 2건 (그중 domain_id 없음 2건) — 전량 누락
  ℹ️  adr: 이번 키트 15건 / 스코프 밖 40건 (그중 domain_id 없음 5건)
...
- NEW [[API-215]]
- NEW [[UC-036]]
- CHANGED [[AC-1064]] (prev v6)
- CHANGED [[ADR-046]] (prev v13)
- CHANGED [[SEQ-012]] (prev v13)
- CHANGED [[DOMAIN-012]] (prev v8)
- CHANGED [[DFEAT-041]] (prev v13)
- CHANGED [[EXTSYS-003]] (prev v8)
- CHANGED [[INT-004]] (prev v11)
- CHANGED [[INTSPEC-001]] (prev v9)
...
| [[AC-1064]] | acceptance | 7 | CHANGED |
| [[AC-1065]] | acceptance | 4 | UNCHANGED |
| [[AC-1066]] | acceptance | 8 | UNCHANGED |
...
| [[SEQ-012]] | diagram_sequence | 14 | CHANGED |
...
| [[UC-011]] | use_case | 18 | CHANGED |
| [[UC-013]] | use_case | 12 | UNCHANGED |
| [[UC-016]] | use_case | 29 | CHANGED |
| [[UC-019]] | use_case | 27 | CHANGED |
| [[UC-036]] | use_case | 8 | NEW |
