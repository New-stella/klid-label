...
| Domain | DOMAIN-012 |
| Last sync | 2026-09-02T10:52:37.723Z |
| Mode | SYNC — NEW 0 / CHANGED 13 / UNCHANGED 70 |
...
```
  ...
  ℹ️  api_endpoint: 이번 키트 9건 / 스코프 밖 211건
  ...
  ℹ️  adr: 이번 키트 15건 / 스코프 밖 37건 (그중 domain_id 없음 3건)
