...
| Domain | DOMAIN-012 |
| Last sync | 2026-09-17T01:15:57.969Z |
| Mode | SYNC — NEW 0 / CHANGED 0 / UNCHANGED 129 |
...
```
  ...
  ℹ️  use_case: 이번 키트 5건 / 스코프 밖 32건
  ℹ️  domain_event: 이번 키트 3건 / 스코프 밖 9건
  ℹ️  acceptance: 이번 키트 8건 / 스코프 밖 115건 (그중 domain_id 없음 18건)
  🚨 constant: 이번 키트 0건 / 프로젝트 전역 2건 (그중 domain_id 없음 2건) — 전량 누락
  ℹ️  adr: 이번 키트 21건 / 스코프 밖 44건 (그중 domain_id 없음 6건)
...
|---|---|---|---|
| [[AC-1063]] | acceptance | 9 | UNCHANGED |
| [[AC-1064]] | acceptance | 13 | UNCHANGED |
...
| [[API-112]] | api_endpoint | 7 | UNCHANGED |
