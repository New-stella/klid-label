...
> 시스템을 구성하는 컴포넌트 간 의존관계(dependency)를 Layer(Presentation / Biz Logic / Integration)로 구분하여 표시한다. R2 유스케이스(KLID-AT-UC-001~013) 실행에 관여하는 컴포넌트만 포함한다.

| 컴포넌트 ID | KLID-AT-CO-001 ~ KLID-AT-CO-011 | 컴포넌트명 | (전체 — 아래 목록 참조) |
|----------|---|---------|---|
| 관련 유스케이스 ID | KLID-AT-UC-001 ~ KLID-AT-UC-013 |
