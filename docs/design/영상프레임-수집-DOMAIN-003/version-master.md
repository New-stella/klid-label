...
| Domain | DOMAIN-003 |
| Last sync | 2026-09-02T10:52:14.758Z |
| Mode | SYNC — NEW 1 / CHANGED 19 / UNCHANGED 117 |
...
```
  ...
  ℹ️  use_case: 이번 키트 5건 / 스코프 밖 30건 (그중 domain_id 없음 2건)
  ℹ️  domain_event: 이번 키트 3건 / 스코프 밖 9건
  ℹ️  acceptance: 이번 키트 4건 / 스코프 밖 76건 (그중 domain_id 없음 2건)
  🚨 constant: 이번 키트 0건 / 프로젝트 전역 2건 (그중 domain_id 없음 2건) — 전량 누락
  ℹ️  adr: 이번 키트 17건 / 스코프 밖 35건 (그중 domain_id 없음 4건)
