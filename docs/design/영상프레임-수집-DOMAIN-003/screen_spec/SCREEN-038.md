...
synced_at: 2026-08-16T14:48:51.423Z
status: NEW
prev_version: null
content_hash: df12eea49e9f4318f878bd0ba5721ca020cd2576e2509ab5febcce4d607afe8f
stale: true
raw: ./_raw/SCREEN-038.json
links:
  belongs_to_domain: ["[[DOMAIN-003]]"]
  consumes: ["[[API-185]]", "[[API-186]]"]
  references: ["[[API-185]]", "[[API-186]]"]
  requires: ["[[ROLE-001]]"]
