...
synced_at: 2026-08-29T01:27:24.570Z
status: CHANGED
prev_version: 21
content_hash: 46162021bc4b67fbec935756b2320d8f0485564bbfa8b01416a2fcb5c55b33e9
stale: true
raw: ./_raw/SCREEN-011.json
links:
  belongs_to_domain: ["[[DOMAIN-006]]"]
  consumes: ["[[API-042]]", "[[API-055]]", "[[API-072]]"]
  references: ["[[API-042]]", "[[API-055]]", "[[API-072]]"]
  requires: ["[[ROLE-001]]", "[[ROLE-002]]"]
  applies_to_backward: ["[[SHELL-001]]"]
  designs_backward: ["[[SD-014]]"]
