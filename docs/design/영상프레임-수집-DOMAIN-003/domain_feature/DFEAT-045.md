...
synced_at: 2026-08-25T10:51:50.879Z
status: CHANGED
prev_version: 13
content_hash: fb3f540adb23cbb7f677b097758bae12b868e5ccb797bd2344096fe36f6f4dd4
stale: false
...
[검증 이벤트 유형·질문 카탈로그] 외부 시계열 위탁의 검증 이벤트 유형과 그 유형별 질문 문구를 저작도구가 보관·관리한다. 한 유형에 질문을 여러 개 둘 수 있고 순서가 곧 의미라, 정렬순서 첫 번째가 기본 질문이 된다 — 마킹에서 고른 질문이 없거나 마킹을 거치지 않는 경로는 그 첫 번째를 쓴다. 이 카탈로그는 허용목록이 아니다. 여기에 없는 유형의 영상도 위탁은 그대로 나가고 질문 칸만 빈다.
