...
| Domain | DOMAIN-011 |
| Last sync | 2026-09-03T07:39:20.456Z |
| Mode | SYNC — NEW 0 / CHANGED 2 / UNCHANGED 54 |
...
```
  ...
  ℹ️  api_endpoint: 이번 키트 5건 / 스코프 밖 215건
  ...
  ℹ️  adr: 이번 키트 9건 / 스코프 밖 46건 (그중 domain_id 없음 8건)
