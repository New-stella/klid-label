...
| Domain | DOMAIN-011 |
| Last sync | 2026-09-17T01:15:55.812Z |
| Mode | SYNC — NEW 0 / CHANGED 0 / UNCHANGED 89 |
...
```
  ...
  ℹ️  api_endpoint: 이번 키트 5건 / 스코프 밖 233건
  ...
  ℹ️  acceptance: 이번 키트 3건 / 스코프 밖 120건 (그중 domain_id 없음 18건)
  🚨 constant: 이번 키트 0건 / 프로젝트 전역 2건 (그중 domain_id 없음 2건) — 전량 누락
  ℹ️  adr: 이번 키트 10건 / 스코프 밖 55건 (그중 domain_id 없음 10건)
...
| [[AC-1015]] | acceptance | 8 | UNCHANGED |
