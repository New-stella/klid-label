...
| Domain | DOMAIN-011 |
| Last sync | 2026-09-08T00:22:51.316Z |
| Mode | SYNC — NEW 0 / CHANGED 11 / UNCHANGED 76 |
...
```
  ...
  ℹ️  acceptance: 이번 키트 3건 / 스코프 밖 84건 (그중 domain_id 없음 7건)
...
- CHANGED [[AC-1013]] (prev v9)
- CHANGED [[ADR-046]] (prev v14)
- CHANGED [[API-043]] (prev v27)
- CHANGED [[API-047]] (prev v16)
- CHANGED [[DFEAT-039]] (prev v14)
- CHANGED [[ERD-013]] (prev v17)
