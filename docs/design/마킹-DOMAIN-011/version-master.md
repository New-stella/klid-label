...
| Domain | DOMAIN-011 |
| Last sync | 2026-09-01T07:14:27.485Z |
| Mode | SYNC — NEW 0 / CHANGED 5 / UNCHANGED 51 |
...
```
  ...
  ℹ️  use_case: 이번 키트 1건 / 스코프 밖 33건 (그중 domain_id 없음 1건)
...
- CHANGED [[AC-1013]] (prev v5)
- CHANGED [[AC-1014]] (prev v3)
- CHANGED [[AC-1015]] (prev v5)
...
|---|---|---|---|
| [[AC-1013]] | acceptance | 6 | CHANGED |
| [[AC-1014]] | acceptance | 4 | CHANGED |
| [[AC-1015]] | acceptance | 6 | CHANGED |
