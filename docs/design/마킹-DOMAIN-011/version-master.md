...
| Domain | DOMAIN-011 |
| Last sync | 2026-08-31T11:12:48.532Z |
...
```
  ...
  ℹ️  api_endpoint: 이번 키트 5건 / 스코프 밖 197건
  ...
  ℹ️  adr: 이번 키트 9건 / 스코프 밖 39건 (그중 domain_id 없음 5건)
...
|---|---|---|---|
| [[AC-1013]] | acceptance | 5 | UNCHANGED |
| [[AC-1014]] | acceptance | 3 | UNCHANGED |
| [[AC-1015]] | acceptance | 5 | UNCHANGED |
