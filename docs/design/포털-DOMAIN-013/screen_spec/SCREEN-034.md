...
synced_at: 2026-08-28T11:37:03.180Z
status: CHANGED
prev_version: 22
content_hash: 5911832966c3c4ff96fb00aab5cb9f711b599b00fb0c02f472f7afd64688f6f4
stale: false
raw: ./_raw/SCREEN-034.json
links:
  based_on: ["[[ADR-013]]"]
  belongs_to_domain: ["[[DOMAIN-013]]"]
  consumes: ["[[API-140]]", "[[API-149]]", "[[API-154]]", "[[API-155]]", "[[API-157]]", "[[API-159]]"]
  implements: ["[[IMPREC-110]]"]
  realizes: ["[[UC-027]]"]
  references: ["[[API-157]]", "[[API-159]]"]
  requires: ["[[ROLE-003]]"]
  designs_backward: ["[[SD-027]]"]
