...
> **281 케이스**(실측 — 표 행 수) · 계층: unit / integration / security · 우선순위 P0(Critical)~P2 · [← README](README.md)
...
| TC-LABEL-105 | resolve 시간조건(신고 이후 재비식별) | procLog·mtime 모두 신고 이전 | — | 409. mtime 은 60초 클럭스큐 관용, procLog 는 엄격 비교 | integration | P0 | DeidentReportService.java:532, :591-608 |
