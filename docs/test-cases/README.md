...
> 전수 테스트 케이스 카탈로그
> 최초 도출 2026-07-25 · 최신화 2026-07-30(1회차) · **최신화 2026-08-03(3회차 — 2026-08-03 사용자 확정 5건)**
...
| **3** | **2026-08-03** | **2026-08-03 사용자 확정 5건**(`80171828`·`b27b3108`·`d8a7a2cc`·`e58aa086` + 영상 목록 필터 미커밋분) | **7** | **46** | **0** | **1,977**(실측) |
...
|------|------|
| ID | 케이스 고유 식별자 |
| 케이스명 | 한글 서술형. 끝의 `(신규)` = 그 파일 `## 변경 이력` 의 **직전 회차 추가분** 표기(2026-07-30 1회차 / 2026-08-03 3회차) |
| 전제 | 테스트 사전 조건 |
| 입력/조건 | 투입 입력·시나리오 |
| 기대결과 | 검증할 단언 |
