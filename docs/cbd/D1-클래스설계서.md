...
| 날짜 | 버전 | 작성자 | 승인자 | 내용 |
|------|------|--------|--------|------|
| 2026-05-21 | 1.0 | 박찬기 | - | 최초 작성 (klid-label 소스 및 R2 유스케이스 명세서 v1.0 기반) |
| 2026-05-27 | 1.1 | 박찬기 | - | CBD 양식 전환 (UC-016 영상 마킹 반영) |
...
title KLID-AT-SD-001 영상 자동 처리 파이프라인 (V2.0)
actor "배치시스템\n(Quartz)" as BATCH
...
| 속성명 | 가시성 | 타입 | 기본값 | 설명 |
|---|---|---|---|---|
| markingStep | private | MarkingStep | | 마킹 Step (V2.0 신규) |
