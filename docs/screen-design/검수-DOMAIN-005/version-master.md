...
| Last sync | 2026-08-11T06:32:45.235Z (session 2) |
| Mode | SYNC — NEW 8 / CHANGED 0 / UNCHANGED 125 |
...
| SCREEN-018 | screen_spec | 검수 목록 화면 | 22 | false | UNCHANGED |
| SCREEN-019 | screen_spec | 검수 상세 화면 | 25 | true | UNCHANGED |
