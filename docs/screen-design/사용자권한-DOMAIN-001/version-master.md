...
| Domain | DOMAIN-001 |
| Last sync | 2026-09-02T10:54:10.497Z |
...
| ⚠️ 미판정 | 85건 — 스킬 Phase 2 판정 필요(이번 키트 미포함) |
...
```
  ...
  ℹ️  api_endpoint: 이번 키트 8건 / 스코프 밖 212건
  ...
  ℹ️  permission_role: 이번 키트 2건 / 스코프 밖 2건 (그중 domain_id 없음 2건)
...
| [[SCREEN-002]] | screen_spec | 27 | UNCHANGED |
