...
| 다운로드 화면 | SCREEN-009 |
| Last sync | 2026-08-11T06:30:02.909Z (session 2) |
| Mode | SYNC — NEW 8 / CHANGED 0 / UNCHANGED 116 |
...
| API-043 | api_endpoint | GET /v1/videos/{rawSn} | 6 | false | UNCHANGED |
...
| SCREEN-009 | screen_spec | 영상 상세 화면 | 28 | false | UNCHANGED |
