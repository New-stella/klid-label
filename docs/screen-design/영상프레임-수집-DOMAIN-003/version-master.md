...
| 다운로드 화면 | SCREEN-009 |
| Last sync | 2026-08-20T08:28:11.595Z (session 9) |
| Mode | INITIAL — NEW 164 / CHANGED 0 / UNCHANGED 0 |
...
| [[API-198]] | api_endpoint | POST /v1/videos/{rawSn}/batch/stages/{stage}/skip | 5 | false | NEW |
| [[API-200]] | api_endpoint | DELETE /v1/videos/{rawSn}/batch/stages/{stage}/skip | 3 | false | NEW |
| [[API-201]] | api_endpoint | POST /v1/videos/{rawSn}/batch/stages/{stage}/rerun | 7 | false | NEW |
| [[DS-001]] | design_system | KRDS Public | 8 | false | NEW |
| [[NAV-001]] | navigation_tree | 저작도구 내부 메뉴 (INTERNAL) | 15 | true | NEW |
| [[ROLE-001]] | permission_role | 검수자 (REVIEWER) | 10 | true | NEW |
| [[ROLE-002]] | permission_role | 라벨링 작업자 (WORKER) | 6 | true | NEW |
| [[SCREEN-009]] | screen_spec | 영상 상세 화면 | 51 | true | NEW |
