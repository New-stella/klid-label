...
synced_at: 2026-09-02T10:53:48.863Z
status: NEW
prev_version: null
...
links:
  ...
  consumes: ["[[API-096]]", "[[API-099]]", "[[API-100]]", "[[API-101]]", "[[API-107]]"]
  implements: ["[[IMPREC-005]]"]
  references: ["[[API-096]]", "[[API-099]]", "[[API-100]]", "[[API-101]]", "[[API-107]]"]
  requires: ["[[ROLE-001]]", "[[ROLE-002]]"]
  applies_to_backward: ["[[SHELL-001]]"]
  designs_backward: ["[[SD-010]]"]
  granted_on_backward: ["[[ROLE-001]]", "[[ROLE-002]]"]
  navigates_to_backward: ["[[NAV-001]]"]
  realizes_backward: ["[[MOD-026]]", "[[MOD-027]]", "[[MOD-035]]", "[[MOD-044]]"]
