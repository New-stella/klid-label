...
synced_at: 2026-09-02T10:53:48.944Z
status: NEW
prev_version: null
content_hash: 3d91a16c04c978cd271d3b6a65c0c78423ecbaf616aa5082817d9789986608ec
stale: true
raw: ./_raw/SCREEN-037.json
links:
  based_on: ["[[ADR-014]]"]
  belongs_to_domain: ["[[DOMAIN-009]]"]
  consumes: ["[[API-096]]", "[[API-098]]", "[[API-106]]", "[[API-108]]"]
  implements: ["[[IMPREC-007]]"]
  references: ["[[API-096]]", "[[API-098]]", "[[API-106]]", "[[API-108]]"]
  requires: ["[[ROLE-001]]"]
  applies_to_backward: ["[[SHELL-001]]"]
  designs_backward: ["[[SD-011]]"]
  granted_on_backward: ["[[ROLE-001]]"]
  navigates_to_backward: ["[[NAV-001]]"]
  realizes_backward: ["[[MOD-027]]", "[[MOD-029]]", "[[MOD-037]]", "[[MOD-044]]"]
  references_backward: ["[[ADR-014]]", "[[UC-040]]"]
---
