...
synced_at: 2026-09-02T10:53:48.924Z
status: NEW
prev_version: null
content_hash: f371570f5922686441f2f3fb86e62ec8594ba1d4a239124ccb3f863da3395928
stale: true
...
links:
  ...
  consumes: ["[[API-097]]"]
  implements: ["[[IMPREC-006]]"]
  references: ["[[API-097]]"]
  requires: ["[[ROLE-001]]"]
  applies_to_backward: ["[[SHELL-001]]"]
  designs_backward: ["[[SD-008]]"]
  granted_on_backward: ["[[ROLE-001]]"]
  navigates_to_backward: ["[[NAV-001]]"]
  realizes_backward: ["[[MOD-027]]", "[[MOD-029]]", "[[MOD-036]]", "[[MOD-038]]", "[[MOD-044]]"]
