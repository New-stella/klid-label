...
| 다운로드 화면 | SCREEN-012 |
| Last sync | 2026-09-05T01:33:12.741Z (session 16) |
| Mode | SYNC — NEW 3 / CHANGED 20 / UNCHANGED 143 |
...
|---|---|---|---|---|---|
| [[AC-1075]] | acceptance | UC-029 작업 목록 조회·필터링·배정 — 역할별 범위·일괄 확정 필터·시간축 정렬·KPI 토글·배정/일괄배정 (happy) | 6 | true | NEW |
| [[AC-1076]] | acceptance | UC-029 작업 목록 분기 — 미등록 정렬 키 strict 400·옵션 절단 안내·배정 이력 Drawer (negative) | 5 | true | NEW |
