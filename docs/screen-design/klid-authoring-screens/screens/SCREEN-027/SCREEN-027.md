...
type: screen_spec
version: 38
last_updated_at: 2026-08-27T10:29:26.073Z
domain: DOMAIN-000
project_id: 4ece2c3f-8e99-46f5-9580-71108a76e578
synced_at: 2026-08-27T20:53:19.483Z
sync_session: 31
stale: true
status: CHANGED
prev_version: 34
...
links:
  consumes_apis: ["[[API-043]]", "[[API-152]]", "[[API-156]]", "[[API-158]]", "[[API-160]]", "[[API-162]]", "[[API-164]]", "[[API-216]]", "[[API-217]]", "[[API-218]]", "[[API-194]]"]
  required_roles: ["[[ROLE-001]]"]
  realizes_use_cases: ["[[UC-037]]"]
  acceptance: ["[[AC-099]]", "[[AC-100]]", "[[AC-101]]", "[[AC-102]]", "[[AC-103]]", "[[AC-104]]", "[[AC-105]]", "[[AC-106]]"]
---

> ⚠️ **버전 변경 감지 — logicraft v34 → v38**
> change_summary: 이 화면을 비운영으로 부르는 요약을 고친다. 제목은 이미 파일 업로드인데 요약만 옛 용도에 머물러 있었다. 출발이 시험 통로였다는 사실은 남기되 지금은 관리자 페이지의 운영 화면이라는 것을 함께 적는다.
