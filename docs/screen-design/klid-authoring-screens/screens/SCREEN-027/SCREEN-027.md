...
type: screen_spec
version: 54
last_updated_at: 2026-09-14T05:31:23.529Z
domain: DOMAIN-000
project_id: 4ece2c3f-8e99-46f5-9580-71108a76e578
synced_at: 2026-09-14T05:34:04.732Z
sync_session: 39
stale: false
status: CHANGED
prev_version: 52
...
links:
  consumes_apis: ["[[API-043]]", "[[API-152]]", "[[API-156]]", "[[API-158]]", "[[API-160]]", "[[API-162]]", "[[API-164]]", "[[API-194]]"]
  required_roles: ["[[ROLE-004]]"]
  acceptance: ["[[AC-1086]]", "[[AC-1087]]"]
---

> ⚠️ **버전 변경 감지 — logicraft v52 → v54**
> change_summary: 정적 HTML 와이어프레임 자동 생성 — 1440×auto (16.8KB)
