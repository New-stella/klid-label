...
synced_at: 2026-08-26T04:28:14.113Z
sync_session: 27
stale: false
status: CHANGED
prev_version: 32
...
links:
  consumes_apis: ["[[API-043]]", "[[API-152]]", "[[API-156]]", "[[API-158]]", "[[API-160]]", "[[API-162]]", "[[API-164]]", "[[API-216]]", "[[API-217]]", "[[API-218]]"]
...
> change_summary: 정적 HTML 와이어프레임 자동 생성 — 1440×auto (23.2KB)
