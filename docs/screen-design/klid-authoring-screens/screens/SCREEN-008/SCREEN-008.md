...
type: screen_spec
version: 40
last_updated_at: 2026-08-21T00:18:11.446Z
domain: DOMAIN-000
project_id: 4ece2c3f-8e99-46f5-9580-71108a76e578
synced_at: 2026-08-21T00:40:34.316Z
sync_session: 20
stale: true
status: CHANGED
prev_version: 39
...
> ⚠️ **버전 변경 감지 — logicraft v39 → v40**
> change_summary: 일괄 건너뛰기의 대상을 그 묶음이 실패한 영상으로 한정하고 일괄 건너뛰기 해제 버튼을 화면에서 걷어낸다 — 재수행이 건너뛴 상태를 직접 수락하고 해제 표식까지 함께 남겨 해제와 재수행을 두 번 돌 필요가 없어졌다. 서버의 해제 요청 자체는 남아 있으나 이 화면에서 부르지 않는다. 아울러 검색·필터에 시계열 건너뜀 조건을 더하고, 전체 건너뛰기 스위치가 켜져 있으면 그 사실을 제목 아래 배너로 상시 알린다 — 켜져 있는 동안 들어오는 영상은 전건이 시계열 없이 확정되는데 그 사실이 어디에도 드러나지 않으면 아무도 모르는 사이에 학습데이터가 시계열 없이 쌓인다.
