...
type: screen_spec
version: 37
last_updated_at: 2026-09-02T23:25:56.194Z
domain: DOMAIN-000
project_id: 4ece2c3f-8e99-46f5-9580-71108a76e578
synced_at: 2026-09-05T01:33:13.476Z
sync_session: 34
stale: true
status: CHANGED
prev_version: 23
...
links:
  consumes_apis: ["[[API-140]]", "[[API-142]]", "[[API-151]]", "[[API-157]]", "[[API-159]]", "[[API-161]]", "[[API-163]]", "[[API-166]]", "[[API-169]]", "[[API-171]]", "[[API-231]]"]
  required_roles: ["[[ROLE-003]]"]
  realizes_use_cases: ["[[UC-027]]"]
  acceptance: ["[[AC-1070]]", "[[AC-1071]]"]
---

> ⚠️ **버전 변경 감지 — logicraft v23 → v37**
> change_summary: 정적 HTML 와이어프레임 자동 생성 — 1440×auto (18.8KB)
