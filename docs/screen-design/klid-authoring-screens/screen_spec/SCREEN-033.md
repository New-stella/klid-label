...
synced_at: 2026-09-02T10:53:44.658Z
status: CHANGED
prev_version: 23
content_hash: e25c6a140f93a939ae2afde140ee38868b6f5c02f53a5ff313a73634d0787c43
stale: true
...
links:
  ...
  realizes: ["[[UC-027]]"]
  references: ["[[API-140]]", "[[API-157]]", "[[API-159]]"]
  requires: ["[[ROLE-003]]"]
...
- **note**: 영상 자산에만 노출한다. 증강으로 만들어진 결과물 행에도 두지 않는다 — 증강한 것을 다시 증강하지 않는다.
- **type**: Button
- **label**: AI 증강 요청
...
- **source_hash**: 1d9367d25d9e4a14dd8861003444edd267fedbf2892785450b29b0fcd8f9fe6a
- **generated_at**: 2026-09-02T09:18:38.570Z
