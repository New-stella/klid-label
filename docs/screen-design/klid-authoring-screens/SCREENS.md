...
| last sync | 2026-09-14T05:34:04.921Z (session 39) |
| 화면 수 | 38개 |
...
|---|---|---|---|---|---|
| [[SCREEN-001]] | 세션 인계 진입 화면 | CHANGED | ✅ | [[API-006]] |  |
...
| [[SCREEN-044]] | 포털 증강 화면 | CHANGED | ✅ | [[API-232]], [[API-233]], [[API-157]], [[API-159]] | [[ROLE-003]] |
| [[SCREEN-045]] | 포털 업로드 영상 마킹 화면 | CHANGED | ✅ | [[API-238]], [[API-239]], [[API-240]], [[API-241]], [[API-140]] | [[ROLE-003]] |
...
| ITEM | type | 상태 |
|---|---|---|
| [[AC-1032]] | acceptance | CHANGED (v8→v9) |
| [[AC-1033]] | acceptance | CHANGED (v10→v11) |
| [[AC-1070]] | acceptance | CHANGED (v16→v19) |
| [[AC-1086]] | acceptance | CHANGED (v2→v3) |
| [[API-001]] | api_endpoint | CHANGED (v8→v10) |
| [[API-003]] | api_endpoint | CHANGED (v5→v6) |
| [[API-005]] | api_endpoint | CHANGED (v5→v6) |
| [[API-006]] | api_endpoint | CHANGED (v10→v13) |
| [[API-007]] | api_endpoint | CHANGED (v16→v17) |
...
| [[API-069]] | api_endpoint | CHANGED (v9→v12) |
| [[API-070]] | api_endpoint | CHANGED (v9→v10) |
| [[API-082]] | api_endpoint | CHANGED (v9→v10) |
| [[API-091]] | api_endpoint | CHANGED (v12→v13) |
| [[API-094]] | api_endpoint | CHANGED (v9→v10) |
| [[API-102]] | api_endpoint | CHANGED (v14→v15) |
| [[API-104]] | api_endpoint | CHANGED (v14→v15) |
| [[API-106]] | api_endpoint | CHANGED (v9→v10) |
| [[API-114]] | api_endpoint | CHANGED (v2→v3) |
| [[API-132]] | api_endpoint | CHANGED (v5→v7) |
| [[API-134]] | api_endpoint | CHANGED (v5→v7) |
| [[API-202]] | api_endpoint | CHANGED (v2→v3) |
| [[API-203]] | api_endpoint | CHANGED (v6→v9) |
| [[API-205]] | api_endpoint | CHANGED (v9→v10) |
| [[API-206]] | api_endpoint | CHANGED (v14→v15) |
| [[API-215]] | api_endpoint | CHANGED (v5→v6) |
| [[API-216]] | api_endpoint | CHANGED (v6→v7) |
| [[API-217]] | api_endpoint | CHANGED (v7→v8) |
| [[API-219]] | api_endpoint | CHANGED (v3→v4) |
| [[API-220]] | api_endpoint | CHANGED (v3→v4) |
| [[API-221]] | api_endpoint | CHANGED (v17→v19) |
| [[API-222]] | api_endpoint | CHANGED (v12→v13) |
| [[API-223]] | api_endpoint | CHANGED (v7→v8) |
...
| [[SD-021]] | screen_design | CHANGED (v6→v9) |
| [[SD-033]] | screen_design | CHANGED (v13→v14) |
| [[SD-036]] | screen_design | CHANGED (v5→v14) |
| [[SD-038]] | screen_design | CHANGED (v2→v3) |
| [[SCREEN-001]] | screen_spec | CHANGED (v16→v23) |
| [[SCREEN-002]] | screen_spec | CHANGED (v28→v34) |
| [[SCREEN-003]] | screen_spec | CHANGED (v14→v16) |
| [[SCREEN-004]] | screen_spec | CHANGED (v17→v18) |
| [[SCREEN-005]] | screen_spec | CHANGED (v102→v106) |
| [[SCREEN-006]] | screen_spec | CHANGED (v49→v54) |
| [[SCREEN-009]] | screen_spec | CHANGED (v76→v78) |
| [[SCREEN-024]] | screen_spec | CHANGED (v33→v35) |
| [[SCREEN-026]] | screen_spec | CHANGED (v35→v41) |
| [[SCREEN-027]] | screen_spec | CHANGED (v52→v54) |
| [[SCREEN-028]] | screen_spec | CHANGED (v34→v41) |
| [[SCREEN-029]] | screen_spec | CHANGED (v48→v54) |
| [[SCREEN-032]] | screen_spec | CHANGED (v26→v31) |
| [[SCREEN-033]] | screen_spec | CHANGED (v37→v43) |
| [[SCREEN-038]] | screen_spec | CHANGED (v14→v15) |
| [[SCREEN-039]] | screen_spec | CHANGED (v43→v45) |
| [[SCREEN-042]] | screen_spec | CHANGED (v11→v25) |
| [[SCREEN-044]] | screen_spec | CHANGED (v8→v14) |
| [[SCREEN-045]] | screen_spec | CHANGED (v5→v6) |
...
| [[UC-010]] | use_case | CHANGED (v16→v18) |
| [[UC-011]] | use_case | CHANGED (v19→v24) |
| [[UC-013]] | use_case | CHANGED (v12→v13) |
| [[UC-016]] | use_case | CHANGED (v30→v34) |
| [[UC-018]] | use_case | CHANGED (v24→v28) |
| [[UC-019]] | use_case | CHANGED (v27→v33) |
| [[UC-021]] | use_case | CHANGED (v22→v25) |
| [[UC-022]] | use_case | CHANGED (v24→v30) |
| [[UC-023]] | use_case | CHANGED (v30→v31) |
| [[UC-024]] | use_case | CHANGED (v25→v34) |
| [[UC-027]] | use_case | CHANGED (v32→v35) |
| [[UC-028]] | use_case | CHANGED (v8→v9) |
| [[UC-029]] | use_case | CHANGED (v13→v14) |
| [[UC-030]] | use_case | CHANGED (v16→v17) |
| [[UC-031]] | use_case | CHANGED (v16→v20) |
| [[UC-032]] | use_case | CHANGED (v14→v16) |
| [[UC-033]] | use_case | CHANGED (v7→v8) |
| [[UC-035]] | use_case | CHANGED (v19→v20) |
| [[UC-036]] | use_case | CHANGED (v8→v9) |
| [[UC-037]] | use_case | CHANGED (v15→v16) |
| [[UC-042]] | use_case | CHANGED (v4→v6) |
