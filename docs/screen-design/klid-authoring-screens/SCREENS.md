...
| last sync | 2026-08-25T10:22:55.564Z (session 24) |
| 화면 수 | 32개 |
...
| [[SCREEN-008]] | 영상 처리 현황 화면 | CHANGED | ✅ | [[API-042]], [[API-047]], [[API-068]], [[API-070]], [[API-071]], [[API-181]], [[API-212]], [[API-214]] | [[ROLE-001]], [[ROLE-002]] |
...
| ITEM | type | 상태 |
|---|---|---|
| [[AC-016]] | acceptance | CHANGED (v13→v15) |
| [[AC-024]] | acceptance | CHANGED (v9→v10) |
| [[API-037]] | api_endpoint | CHANGED (v8→v9) |
| [[API-038]] | api_endpoint | CHANGED (v11→v12) |
| [[API-039]] | api_endpoint | CHANGED (v10→v11) |
| [[API-185]] | api_endpoint | CHANGED (v3→v4) |
| [[SCREEN-005]] | screen_spec | CHANGED (v99→v100) |
| [[SCREEN-006]] | screen_spec | CHANGED (v47→v49) |
| [[SCREEN-008]] | screen_spec | CHANGED (v44→v45) |
| [[SCREEN-009]] | screen_spec | CHANGED (v53→v54) |
| [[SCREEN-038]] | screen_spec | CHANGED (v8→v9) |
| [[UC-016]] | use_case | CHANGED (v21→v23) |
