...
| Last sync | 2026-08-25T11:02:36.606Z (session 23) |
| Mode | SYNC — NEW 4 / CHANGED 0 / UNCHANGED 522 |
...
| [[AC-051]] | acceptance | 검수가 완료된 영상은 재수행이 묶음별로 갈린다 | 5 | false | NEW |
...
| [[AC-095]] | acceptance | 남의 포털 자산에는 접근할 수 없고 없는 자산과 구분되지 않는다 | 1 | true | UNCHANGED |
| [[AC-096]] | acceptance | 올린 이미지는 곧바로 라벨링할 수 있고 영상만 추출을 거친다 | 1 | true | UNCHANGED |
| [[AC-097]] | acceptance | 포털 라벨 저장은 전체 교체이며 빈 목록은 전부 지우라는 뜻이다 | 1 | true | UNCHANGED |
| [[AC-098]] | acceptance | 포털 업로드 자산에는 자동 라벨링도 검수도 버전관리도 없다 | 1 | true | UNCHANGED |
...
| [[API-037]] | api_endpoint | GET /v1/manage/presets | 10 | false | UNCHANGED |
| [[API-038]] | api_endpoint | POST /v1/manage/presets | 13 | false | UNCHANGED |
| [[API-039]] | api_endpoint | PUT /v1/manage/presets/{id} | 12 | false | UNCHANGED |
...
| [[API-043]] | api_endpoint | GET /v1/videos/{rawSn} | 17 | false | UNCHANGED |
...
| [[API-185]] | api_endpoint | GET /v1/manage/event-types | 6 | false | UNCHANGED |
...
| [[SCREEN-009]] | screen_spec | 영상 상세 화면 | 54 | true | UNCHANGED |
...
| [[SCREEN-027]] | screen_spec | 수동 업로드 | 32 | true | UNCHANGED |
| [[SCREEN-028]] | screen_spec | 포털 홈 화면 | 20 | true | UNCHANGED |
| [[SCREEN-029]] | screen_spec | 포털 라벨링 화면 | 38 | false | UNCHANGED |
| [[SCREEN-030]] | screen_spec | 공지 목록 화면 | 25 | true | UNCHANGED |
| [[SCREEN-031]] | screen_spec | 공지 상세 화면 | 31 | true | UNCHANGED |
...
| [[SCREEN-038]] | screen_spec | 이벤트유형 관리 화면 | 14 | false | UNCHANGED |
...
| [[SD-024]] | screen_design | SCREEN-028 포털 홈 화면 | 4 | true | UNCHANGED |
...
| [[SD-029]] | screen_design | SCREEN-023 증강 결과 화면 | 4 | true | UNCHANGED |
