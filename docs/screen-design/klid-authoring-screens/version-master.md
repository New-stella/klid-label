...
| Last sync | 2026-08-13T10:42:00.907Z (session 4) |
| Mode | SYNC — NEW 121 / CHANGED 11 / UNCHANGED 271 |
...
| API-056 | api_endpoint | GET /v1/stats/worker | 3 | false | NEW |
...
| API-071 | api_endpoint | PATCH /v1/assignments/{assignmentId} | 4 | false | CHANGED |
| API-072 | api_endpoint | GET /v1/assignments | 4 | false | UNCHANGED |
| API-073 | api_endpoint | GET /v1/tasks/board | 4 | false | UNCHANGED |
| API-074 | api_endpoint | GET /v1/tasks/{rawSn}/summary | 4 | false | NEW |
...
| CONST-002 | constant | CocoClasses — COCO-80 검출 클래스 allowlist | 2 | false | NEW |
| DS-001 | design_system | KRDS Public | 8 | false | UNCHANGED |
| NAV-001 | navigation_tree | 저작도구 내부 메뉴 (INTERNAL) | 10 | true | UNCHANGED |
| NAV-002 | navigation_tree | 포털 메뉴 (PORTAL) | 4 | true | NEW |
...
| SCREEN-002 | screen_spec | 역할 클레임 화면 | 12 | false | NEW |
...
| SCREEN-006 | screen_spec | 마킹 화면 | 35 | false | UNCHANGED |
...
| SCREEN-020 | screen_spec | 작업자 통계 화면 | 20 | false | NEW |
| SCREEN-021 | screen_spec | 전체 구축 현황 화면 | 21 | false | NEW |
| SCREEN-022 | screen_spec | 증강 요청 화면 | 31 | false | NEW |
| SCREEN-023 | screen_spec | 증강 결과 화면 | 29 | false | NEW |
...
| SCREEN-027 | screen_spec | 오토라벨 테스트 화면 (개발) | 14 | true | NEW |
| SCREEN-028 | screen_spec | 포털 홈 화면 | 10 | false | NEW |
...
| SD-001 | screen_design | SCREEN-018 검수 목록 화면 | 5 | false | CHANGED |
| SD-002 | screen_design | SCREEN-005 라벨링 캔버스 화면 | 7 | true | UNCHANGED |
| SD-003 | screen_design | SCREEN-012 작업 목록 화면 | 5 | false | CHANGED |
| SD-004 | screen_design | SCREEN-009 영상 상세 화면 | 11 | true | CHANGED |
| SD-005 | screen_design | SCREEN-019 검수 상세 화면 | 5 | false | CHANGED |
| SD-006 | screen_design | SCREEN-026 프리셋 관리 화면 | 4 | false | CHANGED |
| SD-007 | screen_design | SCREEN-030 공지 목록 화면 | 4 | false | CHANGED |
| SD-008 | screen_design | SCREEN-036 공지 작성 화면 | 4 | false | CHANGED |
| SD-009 | screen_design | SCREEN-024 사용자 관리 화면 | 7 | false | CHANGED |
| SD-010 | screen_design | SCREEN-031 공지 상세 화면 | 7 | false | CHANGED |
| SD-011 | screen_design | SCREEN-037 공지 수정 화면 | 4 | false | CHANGED |
| SD-012 | screen_design | SCREEN-006 마킹 화면 | 5 | false | UNCHANGED |
...
| SHELL-002 | app_shell | 포털 채널 셸 | 3 | true | NEW |
...
| UC-024 | use_case | 포털 라벨 작업 (조회·수정·다운로드) | 9 | true | NEW |
