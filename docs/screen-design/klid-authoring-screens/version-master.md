...
| Last sync | 2026-08-25T09:51:55.020Z (session 23) |
| Mode | INITIAL — NEW 481 / CHANGED 0 / UNCHANGED 0 |
...
|---|---|---|---|---|---|
| [[AC-001]] | acceptance | 증강 영상 생성 요청 수용 | 11 | false | NEW |
...
| [[AC-016]] | acceptance | 비식별 처리 상태·이력 화면 확인 | 13 | true | NEW |
...
| [[AC-024]] | acceptance | 영상 학습데이터 가공(라벨링·메타·VLM 시계열 메타 검수) | 9 | false | NEW |
...
| [[AC-032]] | acceptance | 데이터마트 다운로드 — 보존기간 경계에서 GONE 전환 | 2 | false | NEW |
| [[AC-033]] | acceptance | 만료 예정 시각은 조회 시점 설정값 기준 파생값이다 | 5 | false | NEW |
| [[AC-034]] | acceptance | 비식별 영상 부재 시 다운로드는 라벨·이미지만 담는다 | 3 | false | NEW |
| [[AC-035]] | acceptance | 데이터마트 다운로드는 본인 저장 라벨만 담는다 | 3 | false | NEW |
| [[AC-036]] | acceptance | 처리를 시작하지 않았거나 처리 중인 업로드 자산은 보존기간 만료 삭제 대상이 아니다 | 5 | false | NEW |
| [[AC-037]] | acceptance | 실패한 업로드 자산은 더 짧은 보존기간으로 삭제된다 | 3 | false | NEW |
...
| [[API-037]] | api_endpoint | GET /v1/manage/presets | 8 | false | NEW |
| [[API-038]] | api_endpoint | POST /v1/manage/presets | 11 | false | NEW |
| [[API-039]] | api_endpoint | PUT /v1/manage/presets/{id} | 10 | false | NEW |
...
| [[API-043]] | api_endpoint | GET /v1/videos/{rawSn} | 17 | false | NEW |
...
| [[API-060]] | api_endpoint | POST /v1/augments/request | 14 | false | NEW |
...
| [[NAV-001]] | navigation_tree | 저작도구 내부 메뉴 (INTERNAL) | 17 | true | NEW |
...
| [[SCREEN-005]] | screen_spec | 라벨링 캔버스 화면 | 99 | true | NEW |
| [[SCREEN-006]] | screen_spec | 마킹 화면 | 47 | true | NEW |
| [[SCREEN-008]] | screen_spec | 영상 처리 현황 화면 | 44 | true | NEW |
| [[SCREEN-009]] | screen_spec | 영상 상세 화면 | 53 | true | NEW |
| [[SCREEN-010]] | screen_spec | 로드 버전 선택 | 37 | true | NEW |
| [[SCREEN-011]] | screen_spec | 대시보드 화면 | 21 | true | NEW |
| [[SCREEN-012]] | screen_spec | 작업 목록 화면 | 46 | true | NEW |
...
| [[SCREEN-022]] | screen_spec | 증강 요청 화면 | 40 | true | NEW |
| [[SCREEN-023]] | screen_spec | 증강 결과 화면 | 41 | false | NEW |
| [[SCREEN-024]] | screen_spec | 사용자 관리 화면 | 23 | true | NEW |
| [[SCREEN-025]] | screen_spec | 시스템 설정 화면 | 38 | true | NEW |
| [[SCREEN-026]] | screen_spec | 프리셋 관리 화면 | 29 | false | NEW |
| [[SCREEN-027]] | screen_spec | 수동 업로드 | 32 | true | NEW |
| [[SCREEN-028]] | screen_spec | 포털 홈 화면 | 20 | true | NEW |
| [[SCREEN-029]] | screen_spec | 포털 라벨링 화면 | 38 | false | NEW |
| [[SCREEN-030]] | screen_spec | 공지 목록 화면 | 25 | true | NEW |
| [[SCREEN-031]] | screen_spec | 공지 상세 화면 | 31 | true | NEW |
| [[SCREEN-032]] | screen_spec | 비식별 신고 관리 화면 | 23 | true | NEW |
| [[SCREEN-033]] | screen_spec | 포털 업로드 화면 | 17 | true | NEW |
| [[SCREEN-034]] | screen_spec | 포털 업로드 라벨링 화면 | 21 | true | NEW |
...
| [[SCREEN-038]] | screen_spec | 이벤트유형 관리 화면 | 8 | false | NEW |
...
| [[SD-004]] | screen_design | SCREEN-009 영상 상세 화면 | 16 | true | NEW |
...
| [[UC-016]] | use_case | 비식별 처리 상태·이력 확인 | 21 | true | NEW |
...
| [[UC-027]] | use_case | 포털 자산 업로드·수동 라벨링 | 11 | false | NEW |
...
| [[UC-032]] | use_case | 라벨 프리셋 CRUD 관리 | 9 | true | NEW |
