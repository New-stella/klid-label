...
| Last sync | 2026-08-18T07:16:50.446Z (session 18) |
| Mode | SYNC — NEW 434 / CHANGED 0 / UNCHANGED 32 |
...
|---|---|---|---|---|---|
| [[AC-001]] | acceptance | 증강 영상 생성 요청 수용 | 9 | false | NEW |
| [[AC-002]] | acceptance | 증강 결과 수신·새 영상 등록 | 8 | true | NEW |
| [[AC-003]] | acceptance | 해상도 변경 파생영상 생성·좌표 재계산 | 7 | true | NEW |
...
| [[AC-009]] | acceptance | 검수 완료 후 수정 통지(TASK_MODIFIED) | 15 | false | NEW |
| [[AC-010]] | acceptance | 증강 영상 활용 여부 검수 | 7 | false | NEW |
| [[AC-011]] | acceptance | 비식별 처리 요청·결과 저장 | 9 | false | NEW |
| [[AC-013]] | acceptance | 비식별 옵션 설정 | 9 | false | NEW |
| [[AC-016]] | acceptance | 비식별 처리 상태·이력 화면 확인 | 11 | false | NEW |
| [[AC-017]] | acceptance | 실영상 라벨링·메타 가공 | 6 | false | NEW |
| [[AC-018]] | acceptance | 다양한 환경 증강 영상 확보 | 6 | false | NEW |
| [[AC-019]] | acceptance | 개인정보 비식별화 처리·검수·누락 신고 | 7 | false | NEW |
| [[AC-020]] | acceptance | 다양한 환경·산불 유형 학습데이터 제작 | 4 | true | NEW |
| [[AC-021]] | acceptance | 생성된 영상 라벨링으로 학습데이터셋 편입 | 5 | true | NEW |
| [[AC-022]] | acceptance | 학습데이터셋 자동·수동 검수 | 8 | false | NEW |
| [[AC-023]] | acceptance | 이미지 학습데이터 가공(추출·라벨링·가명·검수) | 6 | true | NEW |
| [[AC-024]] | acceptance | 영상 학습데이터 가공(라벨링·메타·VLM 시계열 메타 검수) | 6 | false | NEW |
| [[AC-025]] | acceptance | 관제 인입 → 폴링 적재 정상 흐름 수용 | 6 | false | NEW |
| [[AC-026]] | acceptance | 인입 중복 방어·파일 미도착 백오프 | 5 | false | NEW |
| [[AC-027]] | acceptance | 자동/수동 마킹 완료·잔여 배치 트리거 | 6 | false | NEW |
| [[AC-028]] | acceptance | 마킹에서 도출된 VLM 위탁 입력(frame_policy·event_type) | 5 | true | NEW |
| [[AC-029]] | acceptance | 검수완료 기준 수치와 전체 수치 병기 정합 | 2 | true | NEW |
| [[AC-030]] | acceptance | 이벤트 유형 표시명 그룹 축 집계 | 1 | true | NEW |
| [[AC-031]] | acceptance | 일별 작업량 30일 0-채움 | 1 | true | NEW |
| [[AC-032]] | acceptance | 데이터마트 다운로드 — 보존기간 경계에서 GONE 전환 | 1 | true | NEW |
| [[AC-033]] | acceptance | 만료 예정 시각은 조회 시점 설정값 기준 파생값이다 | 3 | true | NEW |
| [[AC-034]] | acceptance | 비식별 영상 부재 시 다운로드는 라벨·이미지만 담는다 | 1 | true | NEW |
| [[AC-035]] | acceptance | 데이터마트 다운로드는 본인 저장 라벨만 담는다 | 1 | true | NEW |
| [[AC-036]] | acceptance | 처리를 시작하지 않았거나 처리 중인 업로드 자산은 보존기간 만료 삭제 대상이 아니다 | 3 | false | NEW |
| [[AC-037]] | acceptance | 실패한 업로드 자산은 더 짧은 보존기간으로 삭제된다 | 2 | false | NEW |
...
| [[API-008]] | api_endpoint | GET /v1/reviews | 11 | false | NEW |
| [[API-009]] | api_endpoint | GET /v1/reviews/{videoId} | 8 | false | NEW |
...
| [[API-014]] | api_endpoint | POST /v1/reviews/{videoId}/approve | 10 | false | NEW |
...
| [[API-020]] | api_endpoint | POST /v1/frames/{srcSn}/sam2-track | 12 | false | NEW |
...
| [[API-034]] | api_endpoint | GET /v1/frames/{srcSn}/versions | 8 | true | NEW |
| [[API-035]] | api_endpoint | GET /v1/versions/{version}/diff | 10 | true | NEW |
| [[API-036]] | api_endpoint | POST /v1/versions/{version}/rollback | 10 | true | NEW |
| [[API-037]] | api_endpoint | GET /v1/manage/presets | 5 | false | NEW |
| [[API-038]] | api_endpoint | POST /v1/manage/presets | 7 | false | NEW |
| [[API-039]] | api_endpoint | PUT /v1/manage/presets/{id} | 6 | false | NEW |
| [[API-040]] | api_endpoint | DELETE /v1/manage/presets/{id} | 3 | false | NEW |
| [[API-041]] | api_endpoint | POST /v1/manage/presets/{id}/clone | 4 | false | NEW |
| [[API-042]] | api_endpoint | GET /v1/videos | 5 | false | NEW |
| [[API-043]] | api_endpoint | GET /v1/videos/{rawSn} | 14 | false | NEW |
...
| [[API-047]] | api_endpoint | POST /v1/videos/{rawSn}/markings | 10 | false | NEW |
...
| [[API-060]] | api_endpoint | POST /v1/augments/request | 12 | false | NEW |
| [[API-061]] | api_endpoint | GET /v1/augments/{jobId}/result | 10 | false | NEW |
| [[API-062]] | api_endpoint | POST /v1/augments/{id}/accept | 7 | false | NEW |
| [[API-063]] | api_endpoint | POST /v1/augments/{id}/reject | 9 | false | NEW |
| [[API-065]] | api_endpoint | POST /v1/vlm/callback | 15 | false | NEW |
| [[API-066]] | api_endpoint | GET /v1/frames/{srcSn}/meta | 4 | false | NEW |
| [[API-067]] | api_endpoint | PUT /v1/frames/{srcSn}/meta | 5 | false | NEW |
...
| [[API-076]] | api_endpoint | GET /v1/tasks/{rawSn}/meta | 8 | false | NEW |
...
| [[API-084]] | api_endpoint | GET /v1/videos/{rawSn}/stream | 7 | false | NEW |
| [[API-090]] | api_endpoint | GET /v1/manage/health | 4 | false | NEW |
| [[API-091]] | api_endpoint | POST /v1/videos/{rawSn}/deident-report | 11 | false | NEW |
| [[API-092]] | api_endpoint | POST /v1/videos/{rawSn}/resolution | 7 | true | NEW |
...
| [[API-112]] | api_endpoint | POST /v1/videos/{rawSn}/redeident | 4 | true | NEW |
...
| [[API-123]] | api_endpoint | POST /v1/frames/{srcSn}/yolo-track | 11 | false | NEW |
...
| [[API-132]] | api_endpoint | GET /v1/videos/{rawSn}/event-annotation | 4 | false | NEW |
| [[API-133]] | api_endpoint | POST /v1/videos/{rawSn}/event-annotation/approve | 4 | false | NEW |
| [[API-134]] | api_endpoint | PUT /v1/videos/{rawSn}/event-annotation | 4 | false | NEW |
...
| [[API-179]] | api_endpoint | GET /v1/videos/{rawSn}/resolution | 5 | false | NEW |
| [[API-181]] | api_endpoint | GET /v1/event-types | 7 | false | NEW |
| [[API-182]] | api_endpoint | GET /v1/versions/{version}/diff-with-working | 3 | true | NEW |
...
| [[API-185]] | api_endpoint | GET /v1/manage/event-types | 3 | false | NEW |
| [[API-186]] | api_endpoint | PATCH /v1/manage/event-types/{evntTypeCd} | 5 | false | NEW |
...
| [[API-190]] | api_endpoint | POST /v1/augments/{id}/restore | 6 | false | NEW |
...
| [[API-195]] | api_endpoint | GET /v1/videos/{rawSn}/versions/{version}/labels | 6 | true | NEW |
| [[API-196]] | api_endpoint | PUT /v1/videos/{rawSn}/labels | 9 | false | NEW |
| [[API-197]] | api_endpoint | GET /v1/videos/{rawSn}/versions | 4 | true | NEW |
...
| [[CONST-002]] | constant | CocoClasses — COCO-80 검출 클래스 allowlist | 3 | false | NEW |
| [[DS-001]] | design_system | KRDS Public | 8 | false | NEW |
| [[NAV-001]] | navigation_tree | 저작도구 내부 메뉴 (INTERNAL) | 14 | true | NEW |
| [[NAV-002]] | navigation_tree | 포털 메뉴 (PORTAL) | 5 | true | NEW |
| [[ROLE-001]] | permission_role | 검수자 (REVIEWER) | 10 | true | NEW |
| [[ROLE-002]] | permission_role | 라벨링 작업자 (WORKER) | 6 | true | NEW |
| [[ROLE-003]] | permission_role | 포털 회원 (PORTAL_USER) | 7 | true | NEW |
...
| [[SD-002]] | screen_design | SCREEN-005 라벨링 캔버스 화면 | 14 | true | NEW |
| [[SD-003]] | screen_design | SCREEN-012 작업 목록 화면 | 7 | true | NEW |
| [[SD-004]] | screen_design | SCREEN-009 영상 상세 화면 | 13 | false | NEW |
| [[SD-005]] | screen_design | SCREEN-019 검수 상세 화면 | 5 | true | NEW |
| [[SD-006]] | screen_design | SCREEN-026 프리셋 관리 화면 | 4 | true | NEW |
| [[SD-007]] | screen_design | SCREEN-030 공지 목록 화면 | 5 | true | NEW |
...
| [[SD-012]] | screen_design | SCREEN-006 마킹 화면 | 8 | false | NEW |
| [[SD-013]] | screen_design | SCREEN-008 영상 처리 현황 화면 | 3 | true | NEW |
| [[SD-014]] | screen_design | SCREEN-011 대시보드 화면 | 5 | false | NEW |
| [[SD-015]] | screen_design | SCREEN-025 시스템 설정 화면 | 3 | true | NEW |
...
| [[SD-024]] | screen_design | SCREEN-028 포털 홈 화면 | 4 | true | NEW |
...
| [[SD-029]] | screen_design | SCREEN-023 증강 결과 화면 | 4 | true | NEW |
...
| [[SHELL-001]] | app_shell | 저작도구 내부 채널 셸 | 9 | true | NEW |
| [[SHELL-002]] | app_shell | 포털 채널 셸 | 5 | false | NEW |
| [[UC-001]] | use_case | 증강 영상 생성 요청 | 12 | true | NEW |
| [[UC-002]] | use_case | 증강 결과 수신·등록 | 13 | true | NEW |
| [[UC-003]] | use_case | 해상도 변경 수행 | 11 | true | NEW |
| [[UC-004]] | use_case | 객체 자동 추적 | 15 | true | NEW |
| [[UC-005]] | use_case | 객체 외곽 경계 자동 밀착 | 10 | true | NEW |
| [[UC-006]] | use_case | 라벨링 정밀도 조절 | 9 | true | NEW |
| [[UC-007]] | use_case | 라벨 버전 저장·이력 추적 | 12 | true | NEW |
| [[UC-008]] | use_case | 버전 비교·복구 | 13 | true | NEW |
| [[UC-009]] | use_case | 검수 완료·수정 통지 | 19 | false | NEW |
| [[UC-010]] | use_case | 증강 영상 활용 여부 검수 | 13 | false | NEW |
| [[UC-011]] | use_case | 비식별 처리 요청 | 12 | false | NEW |
| [[UC-013]] | use_case | 비식별 옵션 설정 | 8 | true | NEW |
| [[UC-016]] | use_case | 비식별 처리 상태·이력 확인 | 20 | true | NEW |
| [[UC-018]] | use_case | 영상 적재 (관제 인입 테이블 직접 INSERT → 폴링 적재) | 16 | true | NEW |
| [[UC-019]] | use_case | 이벤트 마킹 (자동/수동) | 17 | false | NEW |
| [[UC-021]] | use_case | 라벨 편집·임시저장 | 20 | true | NEW |
| [[UC-022]] | use_case | VLM 시계열 메타 검토 | 17 | true | NEW |
| [[UC-023]] | use_case | 검수 승인·반려 | 22 | true | NEW |
| [[UC-024]] | use_case | 포털 라벨 작업 (조회·수정·다운로드) | 15 | true | NEW |
| [[UC-027]] | use_case | 포털 자산 업로드·수동 라벨링 | 10 | true | NEW |
| [[UC-028]] | use_case | 라벨 클래스·속성 정의 관리 | 5 | true | NEW |
| [[UC-029]] | use_case | 작업 목록 조회·필터링·배정 | 10 | false | NEW |
| [[UC-030]] | use_case | 사용자 계정·역할 관리 | 7 | true | NEW |
| [[UC-031]] | use_case | 시스템 운영 설정 관리 | 7 | true | NEW |
| [[UC-032]] | use_case | 라벨 프리셋 CRUD 관리 | 6 | true | NEW |
