...
| Last sync | 2026-08-26T01:22:56.171Z (session 26) |
| Mode | SYNC — NEW 57 / CHANGED 0 / UNCHANGED 469 |
...
| [[AC-095]] | acceptance | 남의 포털 자산에는 접근할 수 없고 없는 자산과 구분되지 않는다 | 2 | false | NEW |
| [[AC-096]] | acceptance | 올린 이미지는 곧바로 라벨링할 수 있고 영상만 추출을 거친다 | 2 | false | NEW |
| [[AC-097]] | acceptance | 포털 라벨 저장은 전체 교체이며 빈 목록은 전부 지우라는 뜻이다 | 2 | false | NEW |
| [[AC-098]] | acceptance | 포털 업로드 자산에는 자동 라벨링도 검수도 버전관리도 없다 | 2 | false | NEW |
...
| [[SCREEN-022]] | screen_spec | 증강 요청 화면 | 41 | true | UNCHANGED |
...
| [[SCREEN-029]] | screen_spec | 포털 라벨링 화면 | 39 | false | UNCHANGED |
...
| [[UC-024]] | use_case | 포털 라벨 작업 (조회·수정·다운로드) | 16 | false | UNCHANGED |
| [[UC-027]] | use_case | 포털 자산 업로드·수동 라벨링 | 12 | false | UNCHANGED |
