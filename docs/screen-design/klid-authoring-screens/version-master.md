...
| Last sync | 2026-08-25T10:22:55.576Z (session 24) |
| Mode | SYNC — NEW 0 / CHANGED 12 / UNCHANGED 469 |
...
| [[AC-016]] | acceptance | 비식별 처리 상태·이력 화면 확인 | 15 | false | CHANGED |
...
| [[AC-024]] | acceptance | 영상 학습데이터 가공(라벨링·메타·VLM 시계열 메타 검수) | 10 | false | CHANGED |
...
| [[API-037]] | api_endpoint | GET /v1/manage/presets | 9 | false | CHANGED |
| [[API-038]] | api_endpoint | POST /v1/manage/presets | 12 | false | CHANGED |
| [[API-039]] | api_endpoint | PUT /v1/manage/presets/{id} | 11 | false | CHANGED |
...
| [[API-185]] | api_endpoint | GET /v1/manage/event-types | 4 | false | CHANGED |
...
| [[SCREEN-005]] | screen_spec | 라벨링 캔버스 화면 | 100 | true | CHANGED |
| [[SCREEN-006]] | screen_spec | 마킹 화면 | 49 | false | CHANGED |
| [[SCREEN-008]] | screen_spec | 영상 처리 현황 화면 | 45 | true | CHANGED |
| [[SCREEN-009]] | screen_spec | 영상 상세 화면 | 54 | true | CHANGED |
...
| [[SCREEN-026]] | screen_spec | 프리셋 관리 화면 | 29 | false | UNCHANGED |
...
| [[SCREEN-038]] | screen_spec | 이벤트유형 관리 화면 | 9 | true | CHANGED |
...
| [[UC-016]] | use_case | 비식별 처리 상태·이력 확인 | 23 | false | CHANGED |
...
| [[UC-032]] | use_case | 라벨 프리셋 CRUD 관리 | 9 | true | UNCHANGED |
