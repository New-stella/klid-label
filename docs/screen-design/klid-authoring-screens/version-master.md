...
| [[AC-032]] | acceptance | 데이터마트 다운로드 — 보존기간 경계에서 GONE 전환 | 4 | false | NEW |
| [[AC-033]] | acceptance | 만료 예정 시각은 조회 시점 설정값 기준 파생값이다 | 7 | false | NEW |
| [[AC-034]] | acceptance | 비식별 영상 부재 시 다운로드는 라벨·이미지만 담는다 | 6 | false | NEW |
| [[AC-035]] | acceptance | 데이터마트 다운로드는 본인 저장 라벨만 담는다 | 6 | false | NEW |
| [[AC-036]] | acceptance | 처리를 시작하지 않았거나 처리 중인 업로드 자산은 보존기간 만료 삭제 대상이 아니다 | 7 | false | NEW |
| [[AC-037]] | acceptance | 실패한 업로드 자산은 더 짧은 보존기간으로 삭제된다 | 5 | false | NEW |
...
| [[AC-051]] | acceptance | 검수가 완료된 영상은 재수행이 묶음별로 갈린다 | 11 | false | NEW |
| [[AC-055]] | acceptance | 시계열 위탁 전체 건너뛰기 — 사유 없이 켤 수 없고 켜진 동안 외부 호출이 없다 | 3 | false | NEW |
| [[AC-056]] | acceptance | 사용자 관리는 관리자만 수행한다 | 3 | true | NEW |
| [[AC-057]] | acceptance | 허용 목록 밖의 역할 값은 저장에 이르지 못한다 | 3 | true | NEW |
| [[AC-058]] | acceptance | 이미 가진 역할을 다시 저장하면 아무것도 바뀌지 않는다 | 2 | true | NEW |
| [[AC-059]] | acceptance | 역할 변경의 효력은 커밋된 뒤에 생긴다 | 2 | true | NEW |
| [[AC-060]] | acceptance | 계정 활성 여부는 사용자 관리 화면에서 바뀌지 않는다 | 1 | true | NEW |
| [[AC-061]] | acceptance | 사용자 목록은 서버가 고정한 순서로 쪽 단위로 돌아온다 | 3 | true | NEW |
...
| [[AC-071]] | acceptance | 연동 서버 주소는 주소 대역으로 막지 않는다 | 5 | false | NEW |
| [[AC-072]] | acceptance | 운영·관리 성격의 쓰기는 관리자 유효창 안에서만 수행되고 유효창은 역할을 올리지 않는다 | 9 | false | NEW |
| [[AC-073]] | acceptance | 유효창의 길이는 서버가 정하며 상한을 넘지 못한다 | 5 | false | NEW |
| [[AC-074]] | acceptance | 설정 저장은 실제로 바뀐 키만 개별로 보낸다 | 2 | false | NEW |
| [[AC-075]] | acceptance | 설정 값의 허용 범위는 서버가 최종 판정한다 | 4 | false | NEW |
| [[AC-076]] | acceptance | 저장한 적 없는 설정 키가 목록에 없는 것은 정상이다 | 2 | false | NEW |
| [[AC-077]] | acceptance | 되돌릴 수 없는 위험 액션은 확인을 거쳐야만 실행된다 | 3 | false | NEW |
...
| [[API-043]] | api_endpoint | GET /v1/videos/{rawSn} | 25 | false | NEW |
| [[API-044]] | api_endpoint | GET /v1/videos/{rawSn}/labels/auto | 9 | false | NEW |
| [[API-045]] | api_endpoint | GET /v1/videos/{rawSn}/auto-summary | 2 | false | NEW |
| [[API-046]] | api_endpoint | GET /v1/videos/{rawSn}/frames/{frameNo}/image | 7 | false | NEW |
...
| [[API-060]] | api_endpoint | POST /v1/augments/request | 16 | false | NEW |
...
| [[API-069]] | api_endpoint | PUT /v1/manage/configs/{key} | 9 | false | NEW |
...
| [[API-082]] | api_endpoint | POST /v1/portal/user-labels | 9 | false | NEW |
| [[API-083]] | api_endpoint | GET /v1/portal/user-labels | 6 | false | NEW |
...
| [[API-110]] | api_endpoint | GET /v1/portal/frames/{srcSn}/labels | 4 | false | NEW |
...
| [[API-152]] | api_endpoint | POST /v1/dev/upload | 8 | false | NEW |
...
| [[API-156]] | api_endpoint | OPTIONS /v1/uploads | 3 | false | NEW |
| [[API-157]] | api_endpoint | GET /v1/portal/uploads/{uldSn}/export | 3 | false | NEW |
| [[API-158]] | api_endpoint | POST /v1/uploads | 5 | true | NEW |
| [[API-159]] | api_endpoint | GET /v1/portal/uploads/{uldSn}/file | 4 | false | NEW |
| [[API-160]] | api_endpoint | HEAD /v1/uploads/{uploadId} | 4 | false | NEW |
| [[API-161]] | api_endpoint | OPTIONS /v1/portal/uploads/tus | 3 | false | NEW |
| [[API-162]] | api_endpoint | PATCH /v1/uploads/{uploadId} | 6 | false | NEW |
| [[API-163]] | api_endpoint | POST /v1/portal/uploads/tus | 3 | false | NEW |
| [[API-164]] | api_endpoint | DELETE /v1/uploads/{uploadId} | 3 | false | NEW |
| [[API-165]] | api_endpoint | POST /v1/genai/callback | 7 | false | NEW |
...
| [[API-194]] | api_endpoint | POST /v1/manage/admin-session | 8 | true | NEW |
...
| [[API-203]] | api_endpoint | 포털 사용자 작업 데이터 ZIP 다운로드 | 6 | false | NEW |
...
| [[API-223]] | api_endpoint | PUT /v1/manage/admin-password — 관리자 패스워드 교체 | 4 | true | NEW |
...
| [[ROLE-003]] | permission_role | 포털 회원 (PORTAL_USER) | 10 | false | NEW |
...
| [[SCREEN-009]] | screen_spec | 영상 상세 화면 | 75 | true | NEW |
...
| [[SCREEN-021]] | screen_spec | 전체 구축 현황 화면 | 28 | true | NEW |
| [[SCREEN-022]] | screen_spec | 증강 요청 화면 | 45 | true | NEW |
| [[SCREEN-023]] | screen_spec | 증강 결과 화면 | 41 | true | NEW |
| [[SCREEN-024]] | screen_spec | 사용자 관리 화면 | 29 | false | NEW |
| [[SCREEN-025]] | screen_spec | 시스템 설정 화면 | 44 | true | NEW |
| [[SCREEN-026]] | screen_spec | 프리셋 관리 화면 | 35 | true | NEW |
| [[SCREEN-027]] | screen_spec | 파일 업로드 | 39 | true | NEW |
| [[SCREEN-028]] | screen_spec | 포털 홈 화면 | 26 | false | NEW |
| [[SCREEN-029]] | screen_spec | 포털 라벨링 화면 | 41 | false | NEW |
...
| [[SCREEN-033]] | screen_spec | 포털 업로드 화면 | 23 | false | NEW |
| [[SCREEN-034]] | screen_spec | 포털 업로드 라벨링 화면 | 26 | false | NEW |
...
| [[SCREEN-040]] | screen_spec | 관리자 페이지 진입 화면 | 6 | false | NEW |
| [[SCREEN-041]] | screen_spec | 관리자 패스워드 교체 | 7 | false | NEW |
| [[SCREEN-042]] | screen_spec | 연동 서버 주소 관리 화면 | 5 | false | NEW |
| [[SCREEN-043]] | screen_spec | 위험 작업 화면 | 4 | false | NEW |
...
| [[SD-004]] | screen_design | SCREEN-009 영상 상세 화면 | 19 | true | NEW |
...
| [[SD-012]] | screen_design | SCREEN-006 마킹 화면 | 11 | true | NEW |
| [[SD-013]] | screen_design | SCREEN-008 영상 처리 현황 화면 | 7 | true | NEW |
| [[SD-014]] | screen_design | SCREEN-011 대시보드 화면 | 5 | false | NEW |
| [[SD-015]] | screen_design | SCREEN-025 시스템 설정 화면 | 7 | true | NEW |
...
| [[SD-023]] | screen_design | SCREEN-038 이벤트유형 관리 화면 | 5 | true | NEW |
| [[SD-024]] | screen_design | SCREEN-028 포털 홈 화면 | 6 | true | NEW |
| [[SD-025]] | screen_design | SCREEN-029 포털 라벨링 화면 | 4 | true | NEW |
| [[SD-026]] | screen_design | SCREEN-033 포털 업로드 화면 | 7 | false | NEW |
| [[SD-027]] | screen_design | SCREEN-034 포털 업로드 라벨링 화면 | 9 | false | NEW |
| [[SD-028]] | screen_design | SCREEN-022 증강 요청 화면 | 4 | true | NEW |
...
| [[SD-033]] | screen_design | SCREEN-027 영상 업로드 | 11 | true | NEW |
...
| [[SHELL-002]] | app_shell | 포털 채널 셸 | 5 | true | NEW |
| [[UC-001]] | use_case | 증강 영상 생성 요청 | 13 | true | NEW |
| [[UC-002]] | use_case | 증강 결과 수신·등록 | 15 | true | NEW |
...
| [[UC-016]] | use_case | 비식별 처리 상태·이력 확인 | 24 | false | NEW |
...
| [[UC-024]] | use_case | 포털 라벨 작업 (조회·수정·다운로드) | 17 | true | NEW |
| [[UC-027]] | use_case | 포털 자산 업로드·수동 라벨링 | 16 | false | NEW |
...
| [[UC-031]] | use_case | 시스템 운영 설정 관리 | 12 | true | NEW |
