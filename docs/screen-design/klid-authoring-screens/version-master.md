...
| Last sync | 2026-09-05T02:34:48.537Z (session 35) |
| Mode | SYNC — NEW 10 / CHANGED 0 / UNCHANGED 467 |
...
|---|---|---|---|---|---|
| [[AC-1032]] | acceptance | UC-037 마킹 끝난 영상 일괄 올리기 — 폴더 재귀 짝짓기·판정·비동기 적재·비식별 후 마킹 활성 (happy) | 8 | true | UNCHANGED |
| [[AC-1033]] | acceptance | UC-037 일괄 적재 예외 — 짝 못찾음 건너뜀·FPS 어긋남 중단·중복 식별자 건너뜀·비식별 실패 마감·재기동 복구 (negative) | 10 | false | UNCHANGED |
| [[AC-1070]] | acceptance | UC-027 포털 자산 업로드·수동 라벨링 — 업로드·등록·업로드 영상 마킹·BBOX/POLYGON 수동 라벨링·AI 증강(검수 없음)·다운로드 (happy) | 16 | false | NEW |
| [[AC-1071]] | acceptance | UC-027 포털 업로드 예외 — 재개 가능 업로드·타인 자산 403 (negative) | 10 | false | NEW |
...
| [[API-001]] | api_endpoint | GET /v1/users | 8 | false | UNCHANGED |
...
| [[API-007]] | api_endpoint | POST /v1/auth/role-claim | 16 | true | UNCHANGED |
...
| [[API-070]] | api_endpoint | POST /v1/assignments | 9 | false | UNCHANGED |
...
| [[API-139]] | api_endpoint | POST /v1/portal/uploads/images | 4 | true | UNCHANGED |
...
| [[API-205]] | api_endpoint | 외부 산출물 폴더 검사 | 9 | false | UNCHANGED |
| [[API-206]] | api_endpoint | 외부 산출물 적재 | 14 | false | UNCHANGED |
...
| [[API-215]] | api_endpoint | 비식별 완료 기록 | 5 | false | UNCHANGED |
| [[API-216]] | api_endpoint | 마킹 산출물 폴더 검사 | 6 | false | UNCHANGED |
| [[API-217]] | api_endpoint | 마킹 산출물 일괄 적재 | 7 | false | UNCHANGED |
...
| [[API-221]] | api_endpoint | 이관 대상 폴더 탐색 | 17 | false | UNCHANGED |
| [[API-222]] | api_endpoint | 이관 대상 영상 파일 탐색 | 12 | false | UNCHANGED |
| [[API-223]] | api_endpoint | PUT /v1/manage/admin-password — 관리자 패스워드 교체 | 7 | true | UNCHANGED |
| [[API-232]] | api_endpoint | GET /v1/portal/augments | 4 | false | NEW |
| [[API-233]] | api_endpoint | GET /v1/portal/augments/{augSn} | 5 | false | NEW |
...
| [[SCREEN-002]] | screen_spec | 관리자 등록 화면 | 28 | true | UNCHANGED |
...
| [[SCREEN-024]] | screen_spec | 사용자 관리 화면 | 33 | true | UNCHANGED |
...
| [[SCREEN-028]] | screen_spec | 포털 내 작업 화면 | 34 | true | UNCHANGED |
| [[SCREEN-029]] | screen_spec | 포털 라벨링 화면 | 48 | true | UNCHANGED |
| [[SCREEN-030]] | screen_spec | 공지 목록 화면 | 26 | true | UNCHANGED |
| [[SCREEN-031]] | screen_spec | 공지 상세 화면 | 33 | true | UNCHANGED |
| [[SCREEN-032]] | screen_spec | 비식별 신고 관리 화면 | 26 | true | UNCHANGED |
| [[SCREEN-033]] | screen_spec | 포털 업로드 화면 | 37 | true | UNCHANGED |
...
| [[SCREEN-039]] | screen_spec | 산출물 가져오기 | 43 | true | UNCHANGED |
...
| [[SD-021]] | screen_design | SCREEN-032 비식별 신고 관리 화면 | 6 | true | UNCHANGED |
...
| [[SD-038]] | screen_design | SCREEN-039 산출물 가져오기 | 2 | true | UNCHANGED |
...
| [[UC-002]] | use_case | 증강 결과 수신·등록 | 21 | false | UNCHANGED |
| [[UC-003]] | use_case | 해상도 변경 수행 | 16 | true | UNCHANGED |
| [[UC-004]] | use_case | 객체 자동 추적 | 18 | false | UNCHANGED |
| [[UC-005]] | use_case | 객체 외곽 경계 자동 밀착 | 13 | false | UNCHANGED |
| [[UC-006]] | use_case | 라벨링 정밀도 조절 | 11 | true | UNCHANGED |
| [[UC-007]] | use_case | 라벨 버전 저장·이력 추적 | 15 | false | UNCHANGED |
| [[UC-008]] | use_case | 버전 비교·복구 | 17 | false | UNCHANGED |
| [[UC-009]] | use_case | 검수 완료·수정 통지 | 23 | false | UNCHANGED |
| [[UC-010]] | use_case | 증강 영상 활용 여부 검수 | 16 | true | UNCHANGED |
| [[UC-011]] | use_case | 비식별 처리 요청 | 19 | true | UNCHANGED |
| [[UC-013]] | use_case | 비식별 옵션 설정 | 12 | true | UNCHANGED |
| [[UC-016]] | use_case | 비식별 처리 상태·이력 확인 | 30 | false | UNCHANGED |
| [[UC-018]] | use_case | 영상 적재 (관제 인입 테이블 직접 INSERT → 폴링 적재) | 24 | false | UNCHANGED |
| [[UC-019]] | use_case | 이벤트 마킹 (자동/수동) | 27 | false | UNCHANGED |
| [[UC-021]] | use_case | 라벨 편집·임시저장 | 22 | false | UNCHANGED |
| [[UC-022]] | use_case | VLM 시계열 메타 검토 | 24 | false | UNCHANGED |
| [[UC-023]] | use_case | 검수 승인·반려 | 30 | false | UNCHANGED |
| [[UC-024]] | use_case | 포털 라벨 작업 (조회·수정·다운로드) | 25 | false | UNCHANGED |
| [[UC-027]] | use_case | 포털 자산 업로드·수동 라벨링 | 32 | true | UNCHANGED |
| [[UC-028]] | use_case | 라벨 클래스·속성 정의 관리 | 8 | false | UNCHANGED |
| [[UC-029]] | use_case | 작업 목록 조회·필터링·배정 | 13 | true | UNCHANGED |
| [[UC-030]] | use_case | 사용자 계정·역할 관리 | 16 | true | UNCHANGED |
| [[UC-031]] | use_case | 시스템 운영 설정 관리 | 16 | true | UNCHANGED |
| [[UC-032]] | use_case | 라벨 프리셋 CRUD 관리 | 14 | false | UNCHANGED |
| [[UC-033]] | use_case | 전체 구축 현황 조회 — 검수완료 기준과 전체 기준 병기 | 7 | false | UNCHANGED |
| [[UC-034]] | use_case | 온디맨드 AI 자동 추적 | 7 | false | UNCHANGED |
| [[UC-035]] | use_case | 외부 산출물 가져오기 | 19 | false | UNCHANGED |
| [[UC-036]] | use_case | 이관 이력 조회 | 8 | false | UNCHANGED |
| [[UC-037]] | use_case | 마킹이 끝난 영상 일괄 올리기 | 15 | true | UNCHANGED |
...
| [[UI-035]] | ui_component | navigation: Gnb | 7 | false | UNCHANGED |
