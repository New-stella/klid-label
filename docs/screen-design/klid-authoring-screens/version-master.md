...
| Last sync | 2026-08-27T20:53:19.696Z (session 31) |
| Mode | SYNC — NEW 12 / CHANGED 85 / UNCHANGED 441 |
...
| [[AC-032]] | acceptance | 데이터마트 다운로드 — 보존기간 경계에서 GONE 전환 | 4 | false | CHANGED |
| [[AC-033]] | acceptance | 만료 예정 시각은 조회 시점 설정값 기준 파생값이다 | 7 | false | CHANGED |
| [[AC-034]] | acceptance | 비식별 영상 부재 시 다운로드는 라벨·이미지만 담는다 | 6 | false | CHANGED |
| [[AC-035]] | acceptance | 데이터마트 다운로드는 본인 저장 라벨만 담는다 | 6 | false | CHANGED |
| [[AC-036]] | acceptance | 처리를 시작하지 않았거나 처리 중인 업로드 자산은 보존기간 만료 삭제 대상이 아니다 | 7 | false | CHANGED |
| [[AC-037]] | acceptance | 실패한 업로드 자산은 더 짧은 보존기간으로 삭제된다 | 5 | false | CHANGED |
...
| [[AC-051]] | acceptance | 검수가 완료된 영상은 재수행이 묶음별로 갈린다 | 11 | false | CHANGED |
| [[AC-055]] | acceptance | 시계열 위탁 전체 건너뛰기 — 사유 없이 켤 수 없고 켜진 동안 외부 호출이 없다 | 3 | false | UNCHANGED |
| [[AC-056]] | acceptance | 사용자 관리는 검수자만 수행한다 | 2 | true | CHANGED |
| [[AC-057]] | acceptance | 허용 목록 밖의 역할 값은 저장에 이르지 못한다 | 2 | true | CHANGED |
| [[AC-058]] | acceptance | 이미 가진 역할을 다시 저장하면 아무것도 바뀌지 않는다 | 2 | true | CHANGED |
| [[AC-059]] | acceptance | 역할 변경의 효력은 커밋된 뒤에 생긴다 | 2 | true | CHANGED |
| [[AC-060]] | acceptance | 계정 활성 여부는 사용자 관리 화면에서 바뀌지 않는다 | 1 | true | UNCHANGED |
| [[AC-061]] | acceptance | 사용자 목록은 서버가 고정한 순서로 쪽 단위로 돌아온다 | 3 | true | CHANGED |
...
| [[AC-071]] | acceptance | 연동 서버 주소는 주소 대역으로 막지 않는다 | 4 | true | CHANGED |
| [[AC-072]] | acceptance | 운영·관리 성격의 쓰기는 관리자 유효창 안에서만 수행되고 유효창은 역할을 올리지 않는다 | 8 | false | CHANGED |
| [[AC-073]] | acceptance | 유효창의 길이는 서버가 정하며 상한을 넘지 못한다 | 4 | true | CHANGED |
| [[AC-074]] | acceptance | 설정 저장은 실제로 바뀐 키만 개별로 보낸다 | 1 | true | UNCHANGED |
| [[AC-075]] | acceptance | 설정 값의 허용 범위는 서버가 최종 판정한다 | 3 | true | UNCHANGED |
| [[AC-076]] | acceptance | 저장한 적 없는 설정 키가 목록에 없는 것은 정상이다 | 1 | true | UNCHANGED |
| [[AC-077]] | acceptance | 되돌릴 수 없는 위험 액션은 확인을 거쳐야만 실행된다 | 2 | true | CHANGED |
...
| [[AC-095]] | acceptance | 남의 포털 자산에는 접근할 수 없고 없는 자산과 구분되지 않는다 | 2 | false | UNCHANGED |
| [[AC-096]] | acceptance | 올린 이미지는 곧바로 라벨링할 수 있고 영상만 추출을 거친다 | 2 | false | UNCHANGED |
| [[AC-097]] | acceptance | 포털 라벨 저장은 전체 교체이며 빈 목록은 전부 지우라는 뜻이다 | 2 | false | UNCHANGED |
| [[AC-098]] | acceptance | 포털 업로드 자산에는 자동 라벨링도 검수도 버전관리도 없다 | 2 | false | UNCHANGED |
...
| [[AC-121]] | acceptance | 관리자 패스워드 교체는 현재 패스워드를 다시 확인한 뒤에만 이뤄진다 | 1 | false | NEW |
| [[AC-122]] | acceptance | 자격 저장 위치가 비어 있으면 배포 설정값으로 판정하고, 둘 다 없으면 아무 패스워드도 통과하지 않는다 | 1 | false | NEW |
| [[AC-123]] | acceptance | 관리자 자격은 설정을 조회하는 것만으로 드러나지 않는다 | 1 | false | NEW |
...
| [[API-004]] | api_endpoint | PATCH /v1/users/{userNo} | 7 | false | CHANGED |
| [[API-005]] | api_endpoint | GET /v1/users/me | 5 | false | UNCHANGED |
| [[API-006]] | api_endpoint | GET /v1/me | 10 | false | CHANGED |
| [[API-007]] | api_endpoint | POST /v1/auth/role-claim | 11 | false | CHANGED |
...
| [[API-043]] | api_endpoint | GET /v1/videos/{rawSn} | 25 | false | CHANGED |
| [[API-044]] | api_endpoint | GET /v1/videos/{rawSn}/labels/auto | 9 | false | CHANGED |
...
| [[API-060]] | api_endpoint | POST /v1/augments/request | 16 | false | CHANGED |
...
| [[API-069]] | api_endpoint | PUT /v1/manage/configs/{key} | 9 | false | CHANGED |
...
| [[API-082]] | api_endpoint | POST /v1/portal/user-labels | 9 | false | CHANGED |
| [[API-083]] | api_endpoint | GET /v1/portal/user-labels | 6 | false | CHANGED |
...
| [[API-110]] | api_endpoint | GET /v1/portal/frames/{srcSn}/labels | 4 | false | CHANGED |
...
| [[API-152]] | api_endpoint | POST /v1/dev/upload | 7 | false | CHANGED |
...
| [[API-156]] | api_endpoint | OPTIONS /v1/uploads | 3 | false | CHANGED |
| [[API-157]] | api_endpoint | GET /v1/portal/uploads/{uldSn}/export | 3 | false | UNCHANGED |
| [[API-158]] | api_endpoint | POST /v1/uploads | 5 | false | CHANGED |
| [[API-159]] | api_endpoint | GET /v1/portal/uploads/{uldSn}/file | 4 | false | UNCHANGED |
| [[API-160]] | api_endpoint | HEAD /v1/uploads/{uploadId} | 4 | false | CHANGED |
| [[API-161]] | api_endpoint | OPTIONS /v1/portal/uploads/tus | 3 | false | UNCHANGED |
| [[API-162]] | api_endpoint | PATCH /v1/uploads/{uploadId} | 6 | false | CHANGED |
| [[API-163]] | api_endpoint | POST /v1/portal/uploads/tus | 3 | false | UNCHANGED |
| [[API-164]] | api_endpoint | DELETE /v1/uploads/{uploadId} | 3 | false | CHANGED |
| [[API-165]] | api_endpoint | POST /v1/genai/callback | 7 | false | CHANGED |
...
| [[API-190]] | api_endpoint | POST /v1/augments/{id}/restore | 6 | false | UNCHANGED |
...
| [[API-194]] | api_endpoint | POST /v1/manage/admin-session | 7 | true | CHANGED |
...
| [[API-203]] | api_endpoint | 포털 사용자 작업 데이터 ZIP 다운로드 | 6 | false | CHANGED |
...
| [[API-223]] | api_endpoint | PUT /v1/manage/admin-password — 관리자 패스워드 교체 | 3 | false | NEW |
...
| [[DS-001]] | design_system | KRDS Public | 9 | false | CHANGED |
| [[NAV-001]] | navigation_tree | 저작도구 내부 메뉴 (INTERNAL) | 23 | false | CHANGED |
| [[NAV-002]] | navigation_tree | 포털 메뉴 (PORTAL) | 8 | false | CHANGED |
| [[ROLE-001]] | permission_role | 검수자 (REVIEWER) | 12 | true | CHANGED |
| [[ROLE-002]] | permission_role | 라벨링 작업자 (WORKER) | 8 | false | CHANGED |
| [[ROLE-003]] | permission_role | 포털 회원 (PORTAL_USER) | 9 | false | CHANGED |
| [[SCREEN-001]] | screen_spec | 세션 인계 진입 화면 | 16 | false | CHANGED |
| [[SCREEN-002]] | screen_spec | 역할 클레임 화면 | 22 | false | CHANGED |
| [[SCREEN-003]] | screen_spec | 접근 거부 화면 | 10 | false | UNCHANGED |
| [[SCREEN-004]] | screen_spec | 개발용 로그인 화면 | 11 | false | UNCHANGED |
| [[SCREEN-005]] | screen_spec | 라벨링 캔버스 화면 | 102 | true | CHANGED |
| [[SCREEN-006]] | screen_spec | 마킹 화면 | 49 | false | UNCHANGED |
| [[SCREEN-008]] | screen_spec | 영상 처리 현황 화면 | 47 | false | CHANGED |
| [[SCREEN-009]] | screen_spec | 영상 상세 화면 | 75 | false | CHANGED |
...
| [[SCREEN-019]] | screen_spec | 검수 상세 화면 | 43 | false | CHANGED |
| [[SCREEN-020]] | screen_spec | 작업자 통계 화면 | 32 | false | UNCHANGED |
| [[SCREEN-021]] | screen_spec | 전체 구축 현황 화면 | 28 | false | UNCHANGED |
| [[SCREEN-022]] | screen_spec | 증강 요청 화면 | 45 | false | CHANGED |
| [[SCREEN-023]] | screen_spec | 증강 결과 화면 | 41 | false | UNCHANGED |
| [[SCREEN-024]] | screen_spec | 사용자 관리 화면 | 27 | true | CHANGED |
| [[SCREEN-025]] | screen_spec | 시스템 설정 화면 | 43 | true | CHANGED |
| [[SCREEN-026]] | screen_spec | 프리셋 관리 화면 | 35 | true | CHANGED |
| [[SCREEN-027]] | screen_spec | 파일 업로드 | 38 | true | CHANGED |
| [[SCREEN-028]] | screen_spec | 포털 홈 화면 | 26 | false | CHANGED |
| [[SCREEN-029]] | screen_spec | 포털 라벨링 화면 | 41 | false | CHANGED |
...
| [[SCREEN-033]] | screen_spec | 포털 업로드 화면 | 23 | false | CHANGED |
| [[SCREEN-034]] | screen_spec | 포털 업로드 라벨링 화면 | 26 | false | CHANGED |
...
| [[SCREEN-040]] | screen_spec | 관리자 페이지 진입 화면 | 3 | true | NEW |
| [[SCREEN-041]] | screen_spec | 관리자 패스워드 교체 | 5 | false | NEW |
| [[SCREEN-042]] | screen_spec | 연동 서버 주소 관리 화면 | 3 | true | NEW |
| [[SCREEN-043]] | screen_spec | 위험 작업 화면 | 3 | true | NEW |
| [[SD-001]] | screen_design | SCREEN-018 검수 목록 화면 | 5 | true | UNCHANGED |
| [[SD-002]] | screen_design | SCREEN-005 라벨링 캔버스 화면 | 17 | true | CHANGED |
| [[SD-003]] | screen_design | SCREEN-012 작업 목록 화면 | 8 | true | UNCHANGED |
| [[SD-004]] | screen_design | SCREEN-009 영상 상세 화면 | 19 | true | CHANGED |
| [[SD-005]] | screen_design | SCREEN-019 검수 상세 화면 | 7 | true | CHANGED |
| [[SD-006]] | screen_design | SCREEN-026 프리셋 관리 화면 | 5 | true | CHANGED |
| [[SD-007]] | screen_design | SCREEN-030 공지 목록 화면 | 6 | true | UNCHANGED |
| [[SD-008]] | screen_design | SCREEN-036 공지 작성 화면 | 4 | true | UNCHANGED |
| [[SD-009]] | screen_design | SCREEN-024 사용자 관리 화면 | 9 | false | CHANGED |
| [[SD-010]] | screen_design | SCREEN-031 공지 상세 화면 | 10 | true | UNCHANGED |
| [[SD-011]] | screen_design | SCREEN-037 공지 수정 화면 | 6 | false | UNCHANGED |
| [[SD-012]] | screen_design | SCREEN-006 마킹 화면 | 11 | true | CHANGED |
| [[SD-013]] | screen_design | SCREEN-008 영상 처리 현황 화면 | 7 | true | CHANGED |
| [[SD-014]] | screen_design | SCREEN-011 대시보드 화면 | 5 | false | UNCHANGED |
| [[SD-015]] | screen_design | SCREEN-025 시스템 설정 화면 | 7 | true | CHANGED |
| [[SD-016]] | screen_design | 공통 — 전역 레이아웃(헤더·좌측 주 메뉴) | 4 | false | UNCHANGED |
| [[SD-017]] | screen_design | SCREEN-001 세션 인계 진입 화면 | 3 | false | CHANGED |
...
| [[SD-023]] | screen_design | SCREEN-038 이벤트유형 관리 화면 | 5 | true | CHANGED |
| [[SD-024]] | screen_design | SCREEN-028 포털 홈 화면 | 6 | true | CHANGED |
| [[SD-025]] | screen_design | SCREEN-029 포털 라벨링 화면 | 4 | true | UNCHANGED |
| [[SD-026]] | screen_design | SCREEN-033 포털 업로드 화면 | 7 | false | CHANGED |
| [[SD-027]] | screen_design | SCREEN-034 포털 업로드 라벨링 화면 | 9 | false | CHANGED |
| [[SD-028]] | screen_design | SCREEN-022 증강 요청 화면 | 4 | true | CHANGED |
| [[SD-029]] | screen_design | SCREEN-023 증강 결과 화면 | 5 | false | UNCHANGED |
...
| [[SD-033]] | screen_design | SCREEN-027 영상 업로드 | 11 | true | CHANGED |
| [[SD-034]] | screen_design | SCREEN-040 관리자 페이지 진입 화면 | 3 | true | NEW |
| [[SD-035]] | screen_design | SCREEN-043 위험 작업 화면 | 2 | true | NEW |
| [[SD-036]] | screen_design | SCREEN-042 연동 서버 주소 관리 화면 | 2 | true | NEW |
| [[SD-037]] | screen_design | SCREEN-041 관리자 패스워드 교체 화면 | 3 | true | NEW |
| [[SHELL-001]] | app_shell | 저작도구 내부 채널 셸 | 10 | true | UNCHANGED |
| [[SHELL-002]] | app_shell | 포털 채널 셸 | 5 | false | UNCHANGED |
| [[UC-001]] | use_case | 증강 영상 생성 요청 | 13 | true | CHANGED |
| [[UC-002]] | use_case | 증강 결과 수신·등록 | 15 | true | CHANGED |
...
| [[UC-016]] | use_case | 비식별 처리 상태·이력 확인 | 24 | false | CHANGED |
...
| [[UC-024]] | use_case | 포털 라벨 작업 (조회·수정·다운로드) | 17 | false | UNCHANGED |
| [[UC-027]] | use_case | 포털 자산 업로드·수동 라벨링 | 16 | false | CHANGED |
| [[UC-028]] | use_case | 라벨 클래스·속성 정의 관리 | 6 | false | UNCHANGED |
| [[UC-029]] | use_case | 작업 목록 조회·필터링·배정 | 11 | false | UNCHANGED |
| [[UC-030]] | use_case | 사용자 계정·역할 관리 | 11 | true | CHANGED |
| [[UC-031]] | use_case | 시스템 운영 설정 관리 | 12 | true | CHANGED |
...
| [[UI-018]] | ui_component | display: BatchStageIndicator | 10 | false | CHANGED |
...
| [[UI-090]] | ui_component | action: DangerActions | 6 | false | CHANGED |
...
| [[UI-094]] | ui_component | action: VideoActions | 5 | false | CHANGED |
...
| [[UI-111]] | ui_component | display: Badge | 3 | false | CHANGED |
