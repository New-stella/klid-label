...
| Last sync | 2026-08-26T05:06:14.938Z (session 27) |
| Mode | INITIAL — NEW 526 / CHANGED 0 / UNCHANGED 0 |
| 출력 루트 | /Users/ck/orca/workspaces/klid-label/portal/docs/screen-design/klid-authoring-screens |
...
| [[AC-051]] | acceptance | 검수가 완료된 영상은 재수행이 묶음별로 갈린다 | 8 | false | NEW |
...
| [[API-043]] | api_endpoint | GET /v1/videos/{rawSn} | 20 | false | NEW |
...
| [[API-203]] | api_endpoint | 포털 사용자 작업 데이터 ZIP 다운로드 | 4 | false | NEW |
...
| [[ROLE-003]] | permission_role | 포털 회원 (PORTAL_USER) | 8 | true | NEW |
...
| [[SCREEN-028]] | screen_spec | 포털 홈 화면 | 24 | false | NEW |
