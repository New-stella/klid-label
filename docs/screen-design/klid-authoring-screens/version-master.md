# Version Master — 학습데이터 저작도구 (DOMAIN-000) — 화면 키트

| 항목 | 값 |
|---|---|
| project_id | 4ece2c3f-8e99-46f5-9580-71108a76e578 |
| Domain | DOMAIN-000 학습데이터 저작도구 |
| 다운로드 화면 | SCREEN-005, SCREEN-010 |
| Last sync | 2026-08-10T12:08:03.900Z (session 1) |
| Mode | INITIAL — NEW 163 / CHANGED 0 / UNCHANGED 0 |
...
| AC-008 | acceptance | 버전 diff 비교·롤백 복구 | 6 | false | NEW |
...
| AC-023 | acceptance | 이미지 학습데이터 가공(추출·라벨링·가명·검수) | 4 | false | NEW |
...
| API-019 | api_endpoint | PUT /v1/frames/{srcSn}/labels | 6 | false | NEW |
...
| API-032 | api_endpoint | POST /v1/labels/{srcSn}/deident-report | 5 | false | NEW |
| API-034 | api_endpoint | GET /v1/frames/{srcSn}/versions | 4 | false | NEW |
| API-035 | api_endpoint | GET /v1/versions/{version}/diff | 5 | false | NEW |
| API-036 | api_endpoint | POST /v1/versions/{version}/rollback | 5 | false | NEW |
| API-066 | api_endpoint | GET /v1/frames/{srcSn}/meta | 2 | false | NEW |
| API-067 | api_endpoint | PUT /v1/frames/{srcSn}/meta | 2 | false | NEW |
...
| API-178 | api_endpoint | POST /v1/reviews/{videoId}/cancel-submit | 3 | false | NEW |
| API-182 | api_endpoint | GET /v1/versions/{version}/diff-with-working | 2 | false | NEW |
...
| NAV-001 | navigation_tree | 저작도구 내부 메뉴 (INTERNAL) | 10 | true | NEW |
| ROLE-001 | permission_role | 검수자 (REVIEWER) | 7 | true | NEW |
| ROLE-002 | permission_role | 라벨링 작업자 (WORKER) | 5 | true | NEW |
| SCREEN-005 | screen_spec | 라벨링 캔버스 화면 | 54 | false | NEW |
| SCREEN-010 | screen_spec | 라벨 이력 화면 | 28 | false | NEW |
| SHELL-001 | app_shell | 저작도구 내부 채널 셸 | 6 | true | NEW |
...
| UC-008 | use_case | 버전 비교·복구 | 7 | true | NEW |
...
| UI-017 | ui_component | display: StageBadge | 7 | false | NEW |
| UI-018 | ui_component | display: BatchStageIndicator | 6 | false | NEW |
...
| UI-055 | ui_component | layout: LabelHeader | 10 | false | NEW |
