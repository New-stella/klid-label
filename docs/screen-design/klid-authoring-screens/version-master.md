# Version Master — KLID 저작도구 전체 화면 (DOMAIN-000) — 화면 키트

| 항목 | 값 |
|---|---|
| project_id | 4ece2c3f-8e99-46f5-9580-71108a76e578 |
| Domain | DOMAIN-000 KLID 저작도구 전체 화면 |
| 다운로드 화면 | SCREEN-001, SCREEN-002, SCREEN-003, SCREEN-004, SCREEN-005, SCREEN-006, SCREEN-008, SCREEN-009, SCREEN-010, SCREEN-011, SCREEN-012, SCREEN-018, SCREEN-019, SCREEN-020, SCREEN-021, SCREEN-022, SCREEN-023, SCREEN-024, SCREEN-025, SCREEN-026, SCREEN-027, SCREEN-028, SCREEN-029, SCREEN-030, SCREEN-031, SCREEN-032, SCREEN-033, SCREEN-035, SCREEN-036, SCREEN-037, SCREEN-038, SCREEN-039, SCREEN-040, SCREEN-041, SCREEN-042, SCREEN-043 |
| Last sync | 2026-09-05T01:33:13.615Z (session 34) |
| Mode | SYNC — NEW 7 / CHANGED 123 / UNCHANGED 337 / RETIRED 1 |
...
|---|---|---|---|---|---|
| [[AC-1032]] | acceptance | UC-037 마킹 끝난 영상 일괄 올리기 — 폴더 재귀 짝짓기·판정·비동기 적재·비식별 후 마킹 활성 (happy) | 8 | true | NEW |
| [[AC-1033]] | acceptance | UC-037 일괄 적재 예외 — 짝 못찾음 건너뜀·FPS 어긋남 중단·중복 식별자 건너뜀·비식별 실패 마감·재기동 복구 (negative) | 10 | false | NEW |
...
| [[API-001]] | api_endpoint | GET /v1/users | 8 | false | CHANGED |
...
| [[API-007]] | api_endpoint | POST /v1/auth/role-claim | 16 | true | CHANGED |
...
| [[API-070]] | api_endpoint | POST /v1/assignments | 9 | false | CHANGED |
...
| [[API-139]] | api_endpoint | POST /v1/portal/uploads/images | 4 | true | CHANGED |
...
| [[API-205]] | api_endpoint | 외부 산출물 폴더 검사 | 9 | false | CHANGED |
| [[API-206]] | api_endpoint | 외부 산출물 적재 | 14 | false | CHANGED |
| [[API-207]] | api_endpoint | 이관 이력 목록 조회 | 7 | false | UNCHANGED |
| [[API-208]] | api_endpoint | 이관 이력 상세 조회 | 5 | false | UNCHANGED |
| [[API-209]] | api_endpoint | 분류 대응 목록 조회 | 7 | false | CHANGED |
| [[API-210]] | api_endpoint | 분류 대응 확정 | 11 | false | CHANGED |
...
| [[API-215]] | api_endpoint | 비식별 완료 기록 | 5 | false | CHANGED |
| [[API-216]] | api_endpoint | 마킹 산출물 폴더 검사 | 6 | false | CHANGED |
| [[API-217]] | api_endpoint | 마킹 산출물 일괄 적재 | 7 | false | CHANGED |
...
| [[API-221]] | api_endpoint | 이관 대상 폴더 탐색 | 17 | false | CHANGED |
| [[API-222]] | api_endpoint | 이관 대상 영상 파일 탐색 | 12 | false | CHANGED |
| [[API-223]] | api_endpoint | PUT /v1/manage/admin-password — 관리자 패스워드 교체 | 7 | true | CHANGED |
...
| [[SCREEN-002]] | screen_spec | 관리자 등록 화면 | 28 | true | CHANGED |
...
| [[SCREEN-012]] | screen_spec | 작업 목록 화면 | 49 | false | CHANGED |
...
| [[SCREEN-024]] | screen_spec | 사용자 관리 화면 | 33 | true | CHANGED |
...
| [[SCREEN-028]] | screen_spec | 포털 내 작업 화면 | 34 | true | CHANGED |
| [[SCREEN-029]] | screen_spec | 포털 라벨링 화면 | 48 | true | CHANGED |
| [[SCREEN-030]] | screen_spec | 공지 목록 화면 | 26 | true | UNCHANGED |
| [[SCREEN-031]] | screen_spec | 공지 상세 화면 | 33 | true | UNCHANGED |
| [[SCREEN-032]] | screen_spec | 비식별 신고 관리 화면 | 26 | true | CHANGED |
| [[SCREEN-033]] | screen_spec | 포털 업로드 화면 | 37 | true | CHANGED |
...
| [[SD-021]] | screen_design | SCREEN-032 비식별 신고 관리 화면 | 6 | true | CHANGED |
...
| [[SD-036]] | screen_design | SCREEN-042 연동 서버 주소 관리 화면 | 5 | true | CHANGED |
| [[SD-037]] | screen_design | SCREEN-041 관리자 패스워드 교체 화면 | 5 | true | UNCHANGED |
| [[SD-038]] | screen_design | SCREEN-039 산출물 가져오기 | 2 | true | NEW |
...
| [[UC-002]] | use_case | 증강 결과 수신·등록 | 21 | false | CHANGED |
| [[UC-003]] | use_case | 해상도 변경 수행 | 16 | true | CHANGED |
| [[UC-004]] | use_case | 객체 자동 추적 | 18 | false | CHANGED |
| [[UC-005]] | use_case | 객체 외곽 경계 자동 밀착 | 13 | false | CHANGED |
| [[UC-006]] | use_case | 라벨링 정밀도 조절 | 11 | true | CHANGED |
| [[UC-007]] | use_case | 라벨 버전 저장·이력 추적 | 15 | false | CHANGED |
| [[UC-008]] | use_case | 버전 비교·복구 | 17 | false | CHANGED |
| [[UC-009]] | use_case | 검수 완료·수정 통지 | 23 | false | CHANGED |
| [[UC-010]] | use_case | 증강 영상 활용 여부 검수 | 16 | true | CHANGED |
| [[UC-011]] | use_case | 비식별 처리 요청 | 19 | true | CHANGED |
| [[UC-013]] | use_case | 비식별 옵션 설정 | 12 | true | CHANGED |
| [[UC-016]] | use_case | 비식별 처리 상태·이력 확인 | 30 | false | CHANGED |
| [[UC-018]] | use_case | 영상 적재 (관제 인입 테이블 직접 INSERT → 폴링 적재) | 24 | false | CHANGED |
| [[UC-019]] | use_case | 이벤트 마킹 (자동/수동) | 27 | false | CHANGED |
| [[UC-021]] | use_case | 라벨 편집·임시저장 | 22 | false | CHANGED |
| [[UC-022]] | use_case | VLM 시계열 메타 검토 | 24 | false | CHANGED |
| [[UC-023]] | use_case | 검수 승인·반려 | 30 | false | CHANGED |
| [[UC-024]] | use_case | 포털 라벨 작업 (조회·수정·다운로드) | 25 | false | CHANGED |
| [[UC-027]] | use_case | 포털 자산 업로드·수동 라벨링 | 32 | true | CHANGED |
| [[UC-028]] | use_case | 라벨 클래스·속성 정의 관리 | 8 | false | CHANGED |
| [[UC-029]] | use_case | 작업 목록 조회·필터링·배정 | 13 | true | CHANGED |
| [[UC-030]] | use_case | 사용자 계정·역할 관리 | 16 | true | CHANGED |
| [[UC-031]] | use_case | 시스템 운영 설정 관리 | 16 | true | CHANGED |
| [[UC-032]] | use_case | 라벨 프리셋 CRUD 관리 | 14 | false | CHANGED |
| [[UC-033]] | use_case | 전체 구축 현황 조회 — 검수완료 기준과 전체 기준 병기 | 7 | false | CHANGED |
| [[UC-034]] | use_case | 온디맨드 AI 자동 추적 | 7 | false | CHANGED |
| [[UC-035]] | use_case | 외부 산출물 가져오기 | 19 | false | CHANGED |
| [[UC-036]] | use_case | 이관 이력 조회 | 8 | false | CHANGED |
| [[UC-037]] | use_case | 마킹이 끝난 영상 일괄 올리기 | 15 | true | CHANGED |
