...
| Last sync | 2026-09-01T08:09:59.816Z (session 36) |
...
| [[AC-1086]] | acceptance | SCREEN-027 파일 업로드 — 적재 경로 선택·단건 전송·기술메타 자동 채움·결과 상태 추적 (happy) | 1 | false | UNCHANGED |
| [[AC-1087]] | acceptance | SCREEN-027 파일 업로드 — 유효창 없는 시작·허용 밖 형식과 용량·필수값 누락·중복 식별자 거부 (negative) | 1 | false | UNCHANGED |
...
| [[API-194]] | api_endpoint | POST /v1/manage/admin-session | 10 | false | UNCHANGED |
...
| [[API-206]] | api_endpoint | 외부 산출물 적재 | 13 | true | UNCHANGED |
...
| [[API-210]] | api_endpoint | 분류 대응 확정 | 10 | true | UNCHANGED |
...
| [[API-221]] | api_endpoint | 이관 대상 폴더 탐색 | 16 | true | UNCHANGED |
| [[API-222]] | api_endpoint | 이관 대상 영상 파일 탐색 | 11 | true | UNCHANGED |
...
| [[SCREEN-027]] | screen_spec | 파일 업로드 | 49 | false | UNCHANGED |
...
| [[SCREEN-032]] | screen_spec | 비식별 신고 관리 화면 | 26 | false | UNCHANGED |
...
| [[SCREEN-039]] | screen_spec | 산출물 가져오기 | 41 | false | UNCHANGED |
...
| [[SD-021]] | screen_design | SCREEN-032 비식별 신고 관리 화면 | 6 | false | UNCHANGED |
...
| [[SD-038]] | screen_design | SCREEN-039 산출물 가져오기 | 2 | false | UNCHANGED |
...
| [[UC-035]] | use_case | 외부 산출물 가져오기 | 17 | true | UNCHANGED |
| [[UC-036]] | use_case | 이관 이력 조회 | 6 | true | UNCHANGED |
| [[UC-037]] | use_case | 마킹이 끝난 영상 일괄 올리기 | 9 | true | UNCHANGED |
