...
| Last sync | 2026-09-08T00:20:32.046Z (session 36) |
| Mode | SYNC — NEW 17 / CHANGED 145 / UNCHANGED 314 / RETIRED 101 |
...
|---|---|---|---|---|---|
| [[AC-1032]] | acceptance | UC-037 마킹 끝난 영상 일괄 올리기 — 폴더 재귀 짝짓기·판정·비동기 적재·비식별 후 마킹 활성 (happy) | 9 | true | NEW |
| [[AC-1033]] | acceptance | UC-037 일괄 적재 예외 — 짝 못찾음 건너뜀·FPS 어긋남 중단·중복 식별자 건너뜀·비식별 실패 마감·재기동 복구 (negative) | 11 | true | NEW |
| [[AC-1070]] | acceptance | UC-027 포털 자산 업로드·수동 라벨링 — 업로드·등록·업로드 영상 마킹·BBOX/POLYGON 수동 라벨링·AI 증강(검수 없음)·다운로드 (happy) | 19 | true | NEW |
| [[AC-1071]] | acceptance | UC-027 포털 업로드 예외 — 재개 가능 업로드·타인 자산 403 (negative) | 10 | true | NEW |
| [[AC-1086]] | acceptance | SCREEN-027 파일 업로드 — 적재 경로 선택·단건 전송·기술메타 자동 채움·결과 상태 추적 (happy) | 2 | true | NEW |
| [[AC-1087]] | acceptance | SCREEN-027 파일 업로드 — 유효창 없는 시작·허용 밖 형식과 용량·필수값 누락·중복 식별자 거부 (negative) | 2 | true | NEW |
...
| [[API-025]] | api_endpoint | POST /v1/manage/labels | 9 | false | CHANGED |
...
| [[API-032]] | api_endpoint | POST /v1/labels/{srcSn}/deident-report | 9 | false | CHANGED |
...
| [[API-043]] | api_endpoint | GET /v1/videos/{rawSn} | 27 | false | CHANGED |
...
| [[API-047]] | api_endpoint | POST /v1/videos/{rawSn}/markings | 16 | false | CHANGED |
...
| [[API-058]] | api_endpoint | GET /v1/stats/report | 4 | false | CHANGED |
| [[API-059]] | api_endpoint | GET /v1/augments | 9 | true | CHANGED |
| [[API-060]] | api_endpoint | POST /v1/augments/request | 18 | true | CHANGED |
| [[API-061]] | api_endpoint | GET /v1/augments/{jobId}/result | 11 | true | CHANGED |
| [[API-062]] | api_endpoint | POST /v1/augments/{id}/accept | 10 | true | CHANGED |
| [[API-063]] | api_endpoint | POST /v1/augments/{id}/reject | 10 | true | CHANGED |
| [[API-065]] | api_endpoint | POST /v1/vlm/callback | 25 | false | CHANGED |
...
| [[API-069]] | api_endpoint | PUT /v1/manage/configs/{key} | 10 | false | CHANGED |
...
| [[API-081]] | api_endpoint | GET /v1/portal/datamart/labels | 8 | false | CHANGED |
| [[API-082]] | api_endpoint | POST /v1/portal/user-labels | 10 | false | CHANGED |
...
| [[API-112]] | api_endpoint | POST /v1/videos/{rawSn}/redeident | 6 | false | CHANGED |
| [[API-113]] | api_endpoint | POST /infer/yolo/predict | 4 | false | CHANGED |
| [[API-114]] | api_endpoint | GET /v1/videos/{rawSn}/stream-url | 2 | false | UNCHANGED |
| [[API-115]] | api_endpoint | GET /v1/portal/datamart/videos | 4 | false | CHANGED |
...
| [[API-119]] | api_endpoint | POST /infer/yolo/track | 4 | false | CHANGED |
| [[API-120]] | api_endpoint | POST /infer/sam2/segment | 4 | false | CHANGED |
| [[API-121]] | api_endpoint | POST /infer/sam2/track | 4 | false | CHANGED |
...
| [[API-134]] | api_endpoint | PUT /v1/videos/{rawSn}/event-annotation | 7 | false | CHANGED |
...
| [[API-140]] | api_endpoint | GET /v1/portal/uploads/{uldSn} | 6 | true | CHANGED |
| [[API-141]] | api_endpoint | GET /health | 2 | false | UNCHANGED |
| [[API-142]] | api_endpoint | GET /v1/portal/uploads | 8 | true | CHANGED |
...
| [[API-152]] | api_endpoint | POST /v1/dev/upload | 11 | true | CHANGED |
...
| [[API-157]] | api_endpoint | GET /v1/portal/uploads/{uldSn}/export | 4 | true | CHANGED |
| [[API-158]] | api_endpoint | POST /v1/uploads | 8 | true | CHANGED |
...
| [[API-169]] | api_endpoint | PATCH /v1/portal/uploads/tus/{uldId} | 7 | true | CHANGED |
| [[API-170]] | api_endpoint | PUT /v1/videos/{rawSn}/environment-meta | 3 | false | UNCHANGED |
| [[API-171]] | api_endpoint | DELETE /v1/portal/uploads/tus/{uldId} | 4 | true | CHANGED |
...
| [[API-188]] | api_endpoint | GET /v1/augments/{id}/progress | 3 | true | CHANGED |
| [[API-189]] | api_endpoint | POST /v1/augments/{id}/cancel | 3 | true | CHANGED |
| [[API-190]] | api_endpoint | POST /v1/augments/{id}/restore | 7 | true | CHANGED |
...
| [[API-194]] | api_endpoint | POST /v1/manage/admin-session | 12 | true | CHANGED |
...
| [[API-201]] | api_endpoint | POST /v1/videos/{rawSn}/batch/stages/{stage}/rerun | 9 | true | CHANGED |
| [[API-202]] | api_endpoint | GET /v1/deident-reports/{rprtSn}/deident-candidates | 2 | false | UNCHANGED |
| [[API-203]] | api_endpoint | 포털 사용자 작업 데이터 ZIP 다운로드 | 9 | false | CHANGED |
| [[API-204]] | api_endpoint | POST /v1/ai-requests/{requestId}/cancel | 1 | false | UNCHANGED |
| [[API-205]] | api_endpoint | 외부 산출물 폴더 검사 | 10 | true | CHANGED |
| [[API-206]] | api_endpoint | 외부 산출물 적재 | 15 | true | CHANGED |
| [[API-207]] | api_endpoint | 이관 이력 목록 조회 | 7 | false | UNCHANGED |
| [[API-208]] | api_endpoint | 이관 이력 상세 조회 | 5 | false | UNCHANGED |
| [[API-209]] | api_endpoint | 분류 대응 목록 조회 | 7 | true | CHANGED |
| [[API-210]] | api_endpoint | 분류 대응 확정 | 11 | true | CHANGED |
| [[API-211]] | api_endpoint | 분류 대응 해제 | 8 | false | UNCHANGED |
| [[API-212]] | api_endpoint | POST /v1/videos/batch/stages/{stage}/skip | 6 | true | CHANGED |
| [[API-213]] | api_endpoint | DELETE /v1/videos/batch/stages/{stage}/skip | 7 | true | CHANGED |
| [[API-214]] | api_endpoint | POST /v1/videos/batch/stages/{stage}/rerun | 5 | true | CHANGED |
| [[API-215]] | api_endpoint | 비식별 완료 기록 | 6 | false | CHANGED |
| [[API-216]] | api_endpoint | 마킹 산출물 폴더 검사 | 7 | false | CHANGED |
| [[API-217]] | api_endpoint | 마킹 산출물 일괄 적재 | 8 | false | CHANGED |
| [[API-218]] | api_endpoint | 일괄 적재 진행 조회 | 6 | false | CHANGED |
| [[API-219]] | api_endpoint | GET /v1/manage/verification-event-types | 4 | true | CHANGED |
| [[API-220]] | api_endpoint | PUT /v1/manage/verification-event-types/{vrfcEvntTypeCd}/questions | 4 | true | CHANGED |
| [[API-221]] | api_endpoint | 이관 대상 폴더 탐색 | 19 | true | CHANGED |
| [[API-222]] | api_endpoint | 이관 대상 영상 파일 탐색 | 13 | true | CHANGED |
| [[API-223]] | api_endpoint | PUT /v1/manage/admin-password — 관리자 패스워드 교체 | 8 | true | CHANGED |
| [[API-232]] | api_endpoint | GET /v1/portal/augments | 4 | true | NEW |
| [[API-233]] | api_endpoint | GET /v1/portal/augments/{augSn} | 5 | true | NEW |
| [[API-238]] | api_endpoint | GET /v1/portal/uploads/{uldSn}/stream | 1 | true | NEW |
| [[API-239]] | api_endpoint | GET /v1/portal/uploads/{uldSn}/stream-url | 1 | true | NEW |
| [[API-240]] | api_endpoint | POST /v1/portal/uploads/{uldSn}/markings | 4 | true | NEW |
| [[API-241]] | api_endpoint | GET /v1/portal/uploads/{uldSn}/markings | 1 | true | NEW |
...
| [[NAV-002]] | navigation_tree | 포털 메뉴 (PORTAL) | 17 | true | CHANGED |
| [[ROLE-001]] | permission_role | 검수자 (REVIEWER) | 14 | true | CHANGED |
| [[ROLE-002]] | permission_role | 라벨링 작업자 (WORKER) | 9 | true | UNCHANGED |
| [[ROLE-003]] | permission_role | 포털 회원 (PORTAL_USER) | 14 | true | CHANGED |
...
| [[SCREEN-005]] | screen_spec | 라벨링 캔버스 화면 | 106 | false | CHANGED |
| [[SCREEN-006]] | screen_spec | 마킹 화면 | 52 | false | CHANGED |
| [[SCREEN-008]] | screen_spec | 영상 처리 현황 화면 | 48 | true | CHANGED |
| [[SCREEN-009]] | screen_spec | 영상 상세 화면 | 76 | true | CHANGED |
| [[SCREEN-010]] | screen_spec | 로드 버전 선택 | 37 | true | UNCHANGED |
| [[SCREEN-011]] | screen_spec | 대시보드 화면 | 21 | true | UNCHANGED |
| [[SCREEN-012]] | screen_spec | 작업 목록 화면 | 49 | true | CHANGED |
...
| [[SCREEN-021]] | screen_spec | 전체 구축 현황 화면 | 29 | true | CHANGED |
| [[SCREEN-022]] | screen_spec | 증강 요청 화면 | 51 | false | CHANGED |
| [[SCREEN-023]] | screen_spec | 증강 결과 화면 | 47 | false | CHANGED |
| [[SCREEN-024]] | screen_spec | 사용자 관리 화면 | 35 | true | CHANGED |
| [[SCREEN-025]] | screen_spec | 시스템 설정 화면 | 49 | true | CHANGED |
| [[SCREEN-026]] | screen_spec | 프리셋 관리 화면 | 35 | true | UNCHANGED |
| [[SCREEN-027]] | screen_spec | 파일 업로드 | 52 | true | CHANGED |
| [[SCREEN-028]] | screen_spec | 포털 내 작업 화면 | 38 | true | CHANGED |
| [[SCREEN-029]] | screen_spec | 포털 라벨링 화면 | 54 | true | CHANGED |
| [[SCREEN-030]] | screen_spec | 공지 목록 화면 | 26 | true | UNCHANGED |
| [[SCREEN-031]] | screen_spec | 공지 상세 화면 | 33 | true | UNCHANGED |
| [[SCREEN-032]] | screen_spec | 비식별 신고 관리 화면 | 28 | false | CHANGED |
| [[SCREEN-033]] | screen_spec | 포털 업로드 화면 | 38 | true | CHANGED |
...
| [[SCREEN-038]] | screen_spec | 이벤트유형 관리 화면 | 15 | true | CHANGED |
| [[SCREEN-039]] | screen_spec | 산출물 가져오기 | 45 | true | CHANGED |
| [[SCREEN-040]] | screen_spec | 관리자 페이지 진입 화면 | 9 | false | UNCHANGED |
| [[SCREEN-041]] | screen_spec | 관리자 패스워드 교체 | 10 | false | UNCHANGED |
| [[SCREEN-042]] | screen_spec | 연동 서버 주소 관리 화면 | 15 | false | CHANGED |
| [[SCREEN-043]] | screen_spec | 위험 작업 화면 | 7 | false | UNCHANGED |
| [[SCREEN-044]] | screen_spec | 포털 증강 화면 | 8 | true | NEW |
| [[SCREEN-045]] | screen_spec | 포털 업로드 영상 마킹 화면 | 5 | true | NEW |
...
| [[SD-021]] | screen_design | SCREEN-032 비식별 신고 관리 화면 | 8 | false | CHANGED |
| [[SD-022]] | screen_design | SCREEN-035 라벨 관리 화면 | 4 | true | UNCHANGED |
| [[SD-023]] | screen_design | SCREEN-038 이벤트유형 관리 화면 | 5 | true | UNCHANGED |
| [[SD-024]] | screen_design | SCREEN-028 포털 내 작업 화면 | 12 | true | CHANGED |
| [[SD-025]] | screen_design | SCREEN-029 포털 라벨링 화면 | 6 | true | CHANGED |
| [[SD-026]] | screen_design | SCREEN-033 포털 업로드 화면 | 11 | true | CHANGED |
| [[SD-027]] | screen_design | SCREEN-034 포털 업로드 라벨링 화면 | 11 | true | CHANGED |
| [[SD-028]] | screen_design | SCREEN-022 증강 요청 화면 | 9 | false | CHANGED |
| [[SD-029]] | screen_design | SCREEN-023 증강 결과 화면 | 7 | true | CHANGED |
| [[SD-030]] | screen_design | SCREEN-020 작업자 통계 화면 | 5 | false | UNCHANGED |
| [[SD-031]] | screen_design | SCREEN-021 전체 구축 현황 화면 | 3 | true | CHANGED |
| [[SD-032]] | screen_design | SCREEN-010 로드 버전 선택 | 2 | true | UNCHANGED |
| [[SD-033]] | screen_design | SCREEN-027 파일 업로드 | 13 | false | CHANGED |
| [[SD-034]] | screen_design | SCREEN-040 관리자 페이지 진입 화면 | 6 | false | UNCHANGED |
| [[SD-035]] | screen_design | SCREEN-043 위험 작업 화면 | 4 | true | UNCHANGED |
| [[SD-036]] | screen_design | SCREEN-042 연동 서버 주소 관리 화면 | 7 | false | CHANGED |
| [[SD-037]] | screen_design | SCREEN-041 관리자 패스워드 교체 화면 | 5 | true | UNCHANGED |
| [[SD-038]] | screen_design | SCREEN-039 산출물 가져오기 | 3 | true | NEW |
| [[SHELL-001]] | app_shell | 저작도구 내부 채널 셸 | 12 | true | CHANGED |
| [[SHELL-002]] | app_shell | 포털 채널 셸 | 8 | true | CHANGED |
| [[UC-001]] | use_case | 증강 영상 생성 요청 | 18 | false | CHANGED |
| [[UC-002]] | use_case | 증강 결과 수신·등록 | 21 | true | CHANGED |
| [[UC-003]] | use_case | 해상도 변경 수행 | 16 | true | CHANGED |
| [[UC-004]] | use_case | 객체 자동 추적 | 18 | true | CHANGED |
| [[UC-005]] | use_case | 객체 외곽 경계 자동 밀착 | 13 | true | CHANGED |
| [[UC-006]] | use_case | 라벨링 정밀도 조절 | 11 | true | CHANGED |
| [[UC-007]] | use_case | 라벨 버전 저장·이력 추적 | 15 | true | CHANGED |
| [[UC-008]] | use_case | 버전 비교·복구 | 17 | true | CHANGED |
| [[UC-009]] | use_case | 검수 완료·수정 통지 | 25 | false | CHANGED |
| [[UC-010]] | use_case | 증강 영상 활용 여부 검수 | 17 | false | CHANGED |
| [[UC-011]] | use_case | 비식별 처리 요청 | 21 | false | CHANGED |
| [[UC-013]] | use_case | 비식별 옵션 설정 | 12 | true | CHANGED |
| [[UC-016]] | use_case | 비식별 처리 상태·이력 확인 | 31 | true | CHANGED |
| [[UC-018]] | use_case | 영상 적재 (관제 인입 테이블 직접 INSERT → 폴링 적재) | 24 | true | CHANGED |
| [[UC-019]] | use_case | 이벤트 마킹 (자동/수동) | 30 | true | CHANGED |
| [[UC-021]] | use_case | 라벨 편집·임시저장 | 23 | true | CHANGED |
| [[UC-022]] | use_case | VLM 시계열 메타 검토 | 29 | false | CHANGED |
| [[UC-023]] | use_case | 검수 승인·반려 | 30 | false | CHANGED |
| [[UC-024]] | use_case | 포털 라벨 작업 (조회·수정·다운로드) | 33 | false | CHANGED |
| [[UC-027]] | use_case | 포털 자산 업로드·수동 라벨링 | 32 | true | CHANGED |
| [[UC-028]] | use_case | 라벨 클래스·속성 정의 관리 | 8 | true | CHANGED |
| [[UC-029]] | use_case | 작업 목록 조회·필터링·배정 | 13 | true | CHANGED |
| [[UC-030]] | use_case | 사용자 계정·역할 관리 | 16 | true | CHANGED |
| [[UC-031]] | use_case | 시스템 운영 설정 관리 | 18 | true | CHANGED |
| [[UC-032]] | use_case | 라벨 프리셋 CRUD 관리 | 14 | true | CHANGED |
| [[UC-033]] | use_case | 전체 구축 현황 조회 — 검수완료 기준과 전체 기준 병기 | 7 | false | CHANGED |
| [[UC-034]] | use_case | 온디맨드 AI 자동 추적 | 7 | true | CHANGED |
| [[UC-035]] | use_case | 외부 산출물 가져오기 | 20 | true | CHANGED |
| [[UC-036]] | use_case | 이관 이력 조회 | 8 | true | CHANGED |
| [[UC-037]] | use_case | 마킹이 끝난 영상 일괄 올리기 | 16 | false | CHANGED |
| [[UC-042]] | use_case | 파일 업로드로 영상 한 건 투입 | 4 | false | NEW |
...
| [[UI-145]] | ui_component | overlay: PathPicker | 1 | false | NEW |
