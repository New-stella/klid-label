...
| Last sync | 2026-09-14T05:34:14.130Z (session 18) |
| Mode | SYNC — NEW 0 / CHANGED 22 / UNCHANGED 205 |
...
| [[AC-1061]] | acceptance | UC-032 라벨 프리셋 CRUD — 이벤트유형+라벨 멀티셀렉트(이름·설명 없음)·labelId 실시간 join·보류 재개 (happy) | 7 | true | CHANGED |
