...
| Last sync | 2026-09-07T15:22:14.244Z (session 17) |
...
| [[AC-1061]] | acceptance | UC-032 라벨 프리셋 CRUD — 이벤트유형+라벨 멀티셀렉트(이름·설명 없음)·labelId 실시간 join·보류 재개 (happy) | 6 | true | UNCHANGED |
