...
| Last sync | 2026-08-11T07:42:06.350Z (session 4) |
| Mode | SYNC — NEW 7 / CHANGED 1 / UNCHANGED 177 |
...
| API-037 | api_endpoint | GET /v1/manage/presets | 2 | false | UNCHANGED |
| API-038 | api_endpoint | POST /v1/manage/presets | 3 | false | UNCHANGED |
| API-039 | api_endpoint | PUT /v1/manage/presets/{id} | 3 | false | UNCHANGED |
...
| API-196 | api_endpoint | PUT /v1/videos/{rawSn}/labels | 4 | false | CHANGED |
...
| SCREEN-005 | screen_spec | 라벨링 캔버스 화면 | 61 | false | UNCHANGED |
| SCREEN-026 | screen_spec | 프리셋 관리 화면 | 19 | false | UNCHANGED |
