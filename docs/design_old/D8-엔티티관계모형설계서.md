...
|------|------|------------|--------|--------|
| 2026-05-27 | 1.0 | CBD 양식 전환 — V47 기준 45개 테이블 반영 | 박찬기 | - |
| 2026-05-28 | 1.1 | V51 기준 47개 테이블 반영 (LS_* 38개 + MNG_* 9개) — PJT_SN 컬럼 제거, LS_MARKING.INTERVAL_SEC→INTERVAL_FRAMES, VLM_VERIFY 상태 제거 반영 | 박찬기 | - |
...
|--------|--------|----------------|:---------:|
| KLID-AT-ERD-001 | 영상·프레임·라벨 코어 | 배치 파이프라인(SS-003), 라벨링(SS-006) | 8 |
| KLID-AT-ERD-002 | 라벨 마스터·속성·프리셋 | 라벨링(SS-006) | 5 |
| KLID-AT-ERD-003 | 배정·검수·이슈 | 검수(SS-007) | 6 |
| KLID-AT-ERD-004 | 메타·증강 | 시계열 메타(SS-005), 데이터 증강(SS-009) | 6 |
| KLID-AT-ERD-005 | 사용자·CCTV·시스템 | 사용자/권한(SS-001) | 10 |
| KLID-AT-ERD-006 | 마킹·포털 사용자 라벨 | 마킹(SS-002), 포털(SS-010) | 2 |
| KLID-AT-ERD-007 | Webhook·통지·폴백 | 비식별화(SS-004), 시계열 메타(SS-005), 검수(SS-007), 데이터 증강(SS-009) | 3 |
| KLID-AT-ERD-008 | 통합 Overview | 전체(SS-001~010) | 45 |
