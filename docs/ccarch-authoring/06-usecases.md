...
```json
{
  ...
  "attrs": {"actor": "BATCH_SYSTEM + ext-deidentify-sw"},
...
```json
{
  ...
  "attrs": {"actor": "BATCH_SYSTEM + ext-vlm-service"},
...
```json
{
  ...
  "attrs": {"actor": "REVIEWER + ext-gitea"},
...
```json
{
  ...
  "attrs": {"actor": "REVIEWER + ext-generative-ai"},
...
```json
{
  ...
  "attrs": {"actor": "ext-control-server + ext-portal-server"},
