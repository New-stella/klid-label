...
>
> **해상도 변경**(RQ-SFR-06-03, 이미지셋 다운스케일) UI는 **SC-022 증강 요청** 화면에 단일 섹션(자체 영상 선택기)으로 포함된다 — 영상 상세(SC-009)에서 이관(2026-06-16). 증강(WINTER/NIGHT/RAIN)과는 별개 기능으로 화면 내에서 구분 → [14 증강](14-augmentation.md) · [05 영상](05-video-management.md).
>
