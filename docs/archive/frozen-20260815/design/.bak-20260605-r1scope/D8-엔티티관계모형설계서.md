...
> **EN ID 배정**: KLID-AT-EN-001 ~ KLID-AT-EN-034 (도메인별 오름차순)
...
> **추가 엔티티(LS_DEADLINE·LS_CONTROL_NOTIFY_FALLBACK·LS_WEBHOOK_IDEMPOTENCY)**는 D9 테이블 명세(KLID-AT-TB-033 ~ KLID-AT-TB-035)에 상세 기술하며, 본 엔티티 명세서는 KLID-AT-EN-001 ~ KLID-AT-EN-034 범위로 작성한다.
...
- 엔티티 ID: `KLID-AT-EN-001 ~ KLID-AT-EN-034`
