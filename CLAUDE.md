...
> - ⚠ **설계만 섰고 코드는 0건이다.** 상세는 변경지시서 `CO-20260902-포털-업로드영상-마킹화면-신설.md`.
...
> 되돌아온 것**이라 **제거할 코드가 없다.** 남는 코드 작업은 **본문 상단 이동 탭 신설** 하나뿐이다.
